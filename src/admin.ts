...
const ADMIN_LAYOUT_CSS = `<style>.reset-user-btn{height:31px!important;margin-top:8px!important;border:0!important;border-radius:999px!important;background:rgba(255,80,80,.16)!important;color:#ffb3b3!important;font-size:12px!important;width:100%!important}.bulk-users-btn{height:36px!important;border:0!important;border-radius:999px!important;background:rgba(255,80,80,.22)!important;color:#ffd1d1!important;font-size:12px!important;font-weight:800!important;padding:0 14px!important;white-space:nowrap!important}@media(min-width:720px){.menu-panel:not([hidden]){display:flex!important;gap:7px!important;overflow-x:auto!important;margin:4px 0 18px!important;padding:0 0 8px!important;border:0!important;background:transparent!important}.menu-panel:not([hidden])::before{display:none!important}.menu-panel:not([hidden]) .menu-head{display:none!important}.menu-panel:not([hidden]) .menu-item{flex:0 0 auto!important;width:auto!important;min-width:86px!important;border-radius:999px!important}.menu-panel:not([hidden]) .menu-item strong{display:block!important;font-size:12px!important}.menu-panel:not([hidden]) .menu-item span{display:none!important}}</style>`;
