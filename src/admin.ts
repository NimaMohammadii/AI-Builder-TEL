...
import { ADMIN_SECTION_ACCESS_PANEL_SCRIPT } from './admin-section-access-panel';
...
export function adminPanelHtml(): string {
  return adminPanelWithFixes().replace('</body></html>', ADMIN_LAYOUT_CSS + ADMIN_SECTION_ACCESS_PANEL_SCRIPT + ADMIN_ONLINE_USER_COUNTS_PANEL_SCRIPT + ADMIN_AUDIO_PANEL_SCRIPT + ADMIN_SLOT_VIRTUAL_USERS_SCRIPT + ADMIN_PREDICT_PANEL_SCRIPT + ADMIN_FOOTBALL_PANEL_SCRIPT + ADMIN_PLINKO_CONTROL_SCRIPT + ADMIN_PLINKO_VIRTUAL_USERS_SCRIPT + ADMIN_CRASH_VIRTUAL_USERS_SCRIPT + '</body></html>');
}
