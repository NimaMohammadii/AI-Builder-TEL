...
function adminPanelWithFixes(): string {
  return mobileAdminPanelHtml()
    ...
    .replace('Manage images used inside the mini app. For now this section contains the credit icon.', 'Manage images used inside the mini app, including the credit icon and Slot game frame.')
