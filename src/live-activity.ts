...
(function(){
  ...
  function style(){
    ...
    var st=document.createElement('style');st.id='homeLiveActivityStyle';st.textContent=[
      ...
      '.home-live-activity-row{position:relative!important;overflow:hidden!important;height:32px!important;min-height:32px!important;border:0!important;outline:0!important;border-radius:28px!important;background:transparent!important;background-color:transparent!important;background-image:none!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.105),inset 0 -1px 0 rgba(255,255,255,.06),inset 0 0 22px rgba(255,255,255,.055),0 12px 28px rgba(0,0,0,.18)!important;display:grid!important;grid-template-columns:minmax(0,1fr) auto!important;align-items:center!important;gap:8px!important;padding:0 10px!important;box-sizing:border-box!important;backdrop-filter:blur(3px) saturate(1.04)!important;-webkit-backdrop-filter:blur(3px) saturate(1.04)!important}.home-live-activity-row.is-new{animation:homeLiveEnter .62s cubic-bezier(.16,.84,.2,1)!important}.home-live-activity-row.is-shifting{animation:homeLiveShift .54s cubic-bezier(.16,.84,.2,1)!important}@keyframes homeLiveEnter{0%{opacity:0;transform:translate3d(-28px,-10px,0) scale(.9)}52%{opacity:1;transform:translate3d(5px,1px,0) scale(1.035)}76%{transform:translate3d(-2px,0,0) scale(.995)}100%{opacity:1;transform:none}}@keyframes homeLiveShift{0%{transform:translate3d(0,-16px,0)}68%{transform:translate3d(0,2px,0)}100%{transform:none}}',
