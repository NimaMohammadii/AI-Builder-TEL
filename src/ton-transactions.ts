...
export type TonTransactionKind = 'deposit' | 'withdraw' | 'game' | 'group_usage' | 'admin' | 'adjustment' | 'market' | 'market_refund';
...
function cleanKind(value: unknown): TonTransactionKind {
  ...
  return ['deposit', 'withdraw', 'game', 'group_usage', 'admin', 'adjustment', 'market', 'market_refund'].includes(raw) ? raw : 'adjustment';
}
