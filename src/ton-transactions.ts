...
export type TonTransactionKind = 'deposit' | 'withdraw' | 'game' | 'group_usage' | 'admin' | 'adjustment';
...
function cleanKind(value: unknown): TonTransactionKind {
  ...
  return ['deposit', 'withdraw', 'game', 'group_usage', 'admin', 'adjustment'].includes(raw) ? raw : 'adjustment';
}
