...
const GHOST_RUN_ASSET_KINDS = new Set(['background', 'ground', 'moon', 'ghost', 'ghostidle', 'ghostmove', 'tree1', 'tree2', 'tree3', 'house1', 'house2', 'house3']);
...
app.get('/app/api/ghost-run-asset/:kind', async (c) => {
  ...
  const cacheControl = kind === 'background' ? 'no-store' : GHOST_RUN_ASSET_CACHE_CONTROL;
