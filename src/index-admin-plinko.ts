...
const GHOST_RUN_ASSET_KINDS = new Set(['background', 'background1', 'background2', 'background3', 'ground', 'moon', 'ghost', 'ghostidle', 'ghostmove', 'tree1', 'tree2', 'tree3', 'house1', 'house2', 'house3']);
...
function defaultGhostRunAssetSvg(kind: string): string {
  ...
  if (kind === 'background2' || kind === 'background3') return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 900 520" preserveAspectRatio="xMidYMid slice"><rect width="900" height="520" fill="transparent"/></svg>`;
