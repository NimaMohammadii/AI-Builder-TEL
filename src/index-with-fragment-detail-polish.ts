...
const REGIONS: RegionConfig[] = [
  ...
  { code: 'QA', label: '🇶🇦 Qatar', language: 'ar', timezone: 'Asia/Qatar' },
  { code: 'MX', label: '🇲🇽 Mexico', language: 'es', timezone: 'America/Mexico_City' },
  { code: 'AR', label: '🇦🇷 Argentina', language: 'es', timezone: 'America/Argentina/Buenos_Aires' },
  { code: 'CO', label: '🇨🇴 Colombia', language: 'es', timezone: 'America/Bogota' },
  { code: 'ES', label: '🇪🇸 Spain', language: 'es', timezone: 'Europe/Madrid' },
  { code: 'FR', label: '🇫🇷 France', language: 'fr', timezone: 'Europe/Paris' },
  { code: 'CA', label: '🇨🇦 Canada', language: 'en', timezone: 'America/Toronto' },
  ...
  { code: 'CH', label: '🇨🇭 Switzerland', language: 'de', timezone: 'Europe/Zurich' },
  { code: 'NL', label: '🇳🇱 Netherlands', language: 'en', timezone: 'Europe/Amsterdam' },
  { code: 'UZ', label: '🇺🇿 Uzbekistan', language: 'ru', timezone: 'Asia/Tashkent' },
  { code: 'KZ', label: '🇰🇿 Kazakhstan', language: 'ru', timezone: 'Asia/Almaty' },
  { code: 'AZ', label: '🇦🇿 Azerbaijan', language: 'tr', timezone: 'Asia/Baku' },
  ...
  { code: 'PK', label: '🇵🇰 Pakistan', language: 'en', timezone: 'Asia/Karachi' },
  { code: 'BD', label: '🇧🇩 Bangladesh', language: 'en', timezone: 'Asia/Dhaka' },
  { code: 'PH', label: '🇵🇭 Philippines', language: 'en', timezone: 'Asia/Manila' },
  { code: 'VN', label: '🇻🇳 Vietnam', language: 'en', timezone: 'Asia/Ho_Chi_Minh' },
  { code: 'MY', label: '🇲🇾 Malaysia', language: 'en', timezone: 'Asia/Kuala_Lumpur' },
  { code: 'EG', label: '🇪🇬 Egypt', language: 'ar', timezone: 'Africa/Cairo' },
  { code: 'NG', label: '🇳🇬 Nigeria', language: 'en', timezone: 'Africa/Lagos' },
  { code: 'ZA', label: '🇿🇦 South Africa', language: 'en', timezone: 'Africa/Johannesburg' },
