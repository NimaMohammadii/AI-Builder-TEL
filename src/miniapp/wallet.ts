export const WALLET_SECTION = `<div id="wallet" class="wallet-sheet" aria-hidden="true">
  <style>
    ...
    body.wallet-open.deposit-open #wallet .wallet-sheet-panel:before{height:min(520px,calc(100vh - 16px))!important;background:rgba(18,18,19,.66)!important}
    ...
    body.wallet-open.deposit-open #depositSheet .deposit-title{margin:0 auto 8px!important;width:min(100%,370px)!important;justify-content:flex-end!important}
    ...
    body.wallet-open.deposit-open #depositSheet .wallet-withdraw-button{width:100%!important;height:48px!important;margin:2px 0 0!important;border:0!important;border-radius:22px!important;background:rgba(13,13,13,.54)!important;color:#fff!important;display:flex!important;align-items:center!important;justify-content:center!important;gap:9px!important;font-size:13px!important;font-weight:900!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.095),inset 0 -1px 0 rgba(255,255,255,.05),0 12px 28px rgba(0,0,0,.18)!important;backdrop-filter:blur(10px) saturate(1.12)!important;-webkit-backdrop-filter:blur(10px) saturate(1.12)!important}
    #depositSheet .wallet-withdraw-button svg{width:19px!important;height:19px!important;display:block!important;color:#ff7181!important}
    ...
    @media(max-width:380px){body.wallet-open.deposit-open #wallet .wallet-sheet-panel:before{height:min(500px,calc(100vh - 14px))!important}body.wallet-open.withdraw-open #wallet .wallet-sheet-panel:before{height:min(430px,calc(100vh - 14px))!important}body.wallet-open.deposit-open #depositSheet.deposit-sheet.open .deposit-panel{height:min(500px,calc(100vh - 14px))!important;max-height:min(500px,calc(100vh - 14px))!important}body.wallet-open.withdraw-open #withdrawSheet.deposit-sheet.open .deposit-panel{height:min(430px,calc(100vh - 14px))!important;max-height:min(430px,calc(100vh - 14px))!important}body.wallet-open.deposit-open #depositSheet .deposit-method-option{min-height:68px!important;padding:10px 12px!important}}
    @media(prefers-reduced-motion:reduce){#wallet .wallet-sheet-backdrop,#wallet .wallet-sheet-panel,#wallet .wallet-sheet-panel:before,#wallet .wallet-sheet-handle{transition:none!important}body.wallet-open.deposit-open #depositSheet.deposit-sheet.open .deposit-panel,body.wallet-open.withdraw-open #withdrawSheet.deposit-sheet.open .deposit-panel{animation:none!important}}
  </style>
  <div class="wallet-sheet-backdrop" data-action="close-wallet"></div>
  <section class="wallet-sheet-panel" role="dialog" aria-modal="true" aria-label="Wallet">
      ...
      function ensurePicker(){
        ...
        if(!s.querySelector('.deposit-method-screen')){
          ...
          box.innerHTML='<p class="deposit-copy deposit-method-copy">Choose how you want to deposit</p>'+
            ...
            '<button class="wallet-withdraw-button" type="button" data-action="open-withdraw"><svg viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M12 17V7M8 11l4-4 4 4" stroke="currentColor" stroke-width="2.3" stroke-linecap="round" stroke-linejoin="round"/></svg><span>Withdraw</span></button>'+
