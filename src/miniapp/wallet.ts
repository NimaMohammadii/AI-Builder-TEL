...
(function(){
  ...
  function flushPaymentDone(){if(!paymentDonePending||document.hidden||(tg&&tg.isActive===false))return;paymentDonePending=false;if(paymentDoneDelay){clearTimeout(paymentDoneDelay);paymentDoneDelay=0}renderPaymentDone()}
