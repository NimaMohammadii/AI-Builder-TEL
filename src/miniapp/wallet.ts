      ...
      if(d.invoiceLink){
        if(tg&&typeof tg.openInvoice==='function'){
          tg.openInvoice(d.invoiceLink,function(state){
            ...
            if(state==='paid'&&window.VexaShowPaymentDone)window.VexaShowPaymentDone();
