...
(function(){
  ...
  var countProfiles={mines:{offset:-36,width:18},plinko:{offset:24,width:32},rps:{offset:-12,width:-8},wheel:{offset:58,width:24},dice:{offset:-28,width:14},crash:{offset:72,width:38},hilo:{offset:-44,width:20},coinflip:{offset:10,width:-12},tower:{offset:46,width:28}};
