...
(function(){
  ...
  function tickCounters(){document.querySelectorAll('#playzone .game-card-shell[data-game-view] .game-players b').forEach(function(el){animateNumber(el,nextCount(el.textContent))});setTimeout(function(){try{window.dispatchEvent(new CustomEvent('vexa-play-zone-live-counts-updated'))}catch(e){}},540)}
