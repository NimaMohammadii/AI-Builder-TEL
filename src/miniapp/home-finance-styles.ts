...
.home-finance-visual{min-height:174px;border-radius:32px;background:rgba(255,255,255,.018);backdrop-filter:blur(3px) saturate(1.12);-webkit-backdrop-filter:blur(3px) saturate(1.12);box-shadow:inset 0 1px 0 rgba(255,255,255,.06),0 16px 46px rgba(0,0,0,.22);overflow:hidden;display:grid;place-items:center;position:relative}
.home-finance-visual img{width:100%;height:100%;object-fit:cover;display:block;opacity:.96}
.home-finance-visual img[src$="home-finance-image.png"]{object-fit:contain;padding:18px;opacity:.9}
@media(max-width:360px){.home-finance-split{gap:9px}.home-finance-card{min-height:74px;border-radius:24px;padding:13px}.home-finance-card strong{font-size:17px}.home-finance-visual{min-height:158px;border-radius:26px}}
`;
