...
.home-empty-glass-card{width:100%;min-height:126px;margin:18px 0 4px;border:0;border-radius:30px;background:rgba(255,255,255,.026);backdrop-filter:blur(3px) saturate(1.14);-webkit-backdrop-filter:blur(3px) saturate(1.14);box-shadow:inset 0 1px 0 rgba(255,255,255,.07),0 16px 42px rgba(0,0,0,.24);overflow:hidden;box-sizing:border-box}
