...
(function(){
  ...
  function ensureRewardsPageGlobalStyles(){
    if(q('rewardsPageGlobalStyles'))return;
    var style=document.createElement('style');
    style.id='rewardsPageGlobalStyles';
    style.textContent='body.rewards-open{overflow:hidden!important}.rewards-page{position:fixed!important;inset:0!important;z-index:2147483000!important;display:block!important;overflow:auto!important;padding:calc(54px + env(safe-area-inset-top)) 18px calc(98px + env(safe-area-inset-bottom))!important;background:radial-gradient(circle at 50% -10%,rgba(255,255,255,.08),rgba(255,255,255,0) 34%),rgba(5,5,7,.88)!important;backdrop-filter:blur(12px)!important;-webkit-backdrop-filter:blur(12px)!important;scrollbar-width:none!important}.rewards-page::-webkit-scrollbar{display:none}.rewards-page-top{display:flex!important;align-items:flex-start!important;justify-content:space-between!important;gap:12px!important;margin:0 0 20px!important}.rewards-status-strip{display:grid!important;grid-template-columns:48px minmax(0,1fr) auto!important;gap:11px!important;align-items:center!important;margin:0 0 18px!important;padding:0 0 16px!important;border-bottom:1px solid rgba(255,255,255,.08)!important}.reward-days{display:flex!important;gap:7px!important;overflow-x:auto!important;overflow-y:hidden!important;margin:0 -18px 18px!important;padding:0 18px 8px!important;scrollbar-width:none!important;scroll-snap-type:x proximity!important;-webkit-overflow-scrolling:touch!important}.reward-days::-webkit-scrollbar{display:none}.reward-today{display:grid!important;grid-template-columns:44px minmax(0,1fr) auto!important;gap:11px!important;align-items:center!important;margin:0 0 16px!important;padding:0 0 15px!important;border-bottom:1px solid rgba(255,255,255,.08)!important}.missions-title{display:flex!important;align-items:center!important;justify-content:space-between!important;gap:10px!important;margin:4px 0 7px!important;color:#fff!important}.missions-list{display:grid!important;gap:7px!important}';
    document.head.appendChild(style);
  }
  function setRewardsPage(open){var s=q('rewardsPage');if(!s)return;ensureRewardsPageGlobalStyles();if(open&&s.parentNode!==document.body)document.body.appendChild(s);document.body.classList.toggle('rewards-open',!!open);s.classList.toggle('open',!!open);s.setAttribute('aria-hidden',open?'false':'true');if(open)try{s.scrollTop=0}catch(e){}}
