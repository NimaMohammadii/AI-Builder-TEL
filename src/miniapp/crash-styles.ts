...
#crash .crash-controls{position:relative;border:0!important;outline:0!important;border-radius:28px;background:transparent!important;padding:12px;box-shadow:none!important;backdrop-filter:blur(3px)!important;-webkit-backdrop-filter:blur(3px)!important;overflow:visible}
...
#crash .crash-amount input{height:42px!important;border-radius:17px!important;background:transparent!important;border:0!important;outline:0!important;color:#fff!important;text-align:center!important;font-weight:910!important;font-size:17px!important;box-shadow:none!important;backdrop-filter:blur(3px)!important;-webkit-backdrop-filter:blur(3px)!important;-webkit-text-fill-color:#fff!important}
#crash .crash-auto-field{margin-top:8px}
#crash .crash-auto{height:42px;border-radius:17px;background:transparent!important;border:0!important;outline:0!important;display:grid;grid-template-columns:minmax(0,1fr) 30px;align-items:center;box-shadow:none!important;backdrop-filter:blur(3px)!important;-webkit-backdrop-filter:blur(3px)!important}
...
#crash .crash-quick button{height:42px;border:0!important;outline:0!important;border-radius:16px;background:transparent!important;color:#fff!important;-webkit-text-fill-color:#fff!important;font-size:12px;font-weight:900;box-shadow:none!important;backdrop-filter:blur(3px)!important;-webkit-backdrop-filter:blur(3px)!important}
#crash .crash-actions{display:grid;grid-template-columns:1fr 1fr;gap:7px;margin-top:9px}
#crash .crash-primary,#crash .crash-secondary{height:45px;border:0!important;outline:0!important;border-radius:17px;font-weight:930;font-size:12px;color:#fff!important;-webkit-text-fill-color:#fff!important;box-shadow:none!important;backdrop-filter:blur(3px)!important;-webkit-backdrop-filter:blur(3px)!important;background:transparent!important}
#crash .crash-primary,#crash .crash-secondary,#crash .crash-primary:disabled,#crash .crash-secondary:disabled{background:transparent!important;color:#fff!important;-webkit-text-fill-color:#fff!important}
...
#crash .crash-amount input:focus,#crash .crash-auto:focus-within,#crash .crash-quick button:focus-visible,#crash .crash-primary:focus-visible,#crash .crash-secondary:focus-visible{box-shadow:none!important;outline:0!important;background:transparent!important}
...
#crash .crash-history span{flex:0 0 auto;border-radius:999px;background:transparent!important;border:0!important;outline:0!important;padding:7px 10px;font-size:11px;font-weight:890;color:rgba(255,255,255,.90)!important;box-shadow:none!important;backdrop-filter:blur(3px)!important;-webkit-backdrop-filter:blur(3px)!important}
`;