...
#crash .crash-stage:before{content:"";position:absolute;inset:0;background:linear-gradient(90deg,rgba(18,18,18,.86) 1px,transparent 1px),linear-gradient(180deg,rgba(18,18,18,.86) 1px,transparent 1px)!important;background-size:20% 20%!important;pointer-events:none;z-index:3;opacity:.70}
