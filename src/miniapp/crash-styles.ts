...
#crash .crash-controls{position:relative;border:0!important;outline:0!important;border-radius:32px;background:transparent!important;padding:12px;box-shadow:0 22px 48px rgba(0,0,0,.18)!important;backdrop-filter:blur(3px)!important;-webkit-backdrop-filter:blur(3px)!important;overflow:visible}
#crash .crash-controls:before,#crash .crash-controls:after{display:none!important}
...
#crash .crash-amount input,#crash .crash-auto,#crash .crash-quick button,#crash .crash-primary,#crash .crash-secondary,#crash .crash-history span{border:0!important;outline:0!important;background:transparent!important;box-shadow:0 10px 22px rgba(0,0,0,.13)!important;backdrop-filter:blur(3px)!important;-webkit-backdrop-filter:blur(3px)!important}
#crash .crash-amount input,#crash .crash-auto{height:42px!important;border-radius:999px!important}
#crash .crash-amount input,#crash .crash-auto input{color:#fff!important;text-align:center!important;font-weight:910!important;font-size:17px!important;-webkit-text-fill-color:#fff!important;background:transparent!important;border:0!important;outline:0!important}
...
#crash .crash-primary,#crash .crash-secondary{height:45px;border-radius:999px;font-weight:930;font-size:12px;color:#fff!important;-webkit-text-fill-color:#fff!important;text-shadow:0 0 18px rgba(120,0,38,.20)}
#crash .crash-primary:disabled,#crash .crash-secondary:disabled{opacity:.42}
#crash .crash-primary:not(:disabled):active,#crash .crash-secondary:not(:disabled):active,#crash .crash-quick button:active{transform:scale(.985);filter:brightness(1.07)}
#crash .crash-amount input:focus,#crash .crash-auto:focus-within,#crash .crash-quick button:focus-visible,#crash .crash-primary:focus-visible,#crash .crash-secondary:focus-visible{background:transparent!important;outline:0!important;box-shadow:0 11px 24px rgba(0,0,0,.15)!important}
