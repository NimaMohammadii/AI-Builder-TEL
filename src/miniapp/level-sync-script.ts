...
(function(){
  ...
  function ensureRankModal(){
    ...
    style.textContent='.vexa-rank-overlay{position:fixed;inset:0;z-index:9998;display:flex;align-items:center;justify-content:center;padding:18px;background:rgba(0,0,0,.08);opacity:0;pointer-events:none;transition:opacity .26s ease}.vexa-rank-overlay.open{opacity:1;pointer-events:auto}.vexa-rank-card{position:relative;width:min(100%,390px);max-height:none;overflow:hidden;border:0;border-radius:30px;background:linear-gradient(135deg,rgba(255,255,255,.075),rgba(255,255,255,.026));backdrop-filter:blur(10px) saturate(1.18);-webkit-backdrop-filter:blur(10px) saturate(1.18);box-shadow:0 22px 60px rgba(0,0,0,.24),inset 0 1px 0 rgba(255,255,255,.12);transform:translateY(-16px) scale(.96);opacity:.25;transition:transform .32s cubic-bezier(.2,.9,.2,1),opacity .26s ease}.vexa-rank-card:before{content:"";position:absolute;inset:-80px -70px auto auto;width:180px;height:180px;border-radius:999px;background:radial-gradient(circle,rgba(255,255,255,.09),rgba(255,255,255,.045) 42%,rgba(255,255,255,0) 70%);pointer-events:none}.vexa-rank-card>*{position:relative;z-index:1}.vexa-rank-overlay.open .vexa-rank-card{transform:translateY(0) scale(1);opacity:1}.vexa-rank-head{display:flex;align-items:flex-start;justify-content:space-between;gap:10px;padding:14px 15px 7px;border-bottom:0}.vexa-rank-eyebrow{margin:0 0 3px;color:rgba(255,255,255,.45);font-size:8px;font-weight:950;text-transform:uppercase;letter-spacing:.15em}.vexa-rank-head h3{margin:0;color:#fff;font-size:22px;line-height:.95;letter-spacing:-.055em}.vexa-rank-head p{margin:5px 0 0;color:rgba(255,255,255,.56);font-size:10px;line-height:1.25;max-width:250px}.vexa-rank-close{width:31px;height:31px;border:0;border-radius:999px;background:rgba(255,255,255,.07);color:#fff;font-size:17px;font-weight:850}.vexa-rank-current{display:none!important}.vexa-rank-orb{width:52px;height:52px;border-radius:18px;display:grid;place-items:center;background:rgba(255,255,255,.08);border:1px solid rgba(255,255,255,.12);font-size:22px}.vexa-rank-current strong{display:block;color:#fff;font-size:17px;line-height:1}.vexa-rank-current span{display:block;margin-top:5px;color:rgba(255,255,255,.55);font-size:11px}.vexa-rank-list{max-height:none;overflow:visible;padding:2px 10px 10px;scrollbar-width:none}.vexa-rank-list::-webkit-scrollbar{display:none}.vexa-rank-row{position:relative;display:grid;grid-template-columns:40px 1fr auto;gap:8px;align-items:center;margin:4px 0;padding:6px 8px;border:1px solid rgba(255,255,255,.09);border-radius:16px;background:rgba(255,255,255,.035);transform:translateY(8px);opacity:0;animation:vexaRankIn .38s ease forwards;min-height:45px}.vexa-rank-row.current{border-color:rgba(255,255,255,.32);background:linear-gradient(135deg,rgba(255,255,255,.13),rgba(255,255,255,.055));box-shadow:0 10px 34px rgba(0,0,0,.11),inset 0 1px 0 rgba(255,255,255,.12)}.vexa-rank-row.done{background:rgba(255,255,255,.055)}.vexa-rank-badge{width:36px;height:36px;border-radius:14px;display:grid;place-items:center;border:1px solid rgba(255,255,255,.12);background:rgba(0,0,0,.18);font-size:17px}.vexa-rank-name{color:#fff;font-size:13px;font-weight:950;line-height:1}.vexa-rank-desc{margin-top:2px;color:rgba(255,255,255,.5);font-size:9px;line-height:1.15}.vexa-rank-range{color:rgba(255,255,255,.65);font-size:9px;font-weight:900;white-space:nowrap}.vexa-rank-now{display:inline-flex;margin-top:4px;padding:2px 6px;border-radius:999px;background:#fff;color:#050505;font-size:8px;font-weight:950}.brand img.logo{cursor:pointer}@keyframes vexaRankIn{to{transform:translateY(0);opacity:1}}@media(max-height:700px){.vexa-rank-overlay{padding:14px}.vexa-rank-head{padding:11px 14px 5px}.vexa-rank-head h3{font-size:20px}.vexa-rank-head p{font-size:9px;margin-top:4px}.vexa-rank-row{margin:3px 0;min-height:40px;padding:5px 7px}.vexa-rank-badge{width:30px;height:30px;border-radius:11px}.vexa-rank-name{font-size:12px}.vexa-rank-desc{font-size:8.2px}.vexa-rank-range{font-size:8px}.vexa-rank-now{font-size:7.5px;padding:2px 5px}}';
