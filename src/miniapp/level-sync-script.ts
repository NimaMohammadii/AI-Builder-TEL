...
(function(){
  ...
  function ensureRankModal(){
    ...
    style.textContent='.vexa-rank-overlay{position:fixed;inset:0;z-index:9998;display:flex;align-items:flex-start;justify-content:center;padding:calc(76px + env(safe-area-inset-top)) 18px 24px;background:rgba(0,0,0,.08);opacity:0;pointer-events:none;transition:opacity .26s ease}.vexa-rank-overlay.open{opacity:1;pointer-events:auto}.vexa-rank-card{width:min(100%,390px);max-height:min(74vh,680px);overflow:hidden;border:1px solid rgba(255,255,255,.18);border-radius:30px;background:linear-gradient(135deg,rgba(255,255,255,.075),rgba(255,255,255,.025));backdrop-filter:blur(3px);-webkit-backdrop-filter:blur(3px);box-shadow:0 22px 80px rgba(0,0,0,.46),inset 0 1px 0 rgba(255,255,255,.13);transform:translateY(-16px) scale(.96);opacity:.25;transition:transform .32s cubic-bezier(.2,.9,.2,1),opacity .26s ease}.vexa-rank-overlay.open .vexa-rank-card{transform:translateY(0) scale(1);opacity:1}.vexa-rank-head{display:flex;align-items:flex-start;justify-content:space-between;gap:12px;padding:18px 18px 12px;border-bottom:1px solid rgba(255,255,255,.08)}.vexa-rank-eyebrow{margin:0 0 4px;color:rgba(255,255,255,.45);font-size:9px;font-weight:950;text-transform:uppercase;letter-spacing:.16em}.vexa-rank-head h3{margin:0;color:#fff;font-size:24px;line-height:1;letter-spacing:-.055em}.vexa-rank-head p{margin:6px 0 0;color:rgba(255,255,255,.56);font-size:11px;line-height:1.35}.vexa-rank-close{width:34px;height:34px;border:1px solid rgba(255,255,255,.15);border-radius:999px;background:rgba(255,255,255,.06);color:#fff;font-size:18px;font-weight:800}.vexa-rank-current{display:grid;grid-template-columns:52px 1fr;gap:12px;align-items:center;margin:14px 18px;padding:12px;border:1px solid rgba(255,255,255,.13);border-radius:22px;background:radial-gradient(circle at 22% 0,rgba(192,58,91,.24),rgba(255,255,255,.035) 50%,rgba(255,255,255,.02));box-shadow:inset 0 1px 0 rgba(255,255,255,.1)}.vexa-rank-orb{width:52px;height:52px;border-radius:18px;display:grid;place-items:center;background:rgba(255,255,255,.08);border:1px solid rgba(255,255,255,.12);font-size:22px}.vexa-rank-current strong{display:block;color:#fff;font-size:17px;line-height:1}.vexa-rank-current span{display:block;margin-top:5px;color:rgba(255,255,255,.55);font-size:11px}.vexa-rank-list{max-height:calc(min(74vh,680px) - 172px);overflow:auto;padding:0 12px 14px;scrollbar-width:none}.vexa-rank-list::-webkit-scrollbar{display:none}.vexa-rank-row{position:relative;display:grid;grid-template-columns:40px 1fr auto;gap:10px;align-items:center;margin:8px 0;padding:11px;border:1px solid rgba(255,255,255,.09);border-radius:19px;background:rgba(255,255,255,.035);transform:translateY(8px);opacity:0;animation:vexaRankIn .38s ease forwards}.vexa-rank-row.current{border-color:rgba(255,255,255,.32);background:linear-gradient(135deg,rgba(255,255,255,.13),rgba(192,58,91,.13));box-shadow:0 10px 34px rgba(192,58,91,.11),inset 0 1px 0 rgba(255,255,255,.12)}.vexa-rank-row.done{background:rgba(255,255,255,.055)}.vexa-rank-badge{width:40px;height:40px;border-radius:15px;display:grid;place-items:center;border:1px solid rgba(255,255,255,.12);background:rgba(0,0,0,.18);font-size:18px}.vexa-rank-name{color:#fff;font-size:14px;font-weight:950;line-height:1}.vexa-rank-desc{margin-top:4px;color:rgba(255,255,255,.5);font-size:10.5px;line-height:1.25}.vexa-rank-range{color:rgba(255,255,255,.65);font-size:10px;font-weight:900;white-space:nowrap}.vexa-rank-now{display:inline-flex;margin-top:6px;padding:4px 8px;border-radius:999px;background:#fff;color:#050505;font-size:9px;font-weight:950}.brand img.logo{cursor:pointer}@keyframes vexaRankIn{to{transform:translateY(0);opacity:1}}';
