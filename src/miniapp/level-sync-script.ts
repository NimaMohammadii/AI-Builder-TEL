...
(function(){
  ...
  function scheduleFlushPendingXp(force){if(force){flushPendingXp();return}if(flushTimer||flushingXp||!loadPendingXp().length)return;flushTimer=setTimeout(function(){flushTimer=0;flushPendingXp()},pendingIsOnlyPlinko()?6000:FLUSH_DEBOUNCE_MS)}
