...
(function(){
  function setup(){
    ...
    function shouldShow(){
      ...
      if(isActive('topplayers')||isActive('referral')||isActive('balancewallet'))return true;
    ...
    function goBack(){
      ...
      if(isActive('topplayers')||isActive('referral')||isActive('balancewallet')){setView('home');sync();return;}
      sync();
    }
