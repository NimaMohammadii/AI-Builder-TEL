...
(function(){
  function setupTelegramBackButton(){
    ...
    var backTarget='';
    var backSections=['predictzone','crash','plinko','mines','topplayers'];
    ...
    function targetFor(section){
      if(section==='predictzone'||section==='crash'||section==='plinko'||section==='mines'||section==='topplayers')return 'playzone';
