...
(function(){
  ...
  function addStyle(){
    ...
    style.textContent=[
      ...
      '#home .home-blank-cards-track{display:flex;gap:12px;width:calc(100% + 32px);margin:0 -16px;overflow-x:auto;overflow-y:visible!important;-webkit-overflow-scrolling:touch;scrollbar-width:none;scroll-snap-type:x proximity;padding:0 16px 18px;box-sizing:border-box;overscroll-behavior-x:contain}',
