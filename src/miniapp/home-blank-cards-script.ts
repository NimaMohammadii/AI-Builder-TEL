...
(function(){
  var LETTERS='ABCDEFGHIJKLMNOPQRSTUVWXYZ',ROW_HEIGHT=48;
  function q(s,r){return (r||document).querySelector(s)}
  function qa(s,r){return Array.prototype.slice.call((r||document).querySelectorAll(s))}
  function cleanHome(){qa('#home .home-finance-split').forEach(function(n){n.outerHTML=''})}
  function css(){
    ...
    st.textContent=[
      ...
      '#homeLuckyCodeSection{display:block!important;padding:0 0 14px!important;margin:0!important}',
      '.home-lucky-card{background:none!important;border:0!important;box-shadow:none!important;padding:0!important}',
      '.home-lucky-head{display:flex!important;align-items:center!important;justify-content:space-between!important;margin:0 0 12px!important}',
      '.home-lucky-titlebox{display:grid!important;gap:5px!important}.home-lucky-titlebox strong{color:#fff!important;font-size:19px!important;font-weight:950!important}.home-lucky-titlebox span{color:rgba(255,255,255,.5)!important;font-size:11px!important;font-weight:760!important}',
      '.home-lucky-machine{display:grid!important;grid-template-columns:repeat(6,minmax(0,1fr))!important;gap:8px!important;background:none!important;box-shadow:none!important;perspective:640px!important}',
      '.home-lucky-reel{height:48px!important;border-radius:18px!important;overflow:hidden!important;position:relative!important;background:linear-gradient(180deg,rgba(255,255,255,.075),rgba(255,255,255,.038))!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.12),inset 0 -1px 0 rgba(255,255,255,.06),inset 0 -12px 20px rgba(0,0,0,.18),0 10px 22px rgba(0,0,0,.13)!important;transform:translateZ(0)!important}',
      '.home-lucky-reel:before{content:""!important;position:absolute!important;left:0!important;right:0!important;top:0!important;height:17px!important;background:linear-gradient(180deg,rgba(0,0,0,.62),rgba(0,0,0,.18),transparent)!important;z-index:3!important;pointer-events:none!important}.home-lucky-reel:after{content:""!important;position:absolute!important;left:0!important;right:0!important;bottom:0!important;height:17px!important;border-radius:0!important;background:linear-gradient(0deg,rgba(0,0,0,.58),rgba(0,0,0,.16),transparent)!important;z-index:3!important;pointer-events:none!important}.home-lucky-strip{will-change:transform!important;transform:translate3d(0,0,0);backface-visibility:hidden!important;filter:none!important}.home-lucky-reel.is-spinning{box-shadow:inset 0 1px 0 rgba(255,255,255,.15),inset 0 -1px 0 rgba(255,255,255,.07),inset 0 -14px 22px rgba(0,0,0,.22),0 14px 26px rgba(0,0,0,.18)!important}.home-lucky-reel.is-spinning .home-lucky-strip{filter:none!important}.home-lucky-letter{height:48px!important;display:grid!important;place-items:center!important;color:#fff!important;font-size:23px!important;font-weight:950!important;text-shadow:0 8px 18px rgba(0,0,0,.54)!important;transform:translateZ(0)!important}',
      '.home-lucky-code{height:40px!important;margin:13px 0!important;border-radius:18px!important;position:relative!important;display:flex!important;align-items:center!important;justify-content:center!important;gap:8px!important;padding:0 48px 0 16px!important;background:rgba(255,255,255,.035)!important;color:rgba(255,255,255,.62)!important;font-size:12px!important;font-weight:800!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.045),inset 0 -1px 0 rgba(255,255,255,.035)!important}.home-lucky-code b{color:#fff!important;letter-spacing:.16em!important}.home-code-spin{position:absolute!important;right:5px!important;top:5px!important;width:30px!important;height:30px!important;border:0!important;border-radius:12px!important;background:rgba(255,255,255,.09)!important;color:#fff!important;font-size:14px!important;font-weight:950!important;display:grid!important;place-items:center!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.12),0 8px 18px rgba(0,0,0,.2)!important}.home-code-spin:disabled{opacity:.55!important}',
      ...
      '.home-ticket-card-head{display:flex!important;align-items:center!important;justify-content:space-between!important;gap:10px!important}.home-ticket-card-head strong{color:#fff!important;font-size:16px!important;font-weight:950!important}.home-ticket-card-image{width:48px!important;height:48px!important;object-fit:contain!important;display:block!important;filter:drop-shadow(0 10px 18px rgba(0,0,0,.26))!important;flex:0 0 auto!important}.home-ticket-count{height:44px!important;width:100%!important;border-radius:18px!important;background:rgba(0,0,0,.22)!important;color:#fff!important;font-size:20px!important;font-weight:950!important;display:flex!important;align-items:center!important;justify-content:center!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.06),inset 0 -1px 0 rgba(255,255,255,.04)!important}',
      '.home-ticket-stepper{display:grid!important;grid-template-columns:1fr 1fr!important;gap:8px!important}.home-ticket-step{height:40px!important;border:0!important;border-radius:16px!important;background:rgba(255,255,255,.075)!important;color:#fff!important;font-size:20px!important;font-weight:950!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.08),inset 0 -1px 0 rgba(255,255,255,.045),0 10px 22px rgba(0,0,0,.18)!important}',
      '.home-ticket-button{width:100%!important;height:42px!important;border-radius:17px!important;border:0!important;background:rgba(255,255,255,.12)!important;color:#fff!important;font-size:13px!important;font-weight:950!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.09),inset 0 -1px 0 rgba(255,255,255,.055),0 12px 24px rgba(0,0,0,.2)!important}.home-ticket-button.is-ready{background:rgba(255,255,255,.18)!important}',
      '.home-ticket-finance-visual{min-height:154px!important;height:100%!important;position:relative!important;display:grid!important;place-items:center!important;background:transparent!important;box-shadow:none!important;overflow:visible!important;pointer-events:auto!important}.home-ticket-finance-visual img{width:100%!important;height:100%!important;margin-top:4px!important;object-fit:contain!important;display:block!important;filter:drop-shadow(0 18px 34px rgba(0,0,0,.26))!important;animation:homeFinanceFloat 3.8s ease-in-out infinite!important;pointer-events:none!important}',
      '.home-ticket-image-button{position:absolute!important;right:0!important;top:0!important;z-index:4!important;height:34px!important;min-width:76px!important;padding:0 12px!important;border:0!important;border-radius:999px!important;background:rgba(255,255,255,.075)!important;color:#fff!important;font-size:12px!important;font-weight:950!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.09),inset 0 -1px 0 rgba(255,255,255,.055),0 14px 30px rgba(0,0,0,.24)!important;backdrop-filter:blur(10px) saturate(1.12)!important;-webkit-backdrop-filter:blur(10px) saturate(1.12)!important}',
      '.home-ticket-drawer-backdrop{position:fixed!important;inset:0!important;z-index:94!important;background:transparent!important;display:none!important}.home-ticket-drawer-backdrop.is-open{display:block!important}',
  ...
  function reel(){var h='';for(var r=0;r<24;r++){for(var i=0;i<LETTERS.length;i++)h+='<div class="home-lucky-letter">'+LETTERS[i]+'</div>'}return h}
  function count(){try{return Math.max(0,Math.floor(Number(localStorage.getItem('vexaFreeTickets')||'0')))}catch(e){return 0}}
  function ready(){try{return localStorage.getItem('vexaTicketReady')==='1'}catch(e){return false}}
  function setReady(v){try{localStorage.setItem('vexaTicketReady',v?'1':'0')}catch(e){}sync()}
