...
(function(){
  ...
  function addStyle(){
    ...
    style.textContent=[
      '#dailyRewardsMount,#dailyRewardsEntry,#dailyRewardsPage,#rewardsPage,#home .home-daily-rewards-section,#home .home-daily-rewards-entry,#home .home-rewards-entry,#home [data-action="open-daily-rewards"],#home [data-action="open-rewards"],#home button:has(.home-daily-rewards-main),#home button:has(.home-rewards-entry-main){display:none!important;visibility:hidden!important;pointer-events:none!important;width:0!important;height:0!important;min-height:0!important;margin:0!important;padding:0!important;border:0!important;overflow:hidden!important;opacity:0!important}',
  ...
  function removeDailyPrize(){
    document.querySelectorAll('#dailyRewardsMount,#dailyRewardsEntry,#dailyRewardsPage,#rewardsPage,#home .home-daily-rewards-section,#home .home-daily-rewards-entry,#home .home-rewards-entry,#home [data-action="open-daily-rewards"],#home [data-action="open-rewards"]').forEach(function(n){try{n.remove()}catch(e){}});
    document.querySelectorAll('#home button,#home section').forEach(function(n){
      var txt=(n.textContent||'').toLowerCase();
      if(txt.indexOf('daily prize')>-1||txt.indexOf('daily rewards')>-1||txt.indexOf('rewards hub')>-1)try{n.remove()}catch(e){}
    });
