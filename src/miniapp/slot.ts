...
<section id="slot" class="view slot-view" style="overflow-x:hidden;max-width:100vw">
  ...
  <div class="slot-control-panel" style="margin-top:-178px;overflow:hidden;max-width:100vw;background:transparent!important;border:0!important;box-shadow:none!important">
    <div class="slot-controls slot-image-controls" style="width:92%;gap:16px;overflow:hidden">
      <button id="slotSpinButton" class="slot-image-control slot-spin-button" type="button" aria-label="Start" style="height:96px;overflow:hidden;background:transparent!important;border:0!important;box-shadow:none!important;border-radius:24px!important">
      ...
      <label class="slot-image-control slot-input-control" aria-label="Amount" style="height:96px;overflow:hidden;background:transparent!important;border:0!important;box-shadow:none!important;border-radius:24px!important">
