  ...
  <div class="slot-rewards-modal" aria-hidden="true">
    ...
    <div class="slot-rewards-panel" role="dialog" aria-label="Slot rewards">
      ...
      <div class="slot-rewards-list">
        <div class="slot-reward-row"><div class="slot-reward-icons" data-slot-reward-icons="cherry,cherry,cherry"></div><div class="slot-reward-copy"><div class="slot-reward-name">Three matching fruits</div><div class="slot-reward-note">Cherry, lemon, orange, grape or watermelon</div></div><div class="slot-reward-mult">5x</div></div>
        <div class="slot-reward-row"><div class="slot-reward-icons" data-slot-reward-icons="diamond,diamond,diamond"></div><div class="slot-reward-copy"><div class="slot-reward-name">Three diamonds</div><div class="slot-reward-note">Premium hit</div></div><div class="slot-reward-mult">15x</div></div>
        <div class="slot-reward-row"><div class="slot-reward-icons" data-slot-reward-icons="gold,gold,gold"></div><div class="slot-reward-copy"><div class="slot-reward-name">Three golden stars</div><div class="slot-reward-note">Rare gold line</div></div><div class="slot-reward-mult">30x</div></div>
        <div class="slot-reward-row"><div class="slot-reward-icons" data-slot-reward-icons="lucky7,lucky7,lucky7"></div><div class="slot-reward-copy"><div class="slot-reward-name">Triple seven</div><div class="slot-reward-note">Jackpot chance: 0.01%</div></div><div class="slot-reward-mult">200x</div></div>
        <div class="slot-reward-row"><div class="slot-reward-icons" data-slot-reward-icons="lemon,lemon,cherry"></div><div class="slot-reward-copy"><div class="slot-reward-name">Two matching fruits</div><div class="slot-reward-note">Small return</div></div><div class="slot-reward-mult">0.8x</div></div>
      </div>
    </div>
  </div>
