...
<section id="slot" class="view slot-view" style="overflow-x:hidden;max-width:100vw">
  ...
  <div class="slot-control-panel" style="z-index:1;margin-top:-194px;overflow:hidden;max-width:100vw;background:transparent!important;border:0!important;box-shadow:none!important">
