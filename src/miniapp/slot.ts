...
<section id="slot" class="view slot-view" style="overflow-x:hidden;max-width:100vw;transform:translateY(-10px)">
  <style>
    ...
    #slot .slot-rewards-card{position:absolute;left:18px;top:84px;z-index:38;display:inline-flex;align-items:center;gap:7px;padding:9px 13px;border-radius:18px;border:1px solid rgba(255,255,255,.13);background:rgba(255,255,255,.035);color:rgba(255,255,255,.92);font-size:13px;font-weight:950;letter-spacing:-.02em;box-shadow:0 16px 42px rgba(0,0,0,.34),inset 0 1px 0 rgba(255,255,255,.09);backdrop-filter:blur(2px);-webkit-backdrop-filter:blur(2px);cursor:pointer;user-select:none;transition:transform .18s ease,opacity .18s ease,border-color .18s ease}
