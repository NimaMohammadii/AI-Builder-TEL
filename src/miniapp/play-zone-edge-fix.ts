...
@media(max-width:380px){
  html body:has(#slot.active) #slot .slot-machine{width:min(86vw,336px)!important;height:430px!important;min-height:430px!important;margin-top:-12px!important;left:9px!important}
  ...
  html body:has(#slot.active) #slot .slot-control-panel{width:min(86vw,336px)!important;margin:-16px auto 0!important;left:-7px!important}
