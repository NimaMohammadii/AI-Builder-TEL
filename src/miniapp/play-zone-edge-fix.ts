...
#playzone .play-zone-muted-card{background:rgba(255,255,255,.035)!important;background-image:none!important;border-color:rgba(255,255,255,.08)!important;box-shadow:0 18px 42px rgba(0,0,0,.16),inset 0 1px 0 rgba(255,255,255,.10)!important}
