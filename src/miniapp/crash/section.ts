...
export const CRASH_SECTION = `<section id="crash" class="view crash-view">
  <style>
    ...
    html body:has(#crash.active) #crash #crashSpaceCanvas{position:fixed!important;inset:0 auto auto 50%!important;width:min(100vw,560px)!important;height:100dvh!important;transform:translateX(-50%)!important;z-index:0!important;border-radius:0!important;background:#000!important}
