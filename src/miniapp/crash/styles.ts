...
#crash .crash-rocket-flight{--rocket-x:0px;--rocket-y:38px;--rocket-tilt:-3deg;--rocket-scale:.72;--rocket-thrust:.3;position:absolute;left:50%;top:59%;width:min(78vw,310px);height:min(78vw,310px);transform:translate3d(calc(-50% + var(--rocket-x)),calc(-50% + var(--rocket-y)),0) rotate(var(--rocket-tilt)) scale(var(--rocket-scale));transform-origin:50% 58%;will-change:transform,opacity;transition:opacity .24s ease;filter:drop-shadow(0 26px 34px rgba(0,0,0,.46))}
#crash .crash-rocket-model{position:absolute;inset:0;width:100%;height:100%;z-index:3;background:transparent!important;--poster-color:transparent;pointer-events:none}
#crash .crash-rocket-flame{position:absolute;left:50%;top:76%;width:21%;height:calc(31% * var(--rocket-thrust));min-height:10px;z-index:1;transform:translateX(-50%);transform-origin:50% 0;filter:drop-shadow(0 10px 13px rgba(101,5,30,.72));opacity:calc(.18 + var(--rocket-thrust) * .82);will-change:height,opacity,filter}
...
#crash .crash-flame-outer{width:100%;transform:translateX(-50%);background:radial-gradient(ellipse at 50% 4%,rgba(255,225,220,.82) 0 7%,rgba(125,12,43,.98) 22%,rgba(83,3,27,.88) 52%,rgba(32,0,10,0) 88%);filter:blur(4px);animation:crashFlameOuter .09s steps(2,end) infinite}
#crash .crash-flame-middle{width:57%;height:86%;transform:translateX(-50%);background:linear-gradient(180deg,#fff 0 11%,#ffd9d5 21%,#a10c3d 52%,rgba(82,0,24,0) 100%);filter:blur(1.3px);animation:crashFlameMiddle .075s ease-in-out infinite alternate}
#crash .crash-flame-core{width:22%;height:58%;transform:translateX(-50%);background:linear-gradient(180deg,#fff 0 38%,#ffe8df 55%,rgba(255,102,115,.12) 100%);filter:blur(.45px);animation:crashFlameCore .055s ease-in-out infinite alternate}
#crash .crash-rocket-heat{position:absolute;left:50%;top:74%;width:30%;height:39%;z-index:0;transform:translateX(-50%);border-radius:50%;background:repeating-radial-gradient(ellipse at 50% 0,rgba(255,255,255,.08) 0 2px,rgba(95,4,29,.04) 3px 6px,transparent 7px 11px);mix-blend-mode:screen;filter:blur(3px);opacity:calc(var(--rocket-thrust) * .48);animation:crashHeatHaze .24s linear infinite}
...
#crash .crash-rocket-flight[data-state="waiting"]{--rocket-thrust:.22;opacity:.96}
#crash .crash-rocket-flight[data-state="crashed"]{--rocket-thrust:0;animation:crashRocketExit .72s cubic-bezier(.2,.75,.24,1) both}
@keyframes crashFlameOuter{0%{transform:translateX(-50%) scaleX(.88) scaleY(.94);filter:blur(4.7px)}100%{transform:translateX(-50%) scaleX(1.08) scaleY(1.06);filter:blur(3.4px)}}
...
@keyframes crashRocketExit{0%{opacity:1;filter:drop-shadow(0 26px 34px rgba(0,0,0,.46))}28%{transform:translate3d(calc(-50% + var(--rocket-x) - 5px),calc(-50% + var(--rocket-y) + 2px),0) rotate(calc(var(--rocket-tilt) - 4deg)) scale(var(--rocket-scale));filter:brightness(1.4) drop-shadow(0 0 28px rgba(110,5,35,.78))}100%{transform:translate3d(calc(-50% + var(--rocket-x) + 72px),calc(-50% + var(--rocket-y) - 86px),0) rotate(calc(var(--rocket-tilt) + 19deg)) scale(calc(var(--rocket-scale) * .82));opacity:0;filter:blur(2px) brightness(.72)}}
