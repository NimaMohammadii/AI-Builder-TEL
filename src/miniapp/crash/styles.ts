...
html body:has(#crash.active) #crash.crash-view .crash-stage{position:relative;width:100vw!important;margin-left:50%!important;transform:translateX(-50%)!important;aspect-ratio:1/1;height:auto!important;min-height:0!important;max-height:none!important;flex:0 0 auto;border-radius:0!important;overflow:visible!important;background-color:transparent!important;background-image:none!important;background-size:cover!important;background-position:center!important;background-repeat:no-repeat!important;border:0!important;outline:0!important;box-shadow:0 -9px 12px -5px #000,0 9px 12px -5px #000!important;backdrop-filter:none!important;-webkit-backdrop-filter:none!important;isolation:isolate}
html body:has(#crash.active) #crash.crash-view .crash-stage-background{position:absolute!important;left:50%!important;top:0!important;width:100vw!important;aspect-ratio:1/1!important;transform:translateX(-50%)!important;overflow:hidden!important;z-index:0!important;background:#000!important;pointer-events:none!important}
html body:has(#crash.active) #crash.crash-view #crashSpaceCanvas{position:absolute!important;left:50%!important;top:0!important;width:100vw!important;height:auto!important;aspect-ratio:1/1!important;transform:translateX(-50%)!important;display:block!important;z-index:1!important;background:transparent!important;pointer-events:none!important;border-radius:0!important}
...
#crash .crash-rocket-flight{--rocket-thrust:.3;--rocket-angle:80deg;--rocket-entry-x:0px;position:absolute;left:50%;top:50%;width:min(56vw,220px);height:min(56vw,220px);transform:translate3d(calc(-50% + var(--rocket-entry-x)), -50%,0) rotate(var(--rocket-angle)) scale(.78);transform-origin:50% 50%;will-change:transform,opacity;animation:crashRocketDrift 3.6s ease-in-out infinite;transition:opacity .22s ease;opacity:1}
...
@keyframes crashRocketDrift{0%,100%{transform:translate3d(calc(-50% + var(--rocket-entry-x) - 2px),calc(-50% + 2px),0) rotate(var(--rocket-angle)) scale(.78)}50%{transform:translate3d(calc(-50% + var(--rocket-entry-x) + 2px),calc(-50% - 2px),0) rotate(var(--rocket-angle)) scale(.78)}}
