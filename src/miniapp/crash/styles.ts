...
#crash .crash-stage{position:relative;width:100%;aspect-ratio:1/1;height:auto!important;min-height:0!important;max-height:none!important;flex:0 0 auto;border-radius:34px;overflow:hidden;background-color:#000!important;background-image:url('/assets/CrashChart.PNG?v=1')!important;background-size:cover!important;background-position:center!important;background-repeat:no-repeat!important;border:0!important;outline:0!important;box-shadow:0 22px 56px rgba(0,0,0,.24)!important;backdrop-filter:blur(3px);-webkit-backdrop-filter:blur(3px);isolation:isolate}
