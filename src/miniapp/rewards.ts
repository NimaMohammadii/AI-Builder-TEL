export const REWARDS_SECTION = `<section id="rewards" class="view rewards-view">
  <style>
    ...
    #rewards .rewards-winners-state-title{margin:0 8px 10px!important;color:rgba(255,255,255,.72)!important;font-size:13px!important;font-weight:850!important;line-height:1.2!important;letter-spacing:-.01em!important;transition:opacity .16s ease,transform .16s ease!important}#rewards.rewards-winners-scrolled .rewards-winners-state-title{opacity:0!important;transform:translateY(-5px)!important;pointer-events:none!important}
    ...
    #rewards .home-live-winner-card .vexa-premium-corner,#rewards .home-live-winner-card .vexa-bonus-premium,#rewards .home-live-winner-card .vexa-premium-star,#rewards .home-live-winner-card .vexa-bonus-star{display:none!important;content:none!important}
