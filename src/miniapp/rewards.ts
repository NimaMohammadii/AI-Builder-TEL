export const REWARDS_SECTION = `<section id="rewards" class="view rewards-view">
  <style>
    ...
    #rewards .rewards-daily-top{margin:calc(-54px + env(safe-area-inset-top)) 0 0!important}
    #rewards .rewards-hero-image-wrap{position:relative;width:min(44vw,170px);height:clamp(62px,20vw,104px);margin:18px auto 0;display:grid;place-items:center;pointer-events:none;animation:rewardsHeroFloat 5.8s ease-in-out infinite;will-change:transform;filter:drop-shadow(0 14px 22px rgba(0,0,0,.26))}
    ...
    #rewards .rewards-mission-list{width:100%!important;max-width:none!important;margin:32px auto 0!important;display:grid!important;gap:10px!important;align-content:start!important;justify-items:stretch!important}
    ...
    @media(max-width:380px){#rewards{padding-left:3px!important;padding-right:3px!important}#rewards .rewards-daily-top{margin-top:calc(-54px + env(safe-area-inset-top))!important}#rewards .rewards-hero-image-wrap{width:min(42vw,155px);height:clamp(58px,18vw,92px);margin-top:16px!important}#rewards .rewards-mission-list{width:100%!important;max-width:none!important;margin-top:30px!important}#rewards .rewards-mission-card{min-height:110px!important;border-radius:22px!important;padding:10px!important}#rewards .rewards-mission-info{font-size:11px!important;height:30px!important}}
  </style>
