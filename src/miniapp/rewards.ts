export const REWARDS_SECTION = `<section id="rewards" class="view rewards-view">
  <style>
    ...
    #rewards .rewards-hero-image-wrap{position:relative;width:min(56vw,230px);height:clamp(92px,28vw,145px);margin:calc(4px + env(safe-area-inset-top)) auto 4px;display:grid;place-items:center;pointer-events:none;animation:rewardsHeroFloat 5.8s ease-in-out infinite;will-change:transform;filter:drop-shadow(0 18px 26px rgba(0,0,0,.28))}
    ...
    #rewards .rewards-mission-list{margin:4px 0 0!important;display:grid!important;gap:12px!important;align-content:start!important}
    ...
    #rewards .rewards-mission-button{width:100%!important;height:42px!important;border-radius:17px!important;border:0!important;background:rgba(255,255,255,.12)!important;color:#fff!important;font-size:13px!important;font-weight:950!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.09),inset 0 -1px 0 rgba(255,255,255,.055),0 12px 24px rgba(0,0,0,.2)!important;backdrop-filter:blur(10px) saturate(1.12)!important;-webkit-backdrop-filter:blur(10px) saturate(1.12)!important}
    #rewards .rewards-mission-button:active{transform:scale(.98)!important;background:rgba(255,255,255,.18)!important}
    ...
    @media(max-width:380px){#rewards{padding-left:14px!important;padding-right:14px!important}#rewards .rewards-hero-image-wrap{width:min(52vw,200px);height:clamp(82px,25vw,125px);margin-top:calc(0px + env(safe-area-inset-top))}#rewards .rewards-mission-card{min-height:146px!important;border-radius:26px!important}}
  </style>
