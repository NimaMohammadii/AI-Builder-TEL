export const REWARDS_SECTION = `<section id="rewards" class="view rewards-view">
  ...
  <article class="rewards-mission-card rewards-daily-top">
    ...
    <div class="rewards-mission-info">Reward: 0.20 TON</div>
  ...
  <div class="rewards-mission-list" aria-label="Rewards missions">
    <article class="rewards-mission-card" data-rewards-invite-card data-rewards-invite-value="0">
      ...
      <div class="rewards-mission-info">Reward: 5 TON for 20 friends</div>
    ...
    <article class="rewards-mission-card">
      ...
      <div class="rewards-mission-info">Reward: 1 TON</div>
    ...
    <article class="rewards-mission-card">
      ...
      <div class="rewards-mission-info">Reward: 0.50 TON</div>
    ...
    <article class="rewards-mission-card">
      ...
      <div class="rewards-mission-info">Reward: 2 TON</div>
