...
(function(){
  ...
  window.VexaTonBalance={read:read,write:write,add:add,render:function(){return render(read())},load:load,format:formatTon,rate:NANO_PER_TON,parse:parseTonText,plinkoUnitNano:PLINKO_UNIT_NANO};
