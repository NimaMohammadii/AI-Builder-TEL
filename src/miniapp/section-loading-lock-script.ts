...
(function(){
  ...
  function style(){
    ...
    s.id='slmcss';
    s.textContent='body.section-loading-active{background:#000!important}body.section-loading-active .app,body.section-loading-active .content{background:#000!important;padding-left:0!important;padding-right:0!important;margin-left:0!important;margin-right:0!important}body.section-loading-active .top{display:none!important}.view.is-section-loading-active,.view.is-section-loading-pending{position:relative!important;display:block!important;width:100%!important;max-width:none!important;min-height:calc(100vh - 96px)!important;margin:0!important;padding-left:0!important;padding-right:0!important;overflow:hidden!important;background:#000!important;transition:background .28s ease}.view.is-section-loading-active>*:not(.section-loading-mode),.view.is-section-loading-pending>*:not(.section-loading-mode){display:none!important}.section-loading-mode{position:relative!important;width:100%!important;max-width:none!important;min-height:calc(100vh - 96px)!important;display:grid!important;place-items:center!important;background:#000!important;color:#fff!important;opacity:0;transform:translateY(12px) scale(.992);animation:slmEnter .42s cubic-bezier(.2,.9,.2,1) forwards}.section-loading-mode-box{width:min(74vw,320px);display:grid;gap:16px;justify-items:center;transform:translateY(14vh);animation:slmRise .52s cubic-bezier(.2,.9,.2,1) both}.section-loading-mode-title{margin:0;color:#fff;font-size:13px;font-weight:850;letter-spacing:.16em;text-transform:uppercase}.section-loading-mode-progress{width:100%;display:grid;grid-template-columns:1fr;align-items:center;justify-items:center;gap:12px}.section-loading-mode-line{width:100%;height:4px;background:rgba(255,255,255,.13);overflow:hidden;border-radius:999px;box-shadow:0 0 0 1px rgba(255,255,255,.035),0 18px 44px rgba(0,0,0,.45)}.section-loading-mode-line i{display:block;height:100%;width:0;background:#fff;border-radius:999px;box-shadow:0 0 22px rgba(255,255,255,.58);transition:width .35s linear}.section-loading-mode-percent{display:block;color:rgba(255,255,255,.74);font-size:12px;font-weight:850;text-align:center;font-variant-numeric:tabular-nums}@keyframes slmEnter{to{opacity:1;transform:translateY(0) scale(1)}}@keyframes slmRise{from{opacity:.62;transform:translateY(calc(14vh + 18px))}to{opacity:1;transform:translateY(14vh)}}';
