...
/* Wide Layout only: one shared landscape layout for phone/tablet/iPad plus laptop/desktop. */
@media(orientation:landscape) and (min-width:600px){
  ...
  .tabs .tab{height:100%!important;border-radius:19px!important;font-size:12.5px!important;font-weight:760!important;letter-spacing:-.02em!important;padding:0 10px!important;color:rgba(255,255,255,.64)!important;text-shadow:none!important}
  .tabs .tab.active{background:linear-gradient(145deg,#f9f9fa 0%,#e7e7e9 58%,#ceced2 100%)!important;color:#111216!important;box-shadow:0 7px 18px rgba(0,0,0,.25),inset 0 1px 0 rgba(255,255,255,.98),inset 0 -1px 0 rgba(63,63,68,.14)!important}
}
`;
