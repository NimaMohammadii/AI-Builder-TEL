...
.tabs{position:absolute!important;left:50%!important;right:auto!important;bottom:calc(12px + env(safe-area-inset-bottom))!important;width:340px!important;max-width:calc(100% - 56px)!important;height:58px!important;border:0!important;outline:0!important;background:rgba(255,255,255,.035)!important;box-shadow:0 18px 42px rgba(0,0,0,.16),inset 0 1px 0 rgba(255,255,255,.16)!important;backdrop-filter:blur(10px) saturate(1.18)!important;-webkit-backdrop-filter:blur(10px) saturate(1.18)!important;overflow:hidden!important;transform:translateX(-50%)!important}
