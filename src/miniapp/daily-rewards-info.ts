export const DAILY_REWARDS_INFO_SECTION = `<section id="dailyrewardsinfo" class="view daily-rewards-info-view">
  <style>
    ...
    .daily-info-list{position:relative;min-height:0;display:grid;gap:12px;align-content:start;overflow-y:auto!important;overflow-x:hidden!important;-webkit-overflow-scrolling:touch;overscroll-behavior-y:contain;scrollbar-width:none;padding:0 0 70px!important;mask-image:linear-gradient(to bottom,#000 0,#000 calc(100% - 58px),rgba(0,0,0,0));-webkit-mask-image:linear-gradient(to bottom,#000 0,#000 calc(100% - 58px),rgba(0,0,0,0))}.daily-info-list::-webkit-scrollbar{display:none}
    .daily-info-row{display:grid;grid-template-columns:132px minmax(0,1fr);align-items:center;gap:14px;min-height:138px;padding:12px 12px 12px 10px;border-radius:26px;background:rgba(255,255,255,.04);box-shadow:inset 0 1px 0 rgba(255,255,255,.08),0 14px 28px rgba(0,0,0,.12);backdrop-filter:blur(3px);-webkit-backdrop-filter:blur(3px)}
    ...
    .daily-info-img{width:132px;height:112px;border-radius:0;background:transparent!important;overflow:visible;display:grid;place-items:center;box-shadow:none!important;backdrop-filter:none!important;-webkit-backdrop-filter:none!important}.daily-info-img img{width:100%;height:100%;object-fit:contain;display:block;background:transparent!important;border:0!important;border-radius:0!important;box-shadow:none!important;filter:drop-shadow(0 16px 24px rgba(0,0,0,.28))}.daily-info-img span{color:rgba(255,255,255,.3);font-size:9px;font-weight:800}
    .daily-info-main{min-width:0}.daily-info-main b{display:block;color:#fff;font-size:15px;font-weight:900;line-height:1;letter-spacing:-.025em}.daily-info-main small{display:block;margin-top:8px;color:rgba(255,255,255,.58);font-size:11px;font-weight:620;line-height:1.32}.daily-info-day{height:25px;display:inline-grid;place-items:center;padding:0 10px;border-radius:999px;background:rgba(126,20,48,.16);color:rgba(255,255,255,.84);font-size:9px;font-weight:900;margin-bottom:8px}
  </style>
