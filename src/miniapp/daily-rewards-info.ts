export const DAILY_REWARDS_INFO_SECTION = `<section id="dailyrewardsinfo" class="view daily-rewards-info-view">
  <style>
    ...
    .daily-info-page{position:relative;height:100%;min-height:0;padding:0;display:grid;grid-template-rows:auto minmax(0,1fr);gap:12px;align-content:start}
    ...
    .daily-info-list{position:relative;min-height:0;display:block;overflow-y:auto!important;overflow-x:hidden!important;-webkit-overflow-scrolling:touch;overscroll-behavior-y:contain;scrollbar-width:none;padding:4px 0 128px!important;mask-image:linear-gradient(to bottom,#000 0,#000 calc(100% - 58px),rgba(0,0,0,0));-webkit-mask-image:linear-gradient(to bottom,#000 0,#000 calc(100% - 58px),rgba(0,0,0,0))}.daily-info-list::-webkit-scrollbar{display:none}
    @keyframes dailyInfoStepIn{from{opacity:0;transform:translateY(18px) scale(.985)}to{opacity:1;transform:translateY(0) scale(1)}}
    .daily-info-row{display:grid;grid-template-columns:158px minmax(0,1fr);align-items:start;gap:14px;min-height:130px;padding:0 13px 8px 0;border-radius:26px;background:rgba(255,255,255,.04);box-shadow:inset 0 1px 0 rgba(255,255,255,.08),0 14px 28px rgba(0,0,0,.12);backdrop-filter:blur(3px);-webkit-backdrop-filter:blur(3px);overflow:visible!important;position:relative;width:calc(100% - 20px);margin:0 0 62px 0;animation:dailyInfoStepIn .42s cubic-bezier(.2,.8,.2,1) both}
    .daily-info-row:nth-child(even){margin-left:20px}
    .daily-info-row:nth-child(3n){margin-left:10px}
    .daily-info-row:nth-child(1){animation-delay:.02s}.daily-info-row:nth-child(2){animation-delay:.06s}.daily-info-row:nth-child(3){animation-delay:.10s}.daily-info-row:nth-child(4){animation-delay:.14s}.daily-info-row:nth-child(5){animation-delay:.18s}.daily-info-row:nth-child(6){animation-delay:.22s}.daily-info-row:nth-child(7){animation-delay:.26s}
    ...
    .daily-info-img{align-self:start;width:142px;height:158px;margin-left:14px;border-radius:0;background:transparent!important;overflow:visible;display:grid;place-items:start center;box-shadow:none!important;backdrop-filter:none!important;-webkit-backdrop-filter:none!important}.daily-info-img img{width:100%;height:100%;object-fit:contain;object-position:top center;display:block;background:transparent!important;border:0!important;border-radius:0!important;box-shadow:none!important;filter:drop-shadow(0 16px 24px rgba(0,0,0,.28))}.daily-info-img span{color:rgba(255,255,255,.3);font-size:9px;font-weight:800}
    .daily-info-main{min-width:0;padding:15px 0 10px}.daily-info-main b{display:block;color:#fff;font-size:16px;font-weight:900;line-height:1;letter-spacing:-.025em}.daily-info-main small{display:block;margin-top:8px;color:rgba(255,255,255,.6);font-size:11.5px;font-weight:620;line-height:1.34}.daily-info-day{height:26px;display:inline-grid;place-items:center;padding:0 10px;border-radius:999px;background:rgba(126,20,48,.16);color:rgba(255,255,255,.84);font-size:9.5px;font-weight:900;margin-bottom:9px}
  </style>
