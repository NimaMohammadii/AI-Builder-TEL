...
(function(){
  ...
  function animateDrop(btn){if(!btn)return;btn.classList.remove('plinko-drop-tap');requestAnimationFrame(function(){btn.classList.add('plinko-drop-tap')});clearTimeout(btn.__plinkoDropTapTimer);btn.__plinkoDropTapTimer=setTimeout(function(){btn.classList.remove('plinko-drop-tap')},220)}
