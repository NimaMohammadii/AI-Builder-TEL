...
(function(){
  ...
  function installStyles(){
    ...
    style.textContent='#depositSheet .deposit-action-row{width:min(100%,340px)!important;margin:0 auto 18px!important;display:grid!important;grid-template-columns:1fr 1fr!important;gap:10px!important;align-items:center!important}#depositSheet .deposit-action-row .deposit-pay-button{width:100%!important;margin:0!important;height:54px!important;transition:background .28s ease,transform .28s ease,opacity .28s ease!important}#depositSheet .deposit-action-row .deposit-pay-button.ton-mode{background:linear-gradient(135deg,rgba(0,40,62,.28),rgba(255,255,255,.045))!important}.deposit-mode-switch{height:54px!important;border-radius:999px!important;background:rgba(255,255,255,.055)!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.10)!important;padding:5px!important;display:grid!important;grid-template-columns:1fr 1fr!important;position:relative!important;overflow:hidden!important}.deposit-mode-switch:before{content:"";position:absolute!important;top:5px!important;bottom:5px!important;left:5px!important;width:calc(50% - 5px)!important;border-radius:999px!important;background:rgba(255,255,255,.15)!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.16)!important;transition:transform .30s cubic-bezier(.16,1,.3,1)!important}.deposit-mode-switch.ton:before{transform:translateX(100%)!important;background:rgba(0,40,62,.38)!important}.deposit-mode-switch button{position:relative!important;z-index:1!important;border:0!important;background:transparent!important;color:rgba(255,255,255,.56)!important;font-size:12px!important;font-weight:950!important;border-radius:999px!important}.deposit-mode-switch:not(.ton) button[data-mode="stars"],.deposit-mode-switch.ton button[data-mode="ton"]{color:#fff!important}#depositSheet .deposit-ton-equivalent{transition:opacity .22s ease,transform .22s ease,background .22s ease!important}#depositSheet.deposit-ton-mode .deposit-ton-equivalent{background:rgba(255,255,255,.075)!important;color:rgba(255,255,255,.82)!important;transform:scale(1.02)!important}.ton-wallet-status{min-height:17px!important;margin:8px 0 0!important;text-align:center!important;color:rgba(255,255,255,.62)!important;font-size:11px!important;font-weight:750!important;line-height:1.35!important}.ton-wallet-status.success{color:#42f594!important}.ton-wallet-status.error{color:#ff7b9a!important}.ton-wallet-status.pending{color:#ffcf6b!important}';
