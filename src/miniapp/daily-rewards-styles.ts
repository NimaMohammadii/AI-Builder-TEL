...
#home .daily-rewards-day{position:relative;flex:0 0 128px;width:128px;height:164px;border:0!important;outline:0!important;border-radius:28px;background:rgba(255,255,255,.026)!important;background-image:none!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.07),0 16px 42px rgba(0,0,0,.24)!important;backdrop-filter:blur(3px) saturate(1.14)!important;-webkit-backdrop-filter:blur(3px) saturate(1.14)!important;scroll-snap-align:start;box-sizing:border-box;overflow:hidden!important;padding:0!important;display:block!important;cursor:pointer;transition:opacity .22s ease,filter .22s ease,transform .18s ease}
...
#home .daily-rewards-card-img{position:absolute;inset:6px;width:calc(100% - 12px);height:calc(100% - 12px);object-fit:cover;object-position:center;display:block;border:0!important;outline:0!important;border-radius:23px;background:transparent!important;box-shadow:none!important}
#home .daily-rewards-day.locked{opacity:.38;filter:saturate(.55) brightness(.72)}
#home .daily-rewards-day.locked .daily-rewards-card-img{filter:grayscale(.58) brightness(.72);opacity:.66}
#home .daily-rewards-day.claimed{opacity:.82;filter:none}
#home .daily-rewards-day.today{opacity:1;filter:none}
#home .daily-rewards-day.can-claim:active{transform:scale(.985)}
#home .daily-rewards-day.claiming{pointer-events:none;filter:brightness(1.08)}
