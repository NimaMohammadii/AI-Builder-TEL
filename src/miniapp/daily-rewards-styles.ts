...
@media(max-width:380px){#home .daily-rewards-drop-banner{left:50%;top:calc(-18px + env(safe-area-inset-top));width:136px;height:178px;transform:translate3d(-42%,0,0)}#home .daily-rewards-drop-banner.can-claim:active{transform:translate3d(-42%,0,0) scale(.985)}}
`;