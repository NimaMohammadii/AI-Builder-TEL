...
@media(max-width:380px){#home .daily-rewards-day{flex-basis:118px;width:118px;height:154px;border-radius:26px!important}#home .daily-rewards-card-img{border-radius:24px!important}}
`;