...
#home .daily-rewards-drop-banner{position:absolute;left:47.5%;top:calc(-34px + env(safe-area-inset-top));width:156px;height:204px;border:0!important;outline:0!important;border-radius:28px!important;background:rgba(255,255,255,.035)!important;background-image:none!important;box-shadow:0 18px 44px rgba(0,0,0,.22),inset 0 1px 0 rgba(255,255,255,.10)!important;backdrop-filter:blur(3px)!important;-webkit-backdrop-filter:blur(3px)!important;box-sizing:border-box;overflow:visible!important;padding:0!important;display:block!important;cursor:pointer;appearance:none!important;-webkit-appearance:none!important;pointer-events:auto;transform:translate3d(-42%,0,0);transform-origin:50% 0;animation:dailyRewardFlagDrop .82s cubic-bezier(.2,.84,.18,1) both;will-change:transform,opacity;z-index:96;backface-visibility:hidden;-webkit-backface-visibility:hidden}
...
#home .daily-rewards-banner-frame{position:absolute;inset:0;display:block;border-radius:28px!important;overflow:visible!important;background:transparent!important;transform-origin:50% 0;animation:dailyRewardFlagSettle .82s cubic-bezier(.2,.84,.18,1) both;will-change:transform;backface-visibility:hidden;-webkit-backface-visibility:hidden}
#home .daily-rewards-banner-img{position:absolute;inset:0;width:100%;height:100%;object-fit:contain;object-position:center top;display:block;border:0!important;outline:0!important;border-radius:28px!important;background:transparent!important;box-shadow:none!important;opacity:1;filter:brightness(.94);transform-origin:50% 0;animation:dailyRewardFlagSoftWave .82s ease-out both;will-change:transform;backface-visibility:hidden;-webkit-backface-visibility:hidden}
...
@media(max-width:380px){#home .daily-rewards-drop-banner{left:48.5%;top:calc(-36px + env(safe-area-inset-top));width:144px;height:188px;transform:translate3d(-42%,0,0)}#home .daily-rewards-drop-banner.can-claim:active{transform:translate3d(-42%,0,0) scale(.985)}}
`;