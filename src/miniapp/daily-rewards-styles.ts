...
@keyframes dailyRewardBannerDrop{0%{opacity:0;transform:translate(-42%,-140%)}72%{opacity:1;transform:translate(-42%,6px)}100%{opacity:1;transform:translate(-42%,0)}}
@media(max-width:380px){#home .daily-rewards-drop-banner{left:59%;width:158px;height:206px;transform:translate(-42%,0)}#home .daily-rewards-drop-banner.can-claim:active{transform:translate(-42%,0) scale(.985)}@keyframes dailyRewardBannerDrop{0%{opacity:0;transform:translate(-42%,-140%)}72%{opacity:1;transform:translate(-42%,6px)}100%{opacity:1;transform:translate(-42%,0)}}}
`;