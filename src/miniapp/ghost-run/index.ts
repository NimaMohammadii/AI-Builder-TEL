...
#ghostrun .ghost-run-fear-wrap{display:grid!important;grid-template-columns:1fr auto!important;grid-template-rows:auto auto!important;column-gap:8px!important;row-gap:7px!important;align-items:center!important;width:176px!important;min-width:176px!important;max-width:calc(100vw - 32px)!important;box-sizing:border-box!important;padding:10px 12px!important;border-radius:20px!important;background:rgba(0,0,0,.24)!important;border:1px solid rgba(255,255,255,.07)!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.10)!important;backdrop-filter:blur(8px)!important;-webkit-backdrop-filter:blur(8px)!important;overflow:hidden!important}
#ghostrun .ghost-run-fear-top{grid-column:1!important;grid-row:1!important;margin:0!important;display:flex!important;align-items:center!important;gap:8px!important;justify-content:space-between!important;line-height:1!important;overflow:hidden!important}
#ghostrun .ghost-run-fear-track{grid-column:1 / 3!important;grid-row:2!important;height:8px!important;margin:0!important}
#ghostrun .ghost-run-fear-wrap .ghost-run-multiplier{grid-column:2!important;grid-row:1!important;position:static!important;display:inline-flex!important;align-items:center!important;justify-content:flex-end!important;min-width:auto!important;height:auto!important;padding:0!important;margin:0!important;border:0!important;border-radius:0!important;background:transparent!important;box-shadow:none!important;backdrop-filter:none!important;-webkit-backdrop-filter:none!important}
#ghostrun .ghost-run-fear-top strong,#ghostrun .ghost-run-fear-wrap .ghost-run-multiplier{font-size:13px!important;font-weight:950!important;line-height:1!important;letter-spacing:.02em!important;color:#fff!important;text-shadow:0 7px 18px rgba(0,0,0,.44)!important;white-space:nowrap!important}
  ...
  const safeAssetLoader = `function cssUrl(url){var clean=String(url||'').split("'").join('').split(')') .join('').split('"').join('');return "url('"+clean+"')"}
    ...
    function injectAssetUrls(urls){
      ...
      style.textContent=[
        "#ghostrun .ghost-run-reaper{display:none!important;visibility:hidden!important;opacity:0!important}",
        "#ghostrun .ghost-run-state{display:none!important;opacity:0!important;visibility:hidden!important}",
        "#ghostrun .ghost-run-fear-wrap{display:grid!important;grid-template-columns:1fr auto!important;grid-template-rows:auto auto!important;column-gap:8px!important;row-gap:7px!important;align-items:center!important;width:176px!important;min-width:176px!important;max-width:calc(100vw - 32px)!important;box-sizing:border-box!important;overflow:hidden!important;padding:10px 12px!important}",
        "#ghostrun .ghost-run-fear-wrap .ghost-run-multiplier{grid-column:2!important;grid-row:1!important;position:static!important;display:inline-flex!important;align-items:center!important;justify-content:flex-end!important;min-width:auto!important;height:auto!important;padding:0!important;margin:0!important;border:0!important;border-radius:0!important;background:transparent!important;box-shadow:none!important;backdrop-filter:none!important;-webkit-backdrop-filter:none!important;font-size:13px!important;font-weight:950!important;line-height:1!important;letter-spacing:.02em!important;color:#fff!important;text-shadow:0 7px 18px rgba(0,0,0,.44)!important;white-space:nowrap!important}",
