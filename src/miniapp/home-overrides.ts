...
#home .deposit-panel .deposit-title,#home .deposit-panel .deposit-copy,#home .deposit-panel .deposit-custom-field,#home .deposit-panel .deposit-pay-button,#home .deposit-panel .deposit-stars-logo,#home .withdraw-status,#home .withdraw-success{opacity:0;animation:depositItemIn .42s cubic-bezier(.18,.88,.22,1.08) forwards}
#home .deposit-panel .deposit-title{animation-delay:.04s}#home .deposit-panel .deposit-copy{animation-delay:.10s}#home .deposit-panel .deposit-custom-field{animation-delay:.16s}#home .deposit-panel .deposit-pay-button{animation-delay:.22s}#home .deposit-panel .deposit-stars-logo,#home .withdraw-status,#home .withdraw-success{animation-delay:.29s}
...
@media(prefers-reduced-motion:reduce){#home .deposit-panel,#home .deposit-panel .deposit-title,#home .deposit-panel .deposit-copy,#home .deposit-panel .deposit-custom-field,#home .deposit-panel .deposit-pay-button,#home .deposit-panel .deposit-stars-logo,#home .deposit-stars-logo svg,#home .withdraw-status,#home .withdraw-success,#home .withdraw-success svg,#home .withdraw-success svg path{animation:none!important;opacity:1!important;transform:none!important;stroke-dashoffset:0!important}}
`;
