...
#predictzone .football-detail-page{min-height:calc(100dvh - 250px);display:grid;align-content:start;gap:16px;padding-top:2px;animation:footballDetailIn .22s ease-out both}
