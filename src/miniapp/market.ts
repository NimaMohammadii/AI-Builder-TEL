...
export const MARKET_SECTION = `<section id="market" class="view market-view"><div class="market-segment" role="tablist" aria-label="Market tabs"><button class="market-segment-btn active" type="button" data-market-tab="store">Market</button><span class="market-segment-split"><button class="market-segment-btn" type="button" data-market-tab="owned">My NFTs</button><button class="market-segment-btn" type="button" data-market-tab="listed">Listed</button></span></div><div class="market-tab-panel active" data-market-panel="store"><div class="market-grid game-grid">${marketItems.map(nftCard).join('')}</div></div><div class="market-tab-panel" data-market-panel="owned"><div class="market-grid game-grid market-owned-grid" data-market-owned-grid></div><div class="market-owned-empty" data-market-owned-empty><div class="market-owned-icon">◆</div><strong>No NFTs yet</strong><p>Your purchased NFTs will appear here.</p></div></div><div class="market-tab-panel" data-market-panel="listed"><div class="market-owned-empty"><div class="market-owned-icon">↗</div><strong>No listed NFTs</strong><p>NFTs you put up for sale will appear here.</p></div></div>${detailSheet}</section>`;
