...
const detailSheet = `<div id="marketDetailSheet" class="market-detail-sheet" aria-hidden="true"><div class="market-detail-backdrop" data-market-detail-close="1"></div><article class="market-detail-card" role="dialog" aria-modal="true" aria-label="NFT details"><button class="market-detail-close" type="button" data-market-detail-close="1">×</button><div class="market-detail-media" data-market-detail-media></div><div class="market-detail-body"><div class="market-detail-kicker" data-market-detail-collection>Vexa Collectible</div><h2 data-market-detail-title>NFT</h2><p data-market-detail-description></p><div class="market-detail-price"><span>Price</span><strong><img src="${creditLogo}" alt="" decoding="async" onerror="this.onerror=null;this.src='${fallbackCreditLogo}'"/><b data-market-detail-price>0</b></strong></div><div class="market-detail-specs" data-market-detail-specs></div><button class="market-detail-buy" type="button" data-market-buy=""><img src="${creditLogo}" alt="" decoding="async" onerror="this.onerror=null;this.src='${fallbackCreditLogo}'"/><span>Buy NFT</span></button><p class="market-detail-status" data-market-detail-status></p></div></article></div>`;
