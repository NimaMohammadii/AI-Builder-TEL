...
const detailSheet = `<div id="marketDetailSheet" class="deposit-sheet market-detail-sheet" aria-hidden="true"><div class="deposit-backdrop market-detail-backdrop" data-market-detail-close="1"></div><div class="deposit-panel card market-detail-card" role="dialog" aria-modal="true" aria-label="NFT details"><div class="pad market-detail-pad"><div class="title deposit-title market-detail-titlebar"><div class="deposit-title-main"><div class="market-detail-thumb" data-market-detail-media></div><div><span class="market-detail-kicker" data-market-detail-collection>Vexa Collectible</span><h3 data-market-detail-title>NFT</h3></div></div><button class="ghost deposit-close" type="button" data-market-detail-close="1" aria-label="Close"><svg viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M6 6l12 12M18 6L6 18" stroke="currentColor" stroke-width="2.6" stroke-linecap="round"/></svg></button></div><p class="deposit-copy market-detail-description" data-market-detail-description></p><div class="market-detail-specs" data-market-detail-specs></div><div class="market-detail-price"><span>Price</span><strong><img src="${creditLogo}" alt="" decoding="async" onerror="this.onerror=null;this.src='${fallbackCreditLogo}'"/><b data-market-detail-price>0</b></strong></div><button class="primary deposit-pay-button market-detail-buy" type="button" data-market-buy=""><img src="${creditLogo}" alt="" decoding="async" onerror="this.onerror=null;this.src='${fallbackCreditLogo}'"/><span>Buy NFT</span></button><p class="market-detail-status" data-market-detail-status></p></div></div></div>`;
