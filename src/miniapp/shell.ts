...
import { BALANCE_WALLET_SECTION } from './balance-wallet';
...
<body>
  ...
  <main class="app">
    <header class="top">
      ...
      <button class="top-balance-pill" type="button" data-view="balancewallet" aria-label="Open wallet page">
