...
(function(){
  function apply(){
    ...
    style.textContent='#depositSheet .deposit-close,#withdrawSheet .deposit-close{width:42px!important;height:42px!important;min-width:42px!important;border-radius:999px!important;background:linear-gradient(180deg,rgba(255,255,255,.075),rgba(255,255,255,.025))!important;border:1px solid rgba(255,255,255,.075)!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.13),0 12px 28px rgba(0,0,0,.22)!important;backdrop-filter:blur(9px) saturate(1.18)!important;-webkit-backdrop-filter:blur(9px) saturate(1.18)!important;color:rgba(255,255,255,.76)!important;display:grid!important;place-items:center!important;padding:0!important}#depositSheet .deposit-close svg,#withdrawSheet .deposit-close svg{width:15px!important;height:15px!important;display:block!important;opacity:.88!important;color:currentColor!important}#depositSheet .deposit-close svg path,#withdrawSheet .deposit-close svg path{stroke:currentColor!important;stroke-width:1.75!important;stroke-linecap:round!important}#depositSheet .deposit-close:active,#withdrawSheet .deposit-close:active{transform:scale(.94)!important;background:linear-gradient(180deg,rgba(255,255,255,.105),rgba(255,255,255,.035))!important}';
    ['depositSheet','withdrawSheet'].forEach(function(id){var b=document.querySelector('#'+id+' .deposit-close');if(!b)return;b.innerHTML='<svg viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M8.25 8.25l7.5 7.5M15.75 8.25l-7.5 7.5" stroke="currentColor" stroke-width="1.75" stroke-linecap="round"/></svg>'});
  }
