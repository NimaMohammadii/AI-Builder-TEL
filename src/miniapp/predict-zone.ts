...
.predict-zone-result-strip{position:relative;width:100%;max-width:100%;box-sizing:border-box;margin:10px 0 0;display:none;overflow-x:auto;overflow-y:hidden;scrollbar-width:none}.predict-zone-result-strip::-webkit-scrollbar{display:none}.predict-zone-result-strip.show{display:block}.predict-zone-history-track{display:flex;gap:6px;width:max-content;min-width:100%;padding:0 0 1px}.predict-zone-history-track::-webkit-scrollbar{display:none}.predict-zone-history-card{flex:0 0 auto;min-width:92px;white-space:nowrap;background:#000!important}.predict-zone-history-card.history-up{color:#d7e9dd!important}.predict-zone-history-card.history-down{color:#e4a1b2!important}
...
(function(){
  ...
  ready(function(){
    ...
    var W=360,H=220,L=14,R=58,P=24,HISTORY=23;
