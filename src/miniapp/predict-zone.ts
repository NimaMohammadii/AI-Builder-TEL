...
html:has(#predictzone.predict-zone-keyboard-open.active),html body:has(#predictzone.predict-zone-keyboard-open.active),html body:has(#predictzone.predict-zone-keyboard-open.active) .app,html body:has(#predictzone.predict-zone-keyboard-open.active) main.app,html body:has(#predictzone.predict-zone-keyboard-open.active) .content{background:transparent!important;background-color:transparent!important;background-image:none!important}
html body:has(#predictzone.predict-zone-keyboard-open.active)::before{display:none!important}
