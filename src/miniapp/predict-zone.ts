    ...
    <article class="predict-zone-glass-card predict-zone-btc-preview-card trend-flat" data-predict-card>
      ...
      <div class="predict-zone-chart-preview" data-predict-chart aria-label="Live chart preview">
        ...
        <svg viewBox="0 0 360 220" preserveAspectRatio="none" aria-hidden="true">
          <defs>
            <linearGradient id="predictMainLine" x1="0" x2="1" y1="0" y2="0"><stop offset="0%" stop-color="rgba(255,205,72,.035)"/><stop offset="48%" stop-color="rgba(255,211,86,.95)"/><stop offset="100%" stop-color="rgba(255,222,118,.72)"/></linearGradient>
            <linearGradient id="predictMainFill" x1="0" x2="0" y1="0" y2="1"><stop offset="0%" stop-color="rgba(255,207,78,.17)"/><stop offset="100%" stop-color="rgba(255,207,78,0)"/></linearGradient>
          </defs>
...
(function(){
  ...
  ready(function(){
    ...
    var W=360,H=220,L=14,R=66,P=24,HISTORY=23;
