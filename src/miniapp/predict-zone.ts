...
html body:has(#predictzone.active)::before{content:""!important;display:block!important;position:fixed!important;inset:0!important;width:100vw!important;height:100dvh!important;z-index:0!important;pointer-events:none!important;background-color:#000!important;background-image:radial-gradient(circle at 50% 10%,rgba(92,10,31,.18),transparent 38%),linear-gradient(180deg,#090306 0%,#000 72%)!important;background-size:cover,cover!important;background-position:center,center!important;background-repeat:no-repeat!important;transform:none!important;animation:none!important;filter:none!important;opacity:1!important}
...
(function(){
  ...
  ready(function(){
    ...
    function startChartMotion(){
      if(chartMotionRaf||!readyPrice||!isActive()||eventMode)return;
      ...
      function step(ts){
        ...
        if(!chartMotionFrame||ts-chartMotionFrame>=32){chartMotionFrame=ts;updateChartPrice(ts);if(!betAnimating)draw()}
