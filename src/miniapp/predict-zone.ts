...
.predict-zone-result-strip{position:relative;margin:10px 0 0;display:none;overflow:visible}.predict-zone-result-strip.show{display:block}.predict-zone-history-track{display:flex;gap:6px;overflow-x:auto;overflow-y:hidden;padding:0;scrollbar-width:none}.predict-zone-history-track::-webkit-scrollbar{display:none}.predict-zone-history-card{flex:0 0 auto;min-width:92px;white-space:nowrap;background:#000!important}.predict-zone-history-card.history-up{color:#d7e9dd!important}.predict-zone-history-card.history-down{color:#e4a1b2!important}
