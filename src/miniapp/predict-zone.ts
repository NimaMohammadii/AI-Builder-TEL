export const PREDICT_ZONE_SECTION = `<section id="predictzone" class="view predict-zone-view">
  <div class="predict-zone-simple-shell">
    ...
    <article class="predict-zone-glass-card predict-zone-btc-preview-card trend-flat" data-predict-card>
      <div class="predict-zone-market-stage">
      ...
      <div class="predict-zone-bet-stage" data-predict-bet-stage aria-hidden="true">
        <div class="predict-zone-bet-head"><div><span>Prediction</span><div class="predict-zone-bet-selection"><i data-predict-bet-direction aria-hidden="true">↑</i><strong data-predict-bet-title>Up on Bitcoin</strong></div></div><button type="button" class="predict-zone-bet-close" data-predict-bet-close aria-label="Close">×</button></div>
        ...
        <p class="predict-zone-bet-note">Pool-based prediction. Stake is locked from your GRAM balance.</p>
      </div>
    </article>
  </div>
</section>`;
...
.predict-zone-market-stage{position:relative;z-index:1;opacity:1;transform:translate3d(0,0,0) scale(1);transform-origin:center 58%;transition:opacity .2s ease,transform .42s cubic-bezier(.18,.88,.24,1);will-change:opacity,transform}
.predict-zone-bet-stage{position:absolute!important;inset:10px 12px!important;z-index:3!important;display:grid;align-content:center;overflow:hidden;opacity:0;visibility:hidden;pointer-events:none;transform:translate3d(0,16px,0) scale(.982);transform-origin:center 54%;transition:opacity .2s ease,transform .44s cubic-bezier(.18,.88,.24,1),visibility 0s linear .44s}.predict-zone-bet-stage>*{opacity:0;transform:translate3d(0,8px,0);transition:opacity .2s ease,transform .38s cubic-bezier(.18,.88,.24,1)}.predict-zone-bet-head{display:flex;align-items:flex-start;justify-content:space-between;gap:12px;margin-bottom:9px}.predict-zone-bet-head>div>span{display:block;color:rgba(255,255,255,.38);font-size:9px;font-weight:800;text-transform:uppercase;letter-spacing:.12em;margin-bottom:5px}.predict-zone-bet-selection{display:flex;align-items:center;gap:9px}.predict-zone-bet-selection i{display:grid;place-items:center;width:31px;height:31px;border-radius:12px;background:rgba(255,255,255,.065);box-shadow:inset 0 1px 0 rgba(255,255,255,.08);font-size:18px;font-style:normal;font-weight:950;line-height:1}.predict-zone-glass-card.bet-side-up .predict-zone-bet-selection i{color:#cfe9d8;background:rgba(111,184,137,.10)}.predict-zone-glass-card.bet-side-down .predict-zone-bet-selection i{color:#edc9d4;background:rgba(189,91,119,.11)}.predict-zone-bet-head strong{display:block;font-size:20px;font-weight:950;letter-spacing:-.05em}.predict-zone-bet-close{width:31px!important;height:31px!important;border-radius:13px!important;border:0!important;background:rgba(255,255,255,.07)!important;color:#fff!important;font-size:18px!important;transition:transform .24s ease,background-color .24s ease!important}.predict-zone-bet-close:active{transform:scale(.90)!important;background:rgba(255,255,255,.11)!important}.predict-zone-bet-question{font-size:11px;font-weight:750;color:rgba(255,255,255,.58);margin:0 0 9px}.predict-zone-bet-input-wrap{display:grid;grid-template-columns:minmax(0,1fr) auto auto;align-items:center;gap:8px;min-height:56px;border-radius:18px;background:rgba(0,0,0,.26)!important;box-shadow:inset 0 0 0 1px rgba(255,255,255,.06),inset 0 1px 0 rgba(255,255,255,.065),inset 0 -1px 0 rgba(255,255,255,.04)!important;padding:0 13px;margin:0 0 7px;transition:box-shadow .24s ease,background-color .24s ease!important}.predict-zone-bet-input-wrap:focus-within{background:rgba(0,0,0,.34)!important;box-shadow:inset 0 0 0 1px rgba(255,255,255,.13),inset 0 1px 0 rgba(255,255,255,.08),0 0 0 4px rgba(126,25,56,.08)!important}.predict-zone-bet-input{width:100%;min-width:0;border:0!important;outline:0!important;background:transparent!important;box-shadow:none!important;backdrop-filter:none!important;-webkit-backdrop-filter:none!important;color:#fff;font-size:24px;font-weight:950;letter-spacing:-.05em;appearance:textfield}.predict-zone-bet-input::-webkit-outer-spin-button,.predict-zone-bet-input::-webkit-inner-spin-button{appearance:none;margin:0}.predict-zone-bet-estimate{color:rgba(255,255,255,.82);font-size:12px;font-weight:950;white-space:nowrap}.predict-zone-bet-side{display:grid;justify-items:end;gap:3px}.predict-zone-bet-token{font-size:12px;font-weight:900;color:rgba(255,255,255,.66)}.predict-zone-bet-usd{font-size:10px;font-weight:760;color:rgba(255,255,255,.38);white-space:nowrap}.predict-zone-bet-presets{display:grid;grid-template-columns:repeat(4,1fr);gap:7px;margin:7px 0 8px}.predict-zone-bet-presets button,.predict-zone-bet-submit{position:relative!important;overflow:hidden!important;height:36px!important;padding:0 12px!important;border:0!important;border-radius:28px!important;background:radial-gradient(34px 34px at 0 0,rgba(186,53,87,.16) 0%,rgba(146,35,66,.07) 42%,rgba(104,18,44,0) 76%),radial-gradient(36px 36px at 100% 100%,rgba(172,46,79,.15) 0%,rgba(133,30,60,.065) 43%,rgba(94,16,39,0) 78%),radial-gradient(118% 76% at 10% -16%,rgba(255,255,255,.12) 0%,rgba(255,255,255,.032) 30%,rgba(255,255,255,0) 58%),radial-gradient(96% 72% at 102% 108%,rgba(255,255,255,.052) 0%,rgba(255,255,255,.010) 34%,rgba(255,255,255,0) 62%),radial-gradient(92% 78% at 88% 112%,rgba(72,5,27,.11) 0%,rgba(42,3,16,0) 60%)!important;color:#fff!important;font-size:12px!important;font-weight:950!important;box-shadow:0 12px 30px rgba(31,1,10,.32),0 0 18px rgba(69,5,26,.15),inset 3px 3px .5px -3.5px rgba(255,255,255,.10),inset -3px -3px .5px -3.5px rgba(156,38,70,.48),inset 1px 1px 1px -.5px rgba(140,29,61,.30),inset -1px -1px 1px -.5px rgba(124,22,53,.24),inset 0 0 6px 6px rgba(255,255,255,.055),inset 0 0 2px 2px rgba(255,255,255,.035),inset 0 1px 0 rgba(112,18,49,.065),inset 0 -1px 0 rgba(88,12,37,.15)!important;backdrop-filter:blur(22px) saturate(1.40) brightness(1.05) contrast(1.04)!important;-webkit-backdrop-filter:blur(22px) saturate(1.40) brightness(1.05) contrast(1.04)!important;isolation:isolate!important;transform:translate3d(0,0,0)!important;transform-origin:center!important;touch-action:manipulation!important;-webkit-tap-highlight-color:transparent!important;transition:transform .28s cubic-bezier(.18,.88,.24,1),filter .24s ease,opacity .24s ease!important}.predict-zone-bet-submit{width:100%!important}.predict-zone-bet-presets button:active,.predict-zone-bet-submit:active{transform:translate3d(0,1px,0) scale(.96)!important;filter:brightness(1.12) saturate(1.06)!important;transition-duration:.07s!important}.predict-zone-bet-submit:disabled{opacity:.55}.predict-zone-bet-note,.predict-zone-bet-status{margin:6px 0 0;text-align:center;color:rgba(255,255,255,.42);font-size:9px;font-weight:650}.predict-zone-bet-status{min-height:13px;font-size:10px;font-weight:760}.predict-zone-bet-status.bad{color:rgba(255,160,160,.9)}.predict-zone-bet-status.good{color:rgba(185,255,210,.9)}

#predictzone.predict-zone-betting .predict-zone-category-menu{opacity:.24!important;transform:translate3d(0,-4px,0) scale(.99)!important;pointer-events:none!important}.predict-zone-glass-card.bet-mode .predict-zone-market-stage{opacity:0;transform:translate3d(0,-10px,0) scale(.982);pointer-events:none}.predict-zone-glass-card.bet-mode .predict-zone-bet-stage{opacity:1;visibility:visible;pointer-events:auto;transform:translate3d(0,0,0) scale(1);transition-delay:.06s,0s,0s}.predict-zone-glass-card.bet-mode .predict-zone-bet-stage>*{opacity:1;transform:translate3d(0,0,0)}.predict-zone-glass-card.bet-mode .predict-zone-bet-stage>:nth-child(1){transition-delay:.10s}.predict-zone-glass-card.bet-mode .predict-zone-bet-stage>:nth-child(2){transition-delay:.13s}.predict-zone-glass-card.bet-mode .predict-zone-bet-stage>:nth-child(3){transition-delay:.16s}.predict-zone-glass-card.bet-mode .predict-zone-bet-stage>:nth-child(4){transition-delay:.19s}.predict-zone-glass-card.bet-mode .predict-zone-bet-stage>:nth-child(5){transition-delay:.22s}.predict-zone-glass-card.bet-mode .predict-zone-bet-stage>:nth-child(6),.predict-zone-glass-card.bet-mode .predict-zone-bet-stage>:nth-child(7){transition-delay:.24s}

@media(max-width:380px){.predict-zone-view{padding-left:0!important;padding-right:0!important}#predictzone .predict-zone-category-menu{left:0!important;width:100%!important;padding-left:0!important;padding-right:0!important}.predict-zone-glass-card{min-height:0!important;padding:10px 12px!important}.predict-zone-card-top{top:18px!important;right:12px!important}.predict-zone-countdown{font-size:17px!important}.predict-zone-hero{padding-right:72px}.predict-zone-question-row{font-size:17px!important}.predict-zone-question-image{flex-basis:38px;width:38px;height:38px}.predict-zone-live-meta>div{height:44px!important;padding:6px 8px!important}.predict-zone-live-meta strong{font-size:12px!important}.predict-zone-chart-preview{height:158px!important;border-radius:20px!important}.predict-zone-bet-stage{inset:10px 12px!important}.predict-zone-bet-head{margin-bottom:7px}.predict-zone-bet-question{margin-bottom:7px}.predict-zone-bet-input-wrap{min-height:52px}}
@media(prefers-reduced-motion:reduce){.predict-zone-question-image,.predict-zone-live-price,.predict-zone-choice-symbol{animation:none!important}.predict-zone-category-card,.predict-zone-choice,.predict-zone-glass-card,.predict-zone-chart-preview,.predict-zone-market-stage,.predict-zone-bet-stage,.predict-zone-bet-stage>*,.predict-zone-bet-presets button,.predict-zone-bet-submit{transition:none!important}}
`;
...
(function(){
  ...
  ready(function(){
    ...
    function finishBetClose(){if(betCloseTimer){clearTimeout(betCloseTimer);betCloseTimer=0}if(betOpen)return;if(card)card.classList.remove('bet-mode','bet-side-up','bet-side-down');if(betStage)betStage.setAttribute('aria-hidden','true')}
    ...
    function openBet(nextSide){side=nextSide==='down'?'down':'up';if(betTitle)betTitle.textContent=(side==='down'?'Down':'Up')+' on '+cfg().label;if(betDirection)betDirection.textContent=side==='down'?'↓':'↑';if(betQuestion)betQuestion.textContent=cfg().question;if(betInput)betInput.value='';updateEstimate();setStatus('','');if(betCloseTimer){clearTimeout(betCloseTimer);betCloseTimer=0}betOpen=true;root.classList.add('predict-zone-betting');if(card){card.classList.remove('bet-side-up','bet-side-down');card.classList.add('bet-side-'+side,'bet-mode')}if(betStage)betStage.setAttribute('aria-hidden','false')}
    function closeBet(){if(!betOpen)return;betOpen=false;if(betInput&&document.activeElement===betInput)betInput.blur();var tg=window.Telegram&&window.Telegram.WebApp;if(tg&&typeof tg.hideKeyboard==='function'){try{tg.hideKeyboard()}catch(_){}}root.classList.remove('predict-zone-betting');if(card)card.classList.remove('bet-mode');betCloseTimer=setTimeout(finishBetClose,440)}
    ...
    root.addEventListener('click',function(e){var target=e.target;if(!target)return;var preset=target.closest&&target.closest('[data-predict-bet-preset]');if(preset&&betInput){e.preventDefault();betInput.value=preset.getAttribute('data-predict-bet-preset')||'';updateEstimate();focusBetInput();return}var close=target.closest&&target.closest('[data-predict-bet-close]');if(close){e.preventDefault();closeBet();return}var choice=target.closest&&target.closest('[data-predict-choice]');if(choice){e.preventDefault();openBet(choice.getAttribute('data-predict-choice'));return}var submit=target.closest&&target.closest('[data-predict-bet-submit]');if(submit&&betOpen){e.preventDefault();submitBet()}},true);
