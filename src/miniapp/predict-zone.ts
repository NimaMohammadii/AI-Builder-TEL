...
.predict-zone-bet-stage{display:flex;flex-direction:column;max-height:0;overflow:hidden;opacity:0;pointer-events:none;transform:translate3d(0,12px,0);transform-origin:center top;margin:0;transition:max-height .42s cubic-bezier(.18,.88,.24,1),opacity .18s ease,transform .38s cubic-bezier(.18,.88,.24,1)}
