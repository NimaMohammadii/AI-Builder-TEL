export const PREDICT_ZONE_SECTION = `<section id="predictzone" class="view predict-zone-view">
  ...
  <div class="predict-zone-bet-sheet" data-predict-bet-sheet aria-hidden="true">
    <div class="predict-zone-bet-panel" role="dialog" aria-modal="true" aria-label="Place prediction">
      <div class="predict-zone-bet-head"><div><span>Prediction</span><strong data-predict-bet-title>Up</strong></div><button type="button" class="predict-zone-bet-close" data-predict-bet-close aria-label="Close">×</button></div>
      <p class="predict-zone-bet-question" data-predict-bet-question>Bitcoin up or down?</p>
      <label class="predict-zone-bet-input-wrap"><input class="predict-zone-bet-input" data-predict-bet-input type="number" min="0" step="0.01" inputmode="decimal" placeholder="0.00" /><span class="predict-zone-bet-estimate" data-predict-bet-estimate></span><span class="predict-zone-bet-side"><span class="predict-zone-bet-token">TON</span><span class="predict-zone-bet-usd" data-predict-bet-usd>≈ $0.00</span></span></label>
...
.predict-zone-decision-head{display:flex;align-items:center;justify-content:space-between;gap:10px;margin:0 3px 7px;color:rgba(255,255,255,.40);font-size:10px;font-weight:800}.predict-zone-decision-head strong{color:rgba(255,255,255,.68);font-size:10px;font-weight:900;white-space:nowrap}.predict-zone-actions{display:grid!important;grid-template-columns:1fr 1fr!important;gap:8px!important}.predict-zone-choice{position:relative!important;overflow:hidden!important;height:38px!important;padding:0 12px!important;border:0!important;border-radius:28px!important;color:#fff!important;font-size:12px!important;font-weight:950!important;display:flex!important;align-items:center!important;justify-content:center!important;gap:7px!important;background:radial-gradient(34px 34px at 0 0,rgba(186,53,87,.16) 0%,rgba(146,35,66,.07) 42%,rgba(104,18,44,0) 76%),radial-gradient(36px 36px at 100% 100%,rgba(172,46,79,.15) 0%,rgba(133,30,60,.065) 43%,rgba(94,16,39,0) 78%),radial-gradient(118% 76% at 10% -16%,rgba(255,255,255,.12) 0%,rgba(255,255,255,.032) 30%,rgba(255,255,255,0) 58%),radial-gradient(96% 72% at 102% 108%,rgba(255,255,255,.052) 0%,rgba(255,255,255,.010) 34%,rgba(255,255,255,0) 62%),radial-gradient(92% 78% at 88% 112%,rgba(72,5,27,.11) 0%,rgba(42,3,16,0) 60%)!important;box-shadow:0 12px 30px rgba(31,1,10,.32),0 0 18px rgba(69,5,26,.15),inset 3px 3px .5px -3.5px rgba(255,255,255,.10),inset -3px -3px .5px -3.5px rgba(156,38,70,.48),inset 1px 1px 1px -.5px rgba(140,29,61,.30),inset -1px -1px 1px -.5px rgba(124,22,53,.24),inset 0 0 6px 6px rgba(255,255,255,.055),inset 0 0 2px 2px rgba(255,255,255,.035),inset 0 1px 0 rgba(112,18,49,.065),inset 0 -1px 0 rgba(88,12,37,.15)!important;backdrop-filter:blur(22px) saturate(1.40) brightness(1.05) contrast(1.04)!important;-webkit-backdrop-filter:blur(22px) saturate(1.40) brightness(1.05) contrast(1.04)!important;isolation:isolate!important;transform:translate3d(0,0,0)!important;transform-origin:center!important;touch-action:manipulation!important;-webkit-tap-highlight-color:transparent!important;transition:transform .38s cubic-bezier(.18,.88,.24,1),filter .32s ease,opacity .32s ease!important}.predict-zone-choice-symbol{display:inline-flex;align-items:center;justify-content:center;width:17px;height:17px;font-size:16px;font-weight:950;line-height:1;transform:translate3d(0,0,0)}.predict-zone-choice-up .predict-zone-choice-symbol{color:#d7e9dd}.predict-zone-choice-down .predict-zone-choice-symbol{color:#e7c9d2}.predict-zone-choice:active,.predict-zone-choice.press{transform:translate3d(0,1px,0) scale(.94)!important;filter:brightness(1.14) saturate(1.08)!important;transition-duration:.11s!important}.predict-zone-choice-up:active .predict-zone-choice-symbol,.predict-zone-choice-up.press .predict-zone-choice-symbol{animation:predictChoiceUp .46s cubic-bezier(.18,.88,.24,1)}.predict-zone-choice-down:active .predict-zone-choice-symbol,.predict-zone-choice-down.press .predict-zone-choice-symbol{animation:predictChoiceDown .46s cubic-bezier(.18,.88,.24,1)}@keyframes predictChoiceUp{0%{transform:translateY(0)}45%{transform:translateY(-5px) scale(1.12)}100%{transform:translateY(0)}}@keyframes predictChoiceDown{0%{transform:translateY(0)}45%{transform:translateY(5px) scale(1.12)}100%{transform:translateY(0)}}

.predict-zone-result-strip{position:relative;margin:10px -2px 0;display:none;overflow:hidden;border-radius:20px}.predict-zone-result-strip.show{display:block}.predict-zone-history-track{display:flex;gap:6px;overflow-x:auto;overflow-y:hidden;padding:0 2px 1px;scrollbar-width:none}.predict-zone-history-track::-webkit-scrollbar{display:none}.predict-zone-history-card{flex:0 0 auto;min-width:92px;height:34px;border-radius:999px;background:rgba(255,255,255,.055);box-shadow:0 10px 24px rgba(0,0,0,.18),inset 0 1px 0 rgba(255,255,255,.08);display:flex;align-items:center;justify-content:center;padding:0 10px;color:rgba(255,255,255,.66);font-size:11px;font-weight:850;white-space:nowrap}.predict-zone-history-card.win,.predict-zone-history-card.refund{color:rgba(210,230,255,.94)}

.predict-zone-bet-sheet{position:fixed;inset:0;z-index:80;display:grid;align-items:center;justify-items:center;padding:18px;background:rgba(0,0,0,.18);-webkit-backdrop-filter:blur(3px);backdrop-filter:blur(3px);opacity:0;pointer-events:none;transition:opacity .22s ease}.predict-zone-bet-sheet.open{opacity:1;pointer-events:auto}.predict-zone-bet-panel{position:relative;overflow:hidden;width:100%;max-width:390px;border-radius:28px;border:1px solid rgba(124,22,53,.24)!important;background:#070707!important;background-color:#070707!important;background-image:none!important;box-shadow:0 12px 30px rgba(31,1,10,.32),0 0 18px rgba(69,5,26,.15),inset 3px 3px .5px -3.5px rgba(255,255,255,.10),inset 1px 1px 1px -.5px rgba(140,29,61,.30),inset 0 0 6px 6px rgba(255,255,255,.055),inset 0 0 2px 2px rgba(255,255,255,.035)!important;-webkit-backdrop-filter:none!important;backdrop-filter:none!important;padding:16px;box-sizing:border-box;color:#fff;transform:scale(.94);opacity:.6;transition:transform .28s cubic-bezier(.18,.88,.24,1),opacity .2s ease}.predict-zone-bet-panel:before{content:""!important;position:absolute!important;inset:0!important;pointer-events:none!important;background:radial-gradient(34px 34px at 0 0,rgba(186,53,87,.20) 0%,rgba(146,35,66,.09) 42%,rgba(104,18,44,0) 76%),radial-gradient(38px 38px at 100% 100%,rgba(156,38,70,.26) 0%,rgba(92,10,35,.12) 46%,rgba(69,5,26,0) 78%)!important;box-shadow:inset 3px 3px .5px -3.5px rgba(255,255,255,.10),inset -3px -3px .5px -3.5px rgba(156,38,70,.52),inset 1px 1px 1px -.5px rgba(140,29,61,.22),inset -1px -1px 1px -.5px rgba(92,10,35,.30),inset 6px 5px 13px -8px rgba(255,255,255,.13),inset -5px -4px 11px -8px rgba(255,255,255,.055),inset 0 0 10px rgba(69,5,26,.12)!important}.predict-zone-bet-panel>*{position:relative;z-index:1}.predict-zone-bet-sheet.open .predict-zone-bet-panel{transform:scale(1);opacity:1}.predict-zone-bet-head{display:flex;align-items:flex-start;justify-content:space-between;gap:12px;margin-bottom:12px}.predict-zone-bet-head span{display:block;color:rgba(255,255,255,.38);font-size:9px;font-weight:800;text-transform:uppercase;letter-spacing:.12em;margin-bottom:3px}.predict-zone-bet-head strong{display:block;font-size:21px;font-weight:950;letter-spacing:-.05em}.predict-zone-bet-close{width:32px!important;height:32px!important;border-radius:13px!important;border:0!important;background:rgba(255,255,255,.07)!important;color:#fff!important;font-size:18px!important;transition:transform .24s ease!important}.predict-zone-bet-close:active{transform:scale(.90)!important}.predict-zone-bet-question{font-size:12px;font-weight:750;color:rgba(255,255,255,.58);margin:0 0 12px}.predict-zone-bet-input-wrap{display:grid;grid-template-columns:minmax(0,1fr) auto auto;align-items:center;gap:8px;min-height:58px;border-radius:18px;background:rgba(0,0,0,.22)!important;box-shadow:inset 0 0 0 1px rgba(255,255,255,.055),inset 0 1px 0 rgba(255,255,255,.06),inset 0 -1px 0 rgba(255,255,255,.04)!important;padding:0 13px;margin:0 0 9px}.predict-zone-bet-input{width:100%;min-width:0;border:0!important;outline:0!important;background:transparent!important;box-shadow:none!important;backdrop-filter:none!important;-webkit-backdrop-filter:none!important;color:#fff;font-size:25px;font-weight:950;letter-spacing:-.05em;appearance:textfield}.predict-zone-bet-input::-webkit-outer-spin-button,.predict-zone-bet-input::-webkit-inner-spin-button{appearance:none;margin:0}.predict-zone-bet-estimate{color:rgba(255,255,255,.82);font-size:12px;font-weight:950;white-space:nowrap}.predict-zone-bet-side{display:grid;justify-items:end;gap:3px}.predict-zone-bet-token{font-size:12px;font-weight:900;color:rgba(255,255,255,.66)}.predict-zone-bet-usd{font-size:10px;font-weight:760;color:rgba(255,255,255,.38);white-space:nowrap}.predict-zone-bet-presets{display:grid;grid-template-columns:repeat(4,1fr);gap:7px;margin:9px 0 11px}.predict-zone-bet-presets button,.predict-zone-bet-submit{position:relative!important;overflow:hidden!important;height:38px!important;padding:0 12px!important;border:0!important;border-radius:28px!important;background:radial-gradient(34px 34px at 0 0,rgba(186,53,87,.16) 0%,rgba(146,35,66,.07) 42%,rgba(104,18,44,0) 76%),radial-gradient(36px 36px at 100% 100%,rgba(172,46,79,.15) 0%,rgba(133,30,60,.065) 43%,rgba(94,16,39,0) 78%),radial-gradient(118% 76% at 10% -16%,rgba(255,255,255,.12) 0%,rgba(255,255,255,.032) 30%,rgba(255,255,255,0) 58%),radial-gradient(96% 72% at 102% 108%,rgba(255,255,255,.052) 0%,rgba(255,255,255,.010) 34%,rgba(255,255,255,0) 62%),radial-gradient(92% 78% at 88% 112%,rgba(72,5,27,.11) 0%,rgba(42,3,16,0) 60%)!important;color:#fff!important;font-size:12px!important;font-weight:950!important;box-shadow:0 12px 30px rgba(31,1,10,.32),0 0 18px rgba(69,5,26,.15),inset 3px 3px .5px -3.5px rgba(255,255,255,.10),inset -3px -3px .5px -3.5px rgba(156,38,70,.48),inset 1px 1px 1px -.5px rgba(140,29,61,.30),inset -1px -1px 1px -.5px rgba(124,22,53,.24),inset 0 0 6px 6px rgba(255,255,255,.055),inset 0 0 2px 2px rgba(255,255,255,.035),inset 0 1px 0 rgba(112,18,49,.065),inset 0 -1px 0 rgba(88,12,37,.15)!important;backdrop-filter:blur(22px) saturate(1.40) brightness(1.05) contrast(1.04)!important;-webkit-backdrop-filter:blur(22px) saturate(1.40) brightness(1.05) contrast(1.04)!important;isolation:isolate!important;transform:translate3d(0,0,0)!important;transform-origin:center!important;touch-action:manipulation!important;-webkit-tap-highlight-color:transparent!important;transition:transform .38s cubic-bezier(.18,.88,.24,1),filter .32s ease,opacity .32s ease!important}.predict-zone-bet-submit{width:100%!important}.predict-zone-bet-presets button:active,.predict-zone-bet-submit:active{transform:translate3d(0,1px,0) scale(.94)!important;filter:brightness(1.14) saturate(1.08)!important;transition-duration:.11s!important}.predict-zone-bet-submit:disabled{opacity:.55}.predict-zone-bet-note,.predict-zone-bet-status{margin:8px 0 0;text-align:center;color:rgba(255,255,255,.42);font-size:10px;font-weight:650}.predict-zone-bet-status{min-height:15px;font-size:11px;font-weight:760}.predict-zone-bet-status.bad{color:rgba(255,160,160,.9)}.predict-zone-bet-status.good{color:rgba(185,255,210,.9)}

@media(max-width:380px){.predict-zone-view{padding-left:0!important;padding-right:0!important}#predictzone .predict-zone-category-menu{left:0!important;width:100%!important;padding-left:0!important;padding-right:0!important}.predict-zone-glass-card{min-height:0!important;padding:10px 12px!important}.predict-zone-card-top{top:18px!important;right:12px!important}.predict-zone-countdown{font-size:17px!important}.predict-zone-hero{padding-right:72px}.predict-zone-question-row{font-size:17px!important}.predict-zone-question-image{flex-basis:38px;width:38px;height:38px}.predict-zone-live-meta>div{height:44px!important;padding:6px 8px!important}.predict-zone-live-meta strong{font-size:12px!important}.predict-zone-chart-preview{height:158px!important;border-radius:20px!important}.predict-zone-bet-panel{max-width:340px;padding:15px}}
...
(function(){
  ...
  ready(function(){
    ...
    var MARKETS={
      bitcoin:{label:'Bitcoin',question:'Bitcoin up or down?',stream:'btcusdt@miniTicker',rest:'https://api.binance.com/api/v3/ticker/price?symbol=BTCUSDT',decimals:0,step:5,duration:300000,symbol:'₿'},
      oil:{label:'Oil',question:'Oil in 72h up or down?',stream:'',rest:'',decimals:2,step:.05,duration:259200000,symbol:'Oil'},
      gold:{label:'Gold',question:'Gold up or down?',stream:'paxgusdt@miniTicker',rest:'https://api.binance.com/api/v3/ticker/price?symbol=PAXGUSDT',decimals:2,step:.5,duration:300000,symbol:'Au'}
    };
    var market='bitcoin',ws=null,raf=0,seq=0,values=[],current=0,last=0,raw=0,scaleMin=0,scaleMax=0,readyPrice=false,entry=0,slot=0,lastPointAt=0,lastDrawAt=0,currentRound=null,side='up',busy=false,images={},trend='flat',lastVisualPrice=0,choiceTimer=0,priceTickTimer=0,axisKey='';
    ...
    function ticksForStep(scale,step){
      var epsilon=step*1e-9,first=Math.ceil((scale.min-epsilon)/step)*step,lastTick=Math.floor((scale.max+epsilon)/step)*step,ticks=[],v,precision=Math.max(0,cfg().decimals+4);
      for(v=first;v<=lastTick+epsilon&&ticks.length<48;v+=step)ticks.push(Number(v.toFixed(precision)));
      return ticks;
    }
    function priceTicks(scale){
      var span=scale.max-scale.min,capacity=axisCapacity(),chartHeight=chart&&chart.clientHeight||170,usableHeight=chartHeight*((H-P*2)/H),minGap=38,hint=capacity,step=niceTickStep(span,hint),ticks=ticksForStep(scale,step),attempt=0,gap,stride,thinned,i;
      while(ticks.length<2&&attempt<8){hint++;step=niceTickStep(span,hint);ticks=ticksForStep(scale,step);attempt++}
      if(ticks.length<2)return ticks;
      gap=step/span*usableHeight;
      stride=Math.max(1,Math.ceil((ticks.length-1)/Math.max(1,capacity-1)),Math.ceil(minGap/Math.max(1,gap)));
      if(stride>1){
        thinned=[];
        for(i=0;i<ticks.length;i+=stride)thinned.push(ticks[i]);
        if(thinned.length<2&&ticks.length>=2)thinned=[ticks[0],ticks[ticks.length-1]];
        ticks=thinned;
      }
      return ticks.slice(0,capacity);
    }
    function autoScale(prices){
      ...
      if(!scaleMin||!scaleMax){scaleMin=targetMin;scaleMax=targetMax}
        ...
        scaleMin=targetMin<scaleMin?targetMin:scaleMin+(targetMin-scaleMin)*.025;
        scaleMax=targetMax>scaleMax?targetMax:scaleMax+(targetMax-scaleMax)*.025;
      }
    ...
    function seed(price){values=[];var st=price>1000?1.8:price>100?.18:.006,w=price>1000?5:price>100?.5:.018;for(var i=0;i<22;i++)values.push(price-st*12+i*st+Math.sin(i/2.8)*w);current=price;last=price;raw=price;scaleMin=0;scaleMax=0;lastPointAt=0}
    function draw(progress){
      if(!readyPrice||!values.length||!line||!fill)return;
      var right=W-R,step=(W-L-R)/(Math.max(22,values.length+1)-1),rawPts=values.map(function(v,i){return{x:right-((values.length-i)+progress)*step,v:v}});
      ...
      var scale=autoScale(visibleRaw.map(function(p){return p.v})),visible=visibleRaw.map(function(p){return{x:p.x,y:y(p.v,scale),v:p.v}}),d=path(visible),first=visible[0],lastPoint=visible[visible.length-1],xp=lastPoint.x/W*100,yp=lastPoint.y/H*100;
    ...
    function selectMarket(id){if(!MARKETS[id]||id===market&&raf)return;closeFeed();if(raf){cancelAnimationFrame(raf);raf=0}market=id;values=[];current=0;last=0;raw=0;scaleMin=0;scaleMax=0;entry=0;readyPrice=false;currentRound=null;slot=slotFor(Date.now());lastPointAt=0;lastDrawAt=0;lastVisualPrice=0;showLoading();updateMenu();if(question)question.textContent=cfg().question;renderImage();if(result){result.className='predict-zone-result-strip';result.innerHTML=''}syncRound().finally(function(){connectFeed();if(!raf)raf=requestAnimationFrame(loop)})}
    function loop(now){if(!isActive()){if(raf){cancelAnimationFrame(raf);raf=0}closeFeed();return}var newSlot=slotFor(Date.now());if(newSlot!==slot){slot=newSlot;entry=Number(raw||current||last||0);syncRound()}if(countdown)countdown.textContent=timeLeft(cfg().duration-((Date.now()-slot)%cfg().duration));if(readyPrice){current+=(last-current)*.16;if(!lastPointAt)lastPointAt=now;var elapsed=now-lastPointAt;if(elapsed>=3000){values.push(current);if(values.length>23)values.shift();lastPointAt=now;elapsed=0}if(now-lastDrawAt>32){lastDrawAt=now;draw(Math.min(1,Math.max(0,elapsed/3000)))}}raf=requestAnimationFrame(loop)}
    function resume(){if(!isActive())return;if(!raf){connectFeed();raf=requestAnimationFrame(loop)}}
    function animateChoice(choice){if(!choice)return;if(choiceTimer)clearTimeout(choiceTimer);choice.classList.remove('press');void choice.offsetWidth;choice.classList.add('press');choiceTimer=setTimeout(function(){choice.classList.remove('press')},480)}
    ...
    root.addEventListener('input',function(e){if(e.target&&e.target.matches&&e.target.matches('[data-predict-bet-input]'))updateEstimate()},true);
    root.addEventListener('click',function(e){var preset=e.target&&e.target.closest&&e.target.closest('[data-predict-bet-preset]');if(preset&&betInput){e.preventDefault();betInput.value=preset.getAttribute('data-predict-bet-preset')||'';updateEstimate();return}var close=e.target&&e.target.closest&&e.target.closest('[data-predict-bet-close]');if(close){e.preventDefault();closeBet();return}var choice=e.target&&e.target.closest&&e.target.closest('[data-predict-choice]');if(choice){e.preventDefault();animateChoice(choice);openBet(choice.getAttribute('data-predict-choice'));return}var submit=e.target&&e.target.closest&&e.target.closest('[data-predict-bet-submit]');if(submit&&sheet&&sheet.classList.contains('open')){e.preventDefault();submitBet()}},true);
    document.addEventListener('visibilitychange',function(){if(document.hidden){if(raf){cancelAnimationFrame(raf);raf=0}closeFeed()}else resume()});
    window.addEventListener('focus',resume);window.addEventListener('pageshow',resume);
    document.addEventListener('click',function(e){var tab=e.target&&e.target.closest&&e.target.closest('[data-view="predictzone"]');if(tab)setTimeout(resume,80)},true);
    if(window.MutationObserver)new MutationObserver(resume).observe(root,{attributes:true,attributeFilter:['class']});
    window.VexaPredictBack=function(){return false};
