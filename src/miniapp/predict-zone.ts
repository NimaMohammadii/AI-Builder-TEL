...
html body:has(#predictzone.active) .content{margin-left:-16px!important;margin-right:-16px!important;width:calc(100% + 32px)!important;max-width:none!important;overflow:hidden!important}

.predict-zone-view{padding:0 16px!important;box-sizing:border-box;overflow:hidden!important;overscroll-behavior:none!important;scrollbar-width:none!important}.predict-zone-view::-webkit-scrollbar{display:none}
.predict-zone-simple-shell{position:relative;height:100%;min-height:0;display:grid;align-content:start;padding:0;overflow:visible}

#predictzone .predict-zone-category-menu{position:relative!important;left:-16px!important;z-index:4!important;display:flex!important;gap:8px!important;overflow-x:auto!important;overflow-y:hidden!important;width:calc(100% + 32px)!important;max-width:none!important;margin:0 0 10px!important;padding:0 16px 9px!important;box-sizing:border-box!important;scrollbar-width:none!important;-webkit-overflow-scrolling:touch!important;overscroll-behavior-x:contain!important;scroll-padding:0 16px!important;transform:translate3d(0,0,0);opacity:1;transition:opacity .28s ease,transform .42s cubic-bezier(.18,.88,.24,1)!important}#predictzone .predict-zone-category-menu::-webkit-scrollbar{display:none}#predictzone .predict-zone-category-menu:before{display:none!important;content:none!important}#predictzone .predict-zone-category-menu:after{content:""!important;flex:0 0 max(36px,env(safe-area-inset-right))!important;height:1px!important}
...
(function(){
  ...
  ready(function(){
    ...
    var MARKETS={
      bitcoin:{label:'Bitcoin',question:'Bitcoin up or down?',stream:'wss://fstream.asterdex.com/ws/btcusdt@markPrice@1s',decimals:0,step:5,axisStep:50,duration:300000,symbol:'₿'},
    ...
    function resume(){
      ...
      if(readyPrice)startChartMotion();if(!clockTimer)startClock();if(!wasSuspended&&!ws&&!reconnectTimer)connectFeed(seq,market);
    }
