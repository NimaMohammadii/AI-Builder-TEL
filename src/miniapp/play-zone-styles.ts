...
.play-zone-stage{--play-card-gap:3px;display:flex!important;flex-direction:column!important;gap:10px!important;padding:0 0 96px!important;position:relative!important;overflow:visible!important;width:100%!important;max-width:none!important;scrollbar-width:none!important;-ms-overflow-style:none!important}
...
.game-card{width:100%!important;max-width:none!important;min-width:0!important;height:calc((100vw - (var(--play-card-gap) * 2)) / 3 + (var(--play-card-gap) * 2))!important;min-height:128px!important;max-height:180px!important;border:0!important;outline:0!important;border-radius:30px!important;background:rgba(255,255,255,.035)!important;box-shadow:0 18px 42px rgba(0,0,0,.16),inset 0 1px 0 rgba(255,255,255,.14)!important;padding:0!important;display:block!important;position:relative!important;color:#fff!important;text-align:left!important;overflow:hidden!important;scroll-snap-align:start!important;-webkit-backdrop-filter:blur(4px) saturate(1.12)!important;backdrop-filter:blur(4px) saturate(1.12)!important;transition:transform .18s ease!important}
.game-card:active{transform:scale(.985)!important}
.game-card-live{background:rgba(255,255,255,.035)!important;background-color:rgba(255,255,255,.035)!important;border:0!important;outline:0!important;box-shadow:0 18px 42px rgba(0,0,0,.16),inset 0 1px 0 rgba(255,255,255,.14)!important;padding:0!important;border-radius:30px!important;overflow:hidden!important;filter:none!important;-webkit-backdrop-filter:blur(4px) saturate(1.12)!important;backdrop-filter:blur(4px) saturate(1.12)!important}
...
.game-image{position:absolute!important;inset:var(--play-card-gap)!important;width:auto!important;height:auto!important;aspect-ratio:3/1!important;border-radius:27px!important;background:transparent!important;display:block!important;place-items:unset!important;overflow:hidden!important;border:0!important;outline:0!important;box-shadow:none!important;padding:0!important;z-index:1!important}
.game-image img{display:block!important;width:100%!important;height:100%!important;object-fit:fill!important;object-position:center!important;border-radius:27px!important;background:transparent!important;border:0!important;outline:0!important;box-shadow:none!important;image-rendering:auto!important;transform:translateZ(0)!important;backface-visibility:hidden!important}
.game-card-live .game-image{position:absolute!important;inset:var(--play-card-gap)!important;border:0!important;outline:0!important;border-radius:27px!important;box-shadow:none!important;background:transparent!important;overflow:hidden!important;padding:0!important}
...
.play-zone-featured-card,.play-zone-featured-card.game-card-live,.play-zone-featured-card-2,.play-zone-featured-card-3,.play-zone-triangle-card{position:relative!important;transform:none!important;animation:none!important;box-shadow:0 18px 42px rgba(0,0,0,.16),inset 0 1px 0 rgba(255,255,255,.14)!important;background:rgba(255,255,255,.035)!important;border:0!important;outline:0!important;border-radius:30px!important;-webkit-backdrop-filter:blur(4px) saturate(1.12)!important;backdrop-filter:blur(4px) saturate(1.12)!important}
...
@media(max-width:380px){
  ...
  .play-zone-stage{--play-card-gap:3px;gap:9px!important;padding:0 0 90px!important}
  ...
  .game-card,.game-card-live{height:calc((100vw - (var(--play-card-gap) * 2)) / 3 + (var(--play-card-gap) * 2))!important;min-height:118px!important;max-height:150px!important;border-radius:30px!important;padding:0!important}
  .game-image,.game-card-live .game-image{inset:var(--play-card-gap)!important;border-radius:27px!important;aspect-ratio:3/1!important;border:0!important;outline:0!important;box-shadow:none!important}
  .game-image img{border-radius:27px!important;object-fit:fill!important;border:0!important;outline:0!important;box-shadow:none!important}
