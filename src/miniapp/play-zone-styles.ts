...
.game-card{width:100%!important;max-width:none!important;min-width:0!important;height:calc((100vw - 8px) / 3 + 8px)!important;min-height:126px!important;max-height:178px!important;border:1px solid rgba(255,255,255,.14)!important;border-radius:22px!important;background:rgba(255,255,255,.035)!important;box-shadow:0 16px 36px rgba(0,0,0,.28),inset 0 1px 0 rgba(255,255,255,.12)!important;padding:4px!important;display:block!important;position:relative!important;color:#fff!important;text-align:left!important;overflow:hidden!important;scroll-snap-align:start!important;transition:transform .18s ease,border-color .18s ease,box-shadow .18s ease!important}
.game-card:active{transform:scale(.985)!important}
.game-card-live{background:rgba(255,255,255,.035)!important;background-color:rgba(255,255,255,.035)!important;border:1px solid rgba(255,255,255,.14)!important;box-shadow:0 16px 36px rgba(0,0,0,.28),inset 0 1px 0 rgba(255,255,255,.12)!important;padding:4px!important;border-radius:22px!important;overflow:hidden!important;filter:none!important}
...
.game-image{position:absolute!important;inset:4px!important;width:auto!important;height:auto!important;aspect-ratio:3/1!important;border-radius:14px!important;background:rgba(255,255,255,.025)!important;display:block!important;place-items:unset!important;overflow:hidden!important;border:1px solid rgba(255,255,255,.10)!important;box-shadow:none!important;padding:0!important;z-index:1!important}
.game-image img{display:block!important;width:100%!important;height:100%!important;object-fit:fill!important;object-position:center!important;border-radius:12px!important;background:transparent!important;image-rendering:auto!important;transform:translateZ(0)!important;backface-visibility:hidden!important}
.game-card-live .game-image{position:absolute!important;inset:4px!important;border:1px solid rgba(255,255,255,.10)!important;border-radius:14px!important;box-shadow:none!important;background:rgba(255,255,255,.025)!important;overflow:hidden!important;padding:0!important}
.game-card-live .game-image:after{content:''!important;position:absolute!important;inset:0!important;border-radius:inherit!important;background:linear-gradient(180deg,rgba(0,0,0,0) 62%,rgba(0,0,0,.14) 100%)!important;pointer-events:none!important;z-index:2!important}
...
.game-players{display:inline-flex!important;align-items:center!important;justify-content:center!important;gap:5px!important;min-width:0!important;color:rgba(255,255,255,.96)!important;font-size:10.5px!important;font-weight:950!important;letter-spacing:-.02em!important;white-space:nowrap!important;background:rgba(0,0,0,.22)!important;border:1px solid rgba(255,255,255,.13)!important;border-radius:999px!important;box-shadow:0 10px 24px rgba(0,0,0,.18),inset 0 1px 0 rgba(255,255,255,.08)!important;padding:5px 10px!important;margin:0!important;-webkit-backdrop-filter:blur(10px) saturate(160%)!important;backdrop-filter:blur(10px) saturate(160%)!important}
...
.game-players b{display:inline-block!important;min-width:23px!important;font-size:10.5px!important;font-weight:950!important;color:rgba(255,255,255,.96)!important;text-shadow:0 6px 14px rgba(0,0,0,.72),0 0 10px rgba(255,255,255,.10)!important;font-variant-numeric:tabular-nums!important;transition:opacity .14s ease,filter .18s ease!important}
.game-players em{font-style:normal!important;color:rgba(255,255,255,.68)!important;font-size:8.6px!important;font-weight:850!important;text-transform:none!important;letter-spacing:.02em!important;margin-left:1px!important}
.game-players b.is-counting{opacity:.66!important;filter:brightness(1.22)!important}
.game-open{display:none!important}
.play-zone-featured-card,.play-zone-featured-card.game-card-live,.play-zone-featured-card-2,.play-zone-featured-card-3,.play-zone-triangle-card{position:relative!important;transform:none!important;animation:none!important;box-shadow:0 16px 36px rgba(0,0,0,.28),inset 0 1px 0 rgba(255,255,255,.12)!important;background:rgba(255,255,255,.035)!important}
...
@media(max-width:380px){
  ...
  .game-card,.game-card-live{height:calc((100vw - 8px) / 3 + 8px)!important;min-height:118px!important;max-height:150px!important;border-radius:20px!important;padding:4px!important}
  .game-image,.game-card-live .game-image{inset:4px!important;border-radius:12px!important;aspect-ratio:3/1!important}
  .game-image img{border-radius:10px!important;object-fit:fill!important}
