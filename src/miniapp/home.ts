...
(function(){
  ...
  function tune(){
    ...
    st.textContent=[
      ...
      '.home-bonus-backdrop{position:fixed!important;inset:0!important;z-index:99994!important;background:rgba(0,0,0,.34)!important;opacity:0!important;visibility:hidden!important;transition:opacity .24s ease,visibility 0s linear .24s!important}.home-bonus-backdrop.is-open{opacity:1!important;visibility:visible!important;transition:opacity .24s ease!important}.home-bonus-panel{position:fixed!important;left:0!important;right:0!important;bottom:0!important;z-index:99995!important;max-height:min(72dvh,620px)!important;padding:10px 16px calc(18px + env(safe-area-inset-bottom))!important;border-radius:30px 30px 0 0!important;background:rgba(14,10,12,.92)!important;color:#fff!important;box-shadow:0 -18px 54px rgba(0,0,0,.36),inset 0 1px 0 rgba(255,255,255,.12)!important;backdrop-filter:blur(18px) saturate(1.12)!important;-webkit-backdrop-filter:blur(18px) saturate(1.12)!important;transform:translate3d(0,105%,0)!important;transition:transform .34s cubic-bezier(.2,.9,.26,1)!important;display:grid!important;grid-template-rows:auto auto auto minmax(0,1fr)!important;gap:12px!important;overflow:hidden!important}.home-bonus-panel.is-open{transform:translate3d(0,0,0)!important}.home-bonus-grab{width:36px!important;height:4px!important;margin:0 auto 2px!important;border-radius:999px!important;background:rgba(255,255,255,.20)!important}.home-bonus-head{display:flex!important;align-items:center!important;justify-content:space-between!important;gap:12px!important}.home-bonus-title{display:flex!important;align-items:center!important;gap:9px!important;min-width:0!important}.home-bonus-title svg{width:22px!important;height:22px!important;color:#e9a6b6!important;flex:0 0 auto!important}.home-bonus-head strong{font-family:-apple-system,BlinkMacSystemFont,"SF Pro Rounded","Inter","Segoe UI",sans-serif!important;font-size:18px!important;font-weight:850!important;letter-spacing:-.035em!important;line-height:1!important}.home-bonus-close{width:32px!important;height:32px!important;border-radius:50%!important;border:0!important;background:rgba(255,255,255,.08)!important;color:#fff!important;display:grid!important;place-items:center!important;padding:0!important}.home-bonus-close svg{width:16px!important;height:16px!important}.home-bonus-next{display:grid!important;grid-template-columns:32px minmax(0,1fr)!important;gap:10px!important;align-items:center!important;padding:11px 12px!important;border-radius:18px!important;background:rgba(255,255,255,.055)!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.07)!important}.home-bonus-next svg,.home-bonus-guide-icon svg{width:20px!important;height:20px!important;color:#e9a6b6!important}.home-bonus-next span,.home-bonus-guide-copy span{display:block!important;color:rgba(255,255,255,.52)!important;font-size:10px!important;font-weight:750!important;line-height:1.25!important}.home-bonus-next b{display:block!important;margin-top:2px!important;color:#fff!important;font-size:13px!important;font-weight:850!important;line-height:1.2!important}.home-bonus-guide{display:grid!important;gap:8px!important}.home-bonus-guide-row{display:grid!important;grid-template-columns:24px minmax(0,1fr)!important;gap:9px!important;align-items:start!important}.home-bonus-guide-icon{padding-top:1px!important}.home-bonus-guide-copy b{display:block!important;margin-bottom:2px!important;color:#fff!important;font-size:12px!important;font-weight:850!important;line-height:1.2!important}.home-bonus-list{min-height:0!important;display:grid!important;align-content:start!important;gap:7px!important;overflow-y:auto!important;overflow-x:hidden!important;-webkit-overflow-scrolling:touch!important;scrollbar-width:none!important;padding:2px 0 4px!important}.home-bonus-list::-webkit-scrollbar{display:none!important}.home-bonus-row{min-height:48px!important;border-radius:18px!important;background:rgba(255,255,255,.055)!important;color:#fff!important;display:grid!important;grid-template-columns:31px minmax(0,1fr) auto!important;align-items:center!important;gap:9px!important;padding:8px 11px!important;font-size:12px!important;font-weight:850!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.06)!important}.home-bonus-rank-avatar{width:31px!important;height:31px!important;border-radius:50%!important;display:grid!important;place-items:center!important;color:#f6c9d4!important;font-size:10px!important;font-weight:900!important;background:rgba(194,70,102,.18)!important}.home-bonus-row .home-live-winner-user{min-width:0!important}.home-bonus-row .home-live-winner-user span{display:block!important;color:rgba(255,255,255,.5)!important;font-size:10px!important;font-weight:750!important}.home-bonus-row .home-live-winner-amount{color:#fff!important;font-size:12px!important;font-weight:900!important;white-space:nowrap!important}',
...
(function(){
  ...
  function prizeRowsHtml(prizes){
    ...
    for(var i=0;i<limit;i++){
      ...
      html+='<article class="home-bonus-row"><div class="home-bonus-rank-avatar">#'+rank+'</div><div class="home-live-winner-user"><span>'+percent.toLocaleString(undefined,{maximumFractionDigits:2})+'%</span></div><div class="home-live-winner-amount">'+gram(prize.prizeNano)+' GRAM</div></article>';
    }
    return html;
  }
...
(function(){
  ...
  function text(key){try{var value=window.VexaLotteryText&&window.VexaLotteryText(key);return String(value||'')}catch(e){return ''}}
  ...
  function displayName(item){var name=String(item&&item.displayName||'').trim();return esc(name||text('player')||'Player')}
