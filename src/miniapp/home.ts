export const HOME_SECTION = `<section id="home" class="view active">
  <style>
    ...
    #home .home-rewards-entry-main{position:relative;z-index:1;min-width:0}.home-rewards-entry-main span{display:block;margin-bottom:5px;color:rgba(255,255,255,.48);font-size:8.5px;font-weight:950;text-transform:uppercase;letter-spacing:.16em}.home-rewards-entry-main strong{display:block;color:#fff;font-size:17px;font-weight:1000;line-height:1;letter-spacing:-.055em}.home-rewards-entry-main small{display:block;margin-top:6px;color:rgba(255,255,255,.5);font-size:9.2px;font-weight:750;line-height:1.2;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
    ...
    #home .rewards-page{position:fixed;inset:0;z-index:9997;display:block;overflow:auto;padding:calc(54px + env(safe-area-inset-top)) 18px calc(98px + env(safe-area-inset-bottom));background:radial-gradient(circle at 50% -10%,rgba(255,255,255,.08),rgba(255,255,255,0) 34%),rgba(5,5,7,.88);backdrop-filter:blur(12px);-webkit-backdrop-filter:blur(12px);opacity:0;pointer-events:none;transform:translateX(18px);transition:opacity .26s ease,transform .32s cubic-bezier(.2,.9,.2,1);scrollbar-width:none}
    ...
    #home .rewards-page-top{display:flex;align-items:flex-start;justify-content:space-between;gap:12px;margin:0 0 20px}.rewards-page-kicker{margin:0 0 6px;color:rgba(255,255,255,.48);font-size:9px;font-weight:950;text-transform:uppercase;letter-spacing:.18em}.rewards-page-title{margin:0;color:#fff;font-size:34px;line-height:.9;font-weight:1000;letter-spacing:-.075em}.rewards-page-sub{margin:10px 0 0;max-width:318px;color:rgba(255,255,255,.52);font-size:11px;line-height:1.35;font-weight:650;letter-spacing:-.02em}.rewards-page-back{width:38px;height:38px;border:0;border-radius:999px;background:rgba(255,255,255,.08);color:#fff;font-size:22px;font-weight:900;box-shadow:inset 0 1px 0 rgba(255,255,255,.12)}
    #home .rewards-status-strip{display:grid;grid-template-columns:48px minmax(0,1fr) auto;gap:11px;align-items:center;margin:0 0 18px;padding:0 0 16px;border-bottom:1px solid rgba(255,255,255,.08)}.rewards-status-icon{width:48px;height:48px;border-radius:18px;display:grid;place-items:center;background:rgba(255,255,255,.07);box-shadow:inset 0 1px 0 rgba(255,255,255,.12);color:#fff}.rewards-status-icon svg{width:22px;height:22px;stroke:currentColor;stroke-width:2.15;stroke-linecap:round;stroke-linejoin:round;fill:none}.rewards-status-main strong{display:block;color:#fff;font-size:17px;font-weight:1000;line-height:1;letter-spacing:-.045em}.rewards-status-main span{display:block;margin-top:6px;color:rgba(255,255,255,.47);font-size:9.4px;font-weight:750}.rewards-status-pill{height:30px;padding:0 10px;border-radius:999px;background:rgba(255,255,255,.09);color:rgba(255,255,255,.78);font-size:9px;font-weight:1000;display:grid;place-items:center;white-space:nowrap}
    #home .reward-days{display:flex;gap:7px;overflow-x:auto;overflow-y:hidden;margin:0 -18px 18px;padding:0 18px 8px;scrollbar-width:none;scroll-snap-type:x proximity;-webkit-overflow-scrolling:touch}.reward-days::-webkit-scrollbar{display:none}.reward-day{position:relative;flex:0 0 54px;height:66px;border:0;border-radius:19px;background:rgba(255,255,255,.045);box-shadow:inset 0 1px 0 rgba(255,255,255,.09);color:#fff;padding:8px 7px 7px;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:5px;scroll-snap-align:center;opacity:.68;overflow:hidden}.reward-day.done{opacity:.86;background:rgba(255,255,255,.065)}.reward-day.current{opacity:1;background:rgba(255,255,255,.12);color:#fff;box-shadow:inset 0 1px 0 rgba(255,255,255,.18),0 14px 26px rgba(0,0,0,.12)}.reward-day svg{width:17px;height:17px;stroke:currentColor;stroke-width:2.1;stroke-linecap:round;stroke-linejoin:round;fill:none;opacity:.9}.reward-day small{font-size:7px;font-weight:1000;text-transform:uppercase;letter-spacing:.09em;opacity:.68;line-height:1}.reward-day strong{font-size:17px;font-weight:1000;letter-spacing:-.06em;line-height:1}.reward-day.current:after{content:"Today";position:absolute;top:5px;right:5px;height:13px;padding:0 5px;border-radius:999px;background:#fff;color:#050505;font-size:6.5px;font-weight:1000;display:grid;place-items:center}
    #home .reward-today{display:grid;grid-template-columns:44px minmax(0,1fr) auto;gap:11px;align-items:center;margin:0 0 16px;padding:0 0 15px;border-bottom:1px solid rgba(255,255,255,.08)}.reward-today-icon{width:44px;height:44px;border-radius:17px;display:grid;place-items:center;background:rgba(255,255,255,.065);box-shadow:inset 0 1px 0 rgba(255,255,255,.12);color:#fff}.reward-today-icon svg{width:21px;height:21px;stroke:currentColor;stroke-width:2.1;stroke-linecap:round;stroke-linejoin:round;fill:none}.reward-today-main strong{display:block;color:#fff;font-size:15.5px;font-weight:950;line-height:1;letter-spacing:-.045em}.reward-today-main span{display:block;margin-top:6px;color:rgba(255,255,255,.47);font-size:9.5px;font-weight:750;line-height:1.25}.reward-today-button{border:0;border-radius:999px;padding:9px 12px;background:#fff;color:#050505;font-size:9.5px;font-weight:950;white-space:nowrap}
    #home .missions-title{display:flex;align-items:center;justify-content:space-between;gap:10px;margin:4px 0 7px;color:#fff}.missions-title strong{font-size:13px;font-weight:1000;letter-spacing:-.04em;line-height:1}.missions-title span{height:22px;padding:0 8px;border-radius:999px;display:grid;place-items:center;background:rgba(255,255,255,.075);color:rgba(255,255,255,.62);font-size:8px;font-weight:950;box-shadow:inset 0 1px 0 rgba(255,255,255,.10)}.missions-list{display:grid;gap:7px}.mission-row{position:relative;display:grid;grid-template-columns:32px minmax(0,1fr) auto;gap:10px;align-items:center;min-height:52px;padding:8px 9px;border-radius:16px;background:rgba(255,255,255,.038);box-shadow:inset 0 1px 0 rgba(255,255,255,.075);overflow:hidden}.mission-row.primary{background:rgba(255,255,255,.065);box-shadow:inset 0 1px 0 rgba(255,255,255,.12)}.mission-icon{position:relative;z-index:1;width:32px;height:32px;border-radius:12px;display:grid;place-items:center;background:rgba(255,255,255,.065);box-shadow:inset 0 1px 0 rgba(255,255,255,.12);color:#fff}.mission-row.primary .mission-icon{background:#fff;color:#050505}.mission-icon svg{width:16px;height:16px;stroke:currentColor;stroke-width:2.2;stroke-linecap:round;stroke-linejoin:round;fill:none}.mission-main{position:relative;z-index:1;min-width:0}.mission-main strong{display:block;color:#fff;font-size:12.5px;font-weight:950;line-height:1;letter-spacing:-.035em}.mission-main span{display:block;margin-top:5px;color:rgba(255,255,255,.43);font-size:8.6px;font-weight:750;line-height:1.15;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.mission-reward{position:relative;z-index:1;height:24px;padding:0 8px;border-radius:999px;display:grid;place-items:center;background:rgba(255,255,255,.07);color:rgba(255,255,255,.74);font-size:8.5px;font-weight:950;white-space:nowrap;box-shadow:inset 0 1px 0 rgba(255,255,255,.1)}.mission-row.primary .mission-reward{background:#fff;color:#050505;box-shadow:none}
    @media(max-width:380px){#home .home-rewards-entry{grid-template-columns:44px minmax(0,1fr) 32px;padding:13px}.rewards-page-title{font-size:30px}.reward-day{flex-basis:50px;height:63px;border-radius:18px}.reward-today{grid-template-columns:42px minmax(0,1fr);gap:9px}.reward-today-button{grid-column:1 / -1;width:100%;height:36px}.reward-today-icon{width:42px;height:42px;border-radius:16px}.mission-row{grid-template-columns:30px minmax(0,1fr) auto;gap:8px;min-height:49px;padding:7px 8px}.mission-icon{width:30px;height:30px;border-radius:11px}.mission-main strong{font-size:11.7px}.mission-main span{font-size:8px}.mission-reward{height:23px;font-size:8px;padding:0 7px}}
  </style>
  ...
  <div id="rewardsPage" class="rewards-page" aria-hidden="true">
    ...
    <div class="missions-list">
      <div class="mission-row primary"><div class="mission-icon"><svg viewBox="0 0 24 24"><path d="M5 12.5l4.2 4.2L19 7"/></svg></div><div class="mission-main"><strong>Daily Check-in</strong><span>Open Vexa FLOW once today</span></div><div class="mission-reward">+50 XP</div></div>
