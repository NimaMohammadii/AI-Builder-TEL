...
#homeTicketDrawer .home-ticket-win-chance{
  position:relative!important;
  width:100%!important;
...
#homeTicketDrawer .home-ticket-win-chance-fill{
  position:absolute!important;
  left:0!important;
  top:0!important;
  bottom:0!important;
...
#homeTicketDrawer .home-ticket-win-chance-label{
  position:absolute!important;
  inset:0!important;
  z-index:1!important;
...
#homeTicketDrawer .home-ticket-win-chance-label [data-win-chance]{
  margin-left:4px!important;
  color:#fff!important;
  font-weight:950!important;
  font-variant-numeric:tabular-nums!important;
}
@media (prefers-reduced-motion:reduce){#homeTicketDrawer .home-ticket-win-chance-fill{transition:none!important}}
...
(function(){
  ...
  function renderWinChance(){var track=q('#homeTicketDrawer [data-win-chance-track]'),fill=q('#homeTicketDrawer [data-win-chance-fill]'),value=q('#homeTicketDrawer [data-win-chance]'),chance=Math.max(0,Math.min(100,Number(state&&state.winChancePercent)||0));if(fill)fill.style.width=chance.toFixed(6)+'%';if(value)value.textContent=winChanceText(chance);if(track)track.setAttribute('aria-valuenow',chance.toFixed(6))}
