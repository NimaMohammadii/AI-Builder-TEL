...
(function(){
  ...
  function tune(){
    ...
    st.textContent=[
      ...
      '.home-bonus-backdrop{position:fixed!important;inset:0!important;z-index:99994!important;background:rgba(0,0,0,.24)!important;opacity:0!important;visibility:hidden!important;backdrop-filter:blur(2px)!important;-webkit-backdrop-filter:blur(2px)!important;transition:opacity .24s ease,visibility 0s linear .24s!important}.home-bonus-backdrop.is-open{opacity:1!important;visibility:visible!important;transition:opacity .24s ease!important}.home-bonus-panel{position:fixed!important;left:0!important;right:0!important;bottom:0!important;z-index:99995!important;max-height:min(72dvh,620px)!important;padding:10px 16px calc(18px + env(safe-area-inset-bottom))!important;border-radius:34px 34px 0 0!important;background:rgba(14,10,12,.92)!important;color:#fff!important;box-shadow:0 -18px 54px rgba(0,0,0,.36),inset 0 1px 0 rgba(255,255,255,.12)!important;backdrop-filter:blur(18px) saturate(1.12)!important;-webkit-backdrop-filter:blur(18px) saturate(1.12)!important;transform:translate3d(0,105%,0)!important;transition:transform .34s cubic-bezier(.2,.9,.26,1)!important;display:grid!important;grid-template-rows:auto auto auto auto minmax(0,1fr)!important;gap:10px!important;overflow:hidden!important;font-family:-apple-system,BlinkMacSystemFont,"SF Pro Rounded","Inter","Segoe UI",sans-serif!important;letter-spacing:-.018em!important}.home-bonus-panel.is-open{transform:translate3d(0,0,0)!important}.home-bonus-grab{width:36px!important;height:4px!important;margin:0 auto 2px!important;border-radius:999px!important;background:rgba(255,255,255,.20)!important}.home-bonus-head{display:flex!important;align-items:center!important;justify-content:space-between!important;gap:12px!important}.home-bonus-title{display:flex!important;align-items:center!important;gap:9px!important;min-width:0!important}.home-bonus-title svg{width:22px!important;height:22px!important;color:rgba(255,255,255,.72)!important;flex:0 0 auto!important}.home-bonus-head strong{font-family:inherit!important;font-size:18px!important;font-weight:800!important;letter-spacing:-.035em!important;line-height:1!important}.home-bonus-close{width:34px!important;height:34px!important;min-width:34px!important;border-radius:12px!important;border:1px solid rgba(255,255,255,.08)!important;background:rgba(255,255,255,.045)!important;color:#fff!important;display:grid!important;place-items:center!important;padding:0!important;box-sizing:border-box!important;box-shadow:none!important;backdrop-filter:none!important;-webkit-backdrop-filter:none!important;font-family:inherit!important;font-size:24px!important;font-weight:900!important;line-height:1!important;text-align:center!important;-webkit-tap-highlight-color:transparent!important;transition:transform .18s ease,background .18s ease!important}.home-bonus-close:active{transform:scale(.92)!important}.home-bonus-description{margin:0!important;padding:0 2px!important;color:rgba(255,255,255,.58)!important;font-size:11px!important;font-weight:600!important;line-height:1.45!important;letter-spacing:-.01em!important}.home-bonus-next{position:relative!important;overflow:hidden!important;min-height:48px!important;display:grid!important;grid-template-columns:26px minmax(0,1fr)!important;gap:8px!important;align-items:center!important;padding:0 11px!important;border:1px solid rgba(255,255,255,.06)!important;outline:0!important;border-radius:20px!important;background:rgba(255,255,255,.035)!important;box-sizing:border-box!important;box-shadow:none!important;backdrop-filter:none!important;-webkit-backdrop-filter:none!important}.home-bonus-next>svg{width:26px!important;height:26px!important;padding:4px!important;box-sizing:border-box!important;border-radius:50%!important;background:rgba(255,255,255,.065)!important;color:rgba(255,255,255,.72)!important;box-shadow:none!important}.home-bonus-guide-icon svg{width:20px!important;height:20px!important;color:rgba(255,255,255,.66)!important}.home-bonus-next span,.home-bonus-guide-copy span{display:block!important;color:rgba(255,255,255,.48)!important;font-size:10px!important;font-weight:700!important;line-height:1.25!important}.home-bonus-next b{display:block!important;margin-top:2px!important;color:#fff!important;font-size:11px!important;font-weight:800!important;line-height:1.15!important}.home-bonus-guide{display:grid!important;gap:8px!important}.home-bonus-guide-row{display:grid!important;grid-template-columns:24px minmax(0,1fr)!important;gap:9px!important;align-items:start!important}.home-bonus-guide-icon{padding-top:1px!important}.home-bonus-guide-copy b{display:block!important;margin-bottom:2px!important;color:#fff!important;font-size:12px!important;font-weight:800!important;line-height:1.2!important}.home-bonus-list{min-height:0!important;display:grid!important;grid-auto-rows:54px!important;align-content:start!important;gap:7px!important;overflow-y:auto!important;overflow-x:hidden!important;-webkit-overflow-scrolling:touch!important;scrollbar-width:none!important;padding:2px 0 4px!important}.home-bonus-list::-webkit-scrollbar{display:none!important}.home-bonus-row{position:relative!important;overflow:hidden!important;height:54px!important;min-height:54px!important;border:1px solid rgba(255,255,255,.06)!important;outline:0!important;border-radius:20px!important;background:rgba(255,255,255,.035)!important;box-shadow:none!important;color:#fff!important;display:grid!important;grid-template-columns:30px minmax(0,1fr) auto!important;align-items:center!important;gap:9px!important;padding:0 12px!important;box-sizing:border-box!important;backdrop-filter:none!important;-webkit-backdrop-filter:none!important}.home-bonus-rank-avatar{width:30px!important;height:30px!important;border-radius:50%!important;display:grid!important;place-items:center!important;overflow:hidden!important;background:rgba(255,255,255,.07)!important;color:rgba(255,255,255,.84)!important;font-size:10px!important;font-weight:800!important;line-height:1!important;box-shadow:none!important}.home-bonus-row .home-live-winner-user{min-width:0!important;display:flex!important;align-items:center!important}.home-bonus-row .home-live-winner-user span{display:block!important;color:#fff!important;font-size:12.5px!important;font-weight:800!important;line-height:1.08!important}.home-bonus-row .home-live-winner-amount{color:rgba(255,255,255,.82)!important;font-size:13.5px!important;font-weight:800!important;white-space:nowrap!important}.home-bonus-prize-amount{display:inline-flex!important;align-items:center!important;gap:3px!important}.home-bonus-prize-icon{width:27px!important;height:27px!important;display:inline-flex!important;align-items:center!important;justify-content:center!important;flex:0 0 27px!important}.home-bonus-prize-icon img{width:27px!important;height:27px!important;display:block!important;object-fit:contain!important}',
...
(function(){
  ...
  function prizeRowsHtml(prizes){
    var rows=Array.isArray(prizes)?prizes:[],html='',limit=winnerCount();
    for(var i=0;i<limit;i++){
      var prize=rows[i]||{rank:i+1,prizeNano:0,percent:0},rank=i+1,percent=Math.max(0,Number(prize.percent)||0);
      html+='<article class="home-bonus-row"><div class="home-bonus-rank-avatar">#'+rank+'</div><div class="home-live-winner-user"><span>'+percent.toLocaleString(undefined,{maximumFractionDigits:2})+'%</span></div><div class="home-live-winner-amount home-bonus-prize-amount"><span>'+gram(prize.prizeNano)+'</span>'+prizeIconHtml()+'</div></article>';
    }
    return html;
  }
  function lotteryCopy(){
    var set=function(selector,key){var el=q(selector);if(el)el.textContent=String(window.VexaLotteryText&&window.VexaLotteryText(key)||'')};
    set('[data-lottery-title]','lottery');set('[data-lottery-draw-label]','drawAt');set('[data-lottery-how-title]','howItWorks');set('[data-lottery-ticket-note]','ticketNote');set('[data-lottery-prize-title]','prizeSplit');set('[data-lottery-prize-note]','threeWinners');
    var draw=q('[data-lottery-draw-at]'),drawAt=Date.parse(String(state&&state.round&&state.round.drawAt||''));
    if(draw)draw.textContent=Number.isFinite(drawAt)?new Intl.DateTimeFormat(undefined,{weekday:'short',hour:'2-digit',minute:'2-digit'}).format(new Date(drawAt)):'—';
  }
  ...
  function init(){lotteryCopy();document.addEventListener('click',handleTicketControls,true);document.addEventListener('click',handleSmartRefresh,true);window.addEventListener('vexa:live-activity',handleLivePrizePool);load(true);startClock();window.VexaLotteryRefresh=function(){return load(true)}}
...
(function(){
  ...
  function avatar(item,rank){var raw=String(item&&item.avatarUrl||'').trim(),url='';try{var parsed=new URL(raw);if(parsed.protocol==='https:')url=parsed.href}catch(e){}return '<div class="home-lottery-winner-avatar">'+(url?'<img src="'+esc(url)+'" alt="" loading="lazy" referrerpolicy="no-referrer" onerror="this.remove()">':esc('#'+rank))+'</div>'}
  function row(rank,item,waiting){var name,amount,face;if(waiting){name='Waiting for draw';amount='—';face='<div class="home-lottery-winner-avatar">#'+rank+'</div>'}else if(!item){name='No results this round';amount='—';face='<div class="home-lottery-winner-avatar">#'+rank+'</div>'}else{name=displayName(item);amount='+'+gram(item.prizeNano)+' GRAM';face=avatar(item,rank)}return '<article class="home-lottery-winner-row">'+face+'<div class="home-lottery-winner-copy"><div class="home-lottery-winner-name">'+name+'</div></div><div class="home-lottery-winner-amount">'+esc(amount)+'</div></article>'}
  ...
  function ensureSurface(){var home=homeRoot(),card=host();if(!home||!card)return null;card.removeAttribute('aria-hidden');card.classList.remove('home-ticket-card');var surface=q(':scope>.home-lottery-winners',card);if(!surface){card.innerHTML='<section class="home-lottery-winners" aria-label="Lottery results"><div class="home-lottery-winners-title"><svg viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M12 3 14.5 8l5.5.8-4 3.9.9 5.5-4.9-2.6-4.9 2.6.9-5.5-4-3.9 5.5-.8L12 3Z" stroke="currentColor" stroke-width="1.8" stroke-linejoin="round"/></svg><span data-lottery-winners-title></span></div><div class="home-lottery-winners-list"></div></section>';surface=q(':scope>.home-lottery-winners',card)}var title=surface&&q('[data-lottery-winners-title]',surface);if(title)title.textContent='Previous Winners';var list=surface&&q('.home-lottery-winners-list',surface);if(list&&list.dataset.winnersScrollBound!=='1'){list.dataset.winnersScrollBound='1';list.addEventListener('scroll',function(){updateFade(list)},{passive:true})}watchHeight();return list}
  ...
  window.addEventListener('vexa-country-detected',bind);
