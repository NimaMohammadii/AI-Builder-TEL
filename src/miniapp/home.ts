export const HOME_SECTION = `<section id="home" class="view active">
  <style>
    ...
    #home .home-gift-icon{background:linear-gradient(145deg,rgba(255,255,255,.095),rgba(92,10,35,.16))!important;color:#fff!important}
    #home .home-gift-icon svg{width:27px!important;height:27px!important;stroke-linecap:round!important}
    ...
    #home .home-live-winners-list{display:grid!important;gap:8px!important;margin-top:8px!important;height:auto!important;max-height:none!important;overflow:visible!important;-webkit-overflow-scrolling:touch!important;overscroll-behavior-y:auto!important;scrollbar-width:none!important;padding-right:2px!important}#home .home-live-winners-list::-webkit-scrollbar{display:none!important}
