export const HOME_SECTION = `<section id="home" class="view active">
  <style>
    ...
    #home .home-rewards-head{position:relative;display:flex;align-items:flex-start;justify-content:space-between;gap:12px;margin:0 0 16px}
    ...
    #home .home-rewards-streak{height:34px;min-width:74px;border-radius:999px;display:grid;place-items:center;padding:0 12px;background:rgba(255,255,255,.075);box-shadow:inset 0 1px 0 rgba(255,255,255,.13);color:#fff;font-size:11px;font-weight:950;white-space:nowrap}
    ...
    @media(max-width:380px){#home .home-rewards-head h3{font-size:24px}#home .home-daily-reward-card{grid-template-columns:42px minmax(0,1fr);gap:9px}.home-daily-reward-action{grid-column:1 / -1;width:100%;height:36px}.home-daily-reward-orb{width:42px;height:42px;border-radius:16px}.home-mission-row{grid-template-columns:32px minmax(0,1fr) auto;gap:8px;min-height:50px;padding:8px 0}.home-mission-icon{width:32px;height:32px;border-radius:12px}.home-mission-main strong{font-size:12px}.home-mission-main span{font-size:8.2px}.home-mission-reward{height:24px;font-size:8px;padding:0 7px}}
  </style>
