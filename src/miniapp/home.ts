export const HOME_SECTION = `<section id="home" class="view active">
  <style>
    #home{overflow-y:auto!important;overflow-x:hidden!important;padding-bottom:120px!important;-webkit-overflow-scrolling:touch;scrollbar-width:none;background:radial-gradient(circle at 50% -10%,rgba(255,255,255,.18),transparent 36%),radial-gradient(circle at 18% 18%,rgba(128,23,54,.34),transparent 34%),radial-gradient(circle at 84% 30%,rgba(214,174,92,.14),transparent 30%),linear-gradient(180deg,#170913 0%,#0d070b 48%,#070707 100%)!important;border-radius:0!important}
    #home::-webkit-scrollbar{display:none}
    #home:before{content:'';position:fixed;left:50%;top:calc(88px + env(safe-area-inset-top));width:min(100%,560px);height:calc(100dvh - 172px);transform:translateX(-50%);pointer-events:none;z-index:0;background:radial-gradient(circle at 22% 18%,rgba(255,216,139,.16),transparent 18%),radial-gradient(circle at 76% 10%,rgba(255,255,255,.12),transparent 22%),radial-gradient(circle at 50% 70%,rgba(92,10,35,.20),transparent 38%),repeating-radial-gradient(circle at 50% 42%,rgba(255,255,255,.08) 0 1px,transparent 1px 28px);opacity:.9;filter:blur(.15px) saturate(1.08)}#home:after{content:'';position:fixed;left:50%;top:calc(102px + env(safe-area-inset-top));width:min(100%,560px);height:calc(100dvh - 202px);transform:translateX(-50%);pointer-events:none;z-index:0;background:radial-gradient(circle,rgba(255,255,255,.14) 0 2px,transparent 2.5px),radial-gradient(circle,rgba(255,208,122,.16) 0 1.5px,transparent 2px);background-size:92px 92px,128px 128px;background-position:16px 10px,54px 42px;mask-image:linear-gradient(180deg,transparent 0%,#000 18%,#000 76%,transparent 100%);opacity:.34}#home>*{position:relative;z-index:1}#home .home-finance-split{align-items:start!important}
    ...
    #home .home-finance-actions>.home-finance-card,#home .home-finance-visual-stack>.home-finance-card{height:118px!important;min-height:118px!important;max-height:118px!important;margin:0!important;box-sizing:border-box!important;border:0!important;border-radius:28px!important;background:linear-gradient(180deg,rgba(255,255,255,.105),rgba(255,255,255,.035)),radial-gradient(circle at 50% 0,rgba(255,208,122,.10),transparent 54%)!important;color:#fff!important;border:1px solid rgba(255,255,255,.13)!important;box-shadow:0 18px 42px rgba(0,0,0,.24),0 0 28px rgba(92,10,35,.12),inset 0 1px 0 rgba(255,255,255,.12)!important;text-align:center!important;padding:12px 10px!important;display:grid!important;place-items:center!important;align-content:center!important;gap:5px!important;overflow:hidden!important;position:relative!important}
    #home .home-finance-icon{width:32px!important;height:32px!important;border-radius:14px!important;display:grid!important;place-items:center!important;color:#fff!important;background:rgba(255,255,255,.085)!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.1),0 12px 26px rgba(0,0,0,.18)!important;backdrop-filter:blur(4px)!important;-webkit-backdrop-filter:blur(4px)!important}
    ...
    #home .home-live-winners-card{margin:10px 0 14px!important;border:0!important;border-radius:30px!important;background:rgba(255,255,255,.045)!important;color:#fff!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.07),0 16px 42px rgba(0,0,0,.24)!important;backdrop-filter:blur(3px) saturate(1.14)!important;-webkit-backdrop-filter:blur(3px) saturate(1.14)!important;overflow:hidden!important;padding:3px!important;position:relative!important;box-sizing:border-box!important}
    #home .home-live-winners-card:before{content:""!important;position:absolute!important;inset:3px!important;border-radius:27px!important;background:linear-gradient(180deg,rgba(255,255,255,.095),rgba(255,255,255,.032)),radial-gradient(circle at 20% 0,rgba(255,208,122,.10),transparent 44%)!important;pointer-events:none!important}
    ...
    #home .home-live-winner-row{min-height:54px!important;border:1px solid rgba(92,10,35,.22)!important;border-radius:21px!important;background:linear-gradient(180deg,rgba(255,255,255,.055),rgba(255,255,255,.018))!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.035),0 10px 24px rgba(0,0,0,.12)!important;display:grid!important;grid-template-columns:38px minmax(0,1fr) auto!important;align-items:center!important;gap:10px!important;padding:8px 4px!important;backdrop-filter:blur(3px) saturate(1.04)!important;-webkit-backdrop-filter:blur(3px) saturate(1.04)!important}
