export const HOME_SECTION = `<section id="home" class="view active">
  <style>
    body:has(#home.active) .app{padding-top:0!important}
    body:has(#home.active) .top{display:none!important}
