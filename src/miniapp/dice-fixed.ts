...
@media (max-width: 420px) {
  ...
  .dice-online-badge { gap: 4px !important; }
  .dice-online-badge i { width: 7px !important; height: 7px !important; }
  .dice-online-badge em { font-size: 7.4px !important; }
  .dice-online-badge b { min-width: 20px !important; font-size: 9.4px !important; }
}
`;

const DICE_ASSET_STYLES = `
.dice-view .dice-bet{position:relative!important;display:grid!important;grid-template-columns:.74fr 1.52fr .74fr!important;width:100%!important;height:54px!important;min-height:54px!important;margin:0 auto!important;overflow:visible!important;border-radius:0!important;background:transparent!important;background-image:none!important;border:0!important;box-shadow:none!important;outline:0!important;backdrop-filter:none!important;-webkit-backdrop-filter:none!important;transform:none!important}
.dice-view .dice-bet:before,.dice-view .dice-bet:after{display:none!important;content:none!important}
.dice-view .dice-bet .dice-bet-row-image{position:absolute!important;left:50%!important;top:50%!important;right:auto!important;bottom:auto!important;inset:auto!important;width:min(458px,calc(100vw - 28px))!important;height:auto!important;max-width:none!important;max-height:none!important;transform:translate(-50%,-50%)!important;object-fit:contain!important;display:block!important;opacity:0!important;pointer-events:none!important;z-index:0!important;transition:opacity .18s ease!important}
...
.dice-view .dice-roll-button{position:relative!important;display:flex!important;align-items:center!important;justify-content:center!important;width:100%!important;height:62px!important;min-height:62px!important;margin:0 auto!important;overflow:visible!important;background:transparent!important;background-image:none!important;border:0!important;box-shadow:none!important;outline:0!important;color:transparent!important;text-shadow:none!important;padding:0!important;backdrop-filter:none!important;-webkit-backdrop-filter:none!important;transform:none!important}
.dice-view .dice-roll-button:before,.dice-view .dice-roll-button:after{display:none!important;content:none!important}
.dice-view .dice-roll-button .dice-roll-button-image{position:absolute!important;left:50%!important;top:50%!important;right:auto!important;bottom:auto!important;inset:auto!important;width:min(458px,calc(100vw - 28px))!important;height:auto!important;max-width:none!important;max-height:none!important;transform:translate(-50%,-50%)!important;object-fit:contain!important;display:block!important;opacity:0!important;pointer-events:none!important;transition:opacity .18s ease!important}
...
@media(max-width:420px){.dice-view .dice-bet{height:50px!important;min-height:50px!important}.dice-view .dice-bet .dice-bet-row-image{width:min(420px,calc(100vw - 22px))!important;height:auto!important}.dice-view .dice-roll-button{height:62px!important;min-height:62px!important}.dice-view .dice-roll-button .dice-roll-button-image{width:min(420px,calc(100vw - 22px))!important;height:auto!important}.dice-view .dice-slider-shell.has-dice-thumb-image .dice-slider-thumb{width:48px!important;height:48px!important}}
`;
...
(function(){
  ...
  function render() {
    ...
    rows.forEach(function(item) {
      ...
      row.appendChild(name); row.appendChild(valueNode); row.appendChild(rollNode); list.appendChild(row);
    });
  }
  function capture() {
    ...
    rows.unshift({ label: 'You', result: numericResult > 0 ? '+' + resultValue : resultValue, roll: rollValue ? 'Roll ' + rollValue : '', positive: numericResult > 0, amount: amountValue });
