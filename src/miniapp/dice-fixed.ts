...
@media(max-width:420px){.dice-view .dice-bet{width:min(394px,100%)!important;min-height:64px!important;margin:2px auto 10px!important}.dice-view .dice-bet .dice-bet-row-image{height:74px!important}.dice-view .dice-roll-button{width:min(394px,100%)!important;height:70px!important;margin:0 auto 16px!important}.dice-view .dice-roll-button .dice-roll-button-image{height:70px!important}.dice-view .dice-slider-shell.has-dice-thumb-image .dice-slider-thumb{width:48px!important;height:48px!important}}
`;
