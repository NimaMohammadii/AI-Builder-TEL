...
(function(){
  ...
  var TON_ICON_SVG='<svg class="market-ton-svg" viewBox="0 0 64 64" fill="none" aria-hidden="true"><path fill="currentColor" d="M11.5 15.5h41c3.9 0 6.2 4.3 4 7.6L36.4 51.7c-2.1 3-6.7 3-8.8 0L7.5 23.1c-2.2-3.3.1-7.6 4-7.6Zm2.6 7 14.6 21.1V22.5H14.1Zm21.2 0v21.1l14.6-21.1H35.3Zm-3.3 24 16.1-24H15.9L32 46.5Z"/></svg>';
  ...
  function priceButton(value){return '<span class="market-price-button vexa-fragment-price">'+TON_ICON_SVG+'<b>'+esc(value||'0')+'</b></span>'}
  ...
  async function openDetail(item){
    ...
    if(isTelegram){var priceBox=sheet.querySelector('.market-detail-price strong');if(priceBox&&!priceBox.querySelector('.market-ton-svg'))priceBox.insertAdjacentHTML('afterbegin',TON_ICON_SVG)}
    if(buy){buy.remove()}
