...
(function(){
  ...
  function bind(){
    ...
    document.addEventListener('click',function(ev){
      ...
      if(button&&button.getAttribute('data-action')==='open-deposit')setTimeout(updateEquivalent,50);
      if(button&&button.getAttribute('data-action')==='close-deposit')setDepositKeyboard(false);
    },true);
  }
