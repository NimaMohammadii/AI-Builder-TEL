...
(function(){
  var css = [
    ...
    '#home .vexa-premium-corner{position:absolute!important;right:0!important;bottom:0!important;width:170px!important;height:74px!important;z-index:2!important;pointer-events:none!important;overflow:visible!important;border-radius:0 0 28px 0!important;display:block!important;grid-column:auto!important;grid-row:auto!important;place-self:auto!important}',
    '#home .vexa-premium-corner:before{content:""!important;position:absolute!important;right:-44px!important;bottom:-42px!important;width:210px!important;height:128px!important;border-radius:999px!important;background:radial-gradient(circle at 86% 84%,rgba(92,10,35,.64),rgba(42,4,16,.34) 35%,rgba(42,4,16,.16) 49%,rgba(8,0,4,.06) 61%,rgba(8,0,4,0) 74%)!important;box-shadow:0 0 42px rgba(92,10,35,.34),inset 0 -20px 34px rgba(92,10,35,.18)!important}',
