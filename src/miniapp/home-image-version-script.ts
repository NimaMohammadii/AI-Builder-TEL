...
(function(){
  ...
  function ensure(card,blue){
    ...
    fill(box);
    box.classList.toggle('is-blue',!!blue);
  }
  function apply(){
    ...
    if(!root)return;
    ensure(root.querySelector('.home-live-winner-card:nth-child(1)'),false);
    ensure(root.querySelector('.home-live-winner-card:nth-child(2)'),true);
  }
