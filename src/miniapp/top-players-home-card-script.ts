...
(function(){
  ...
  function toastLocked(){var t=q('toast');if(t){t.textContent='قفله';t.style.display='block';setTimeout(function(){t.style.display='none'},2400);return}try{alert('قفله')}catch(e){}}
