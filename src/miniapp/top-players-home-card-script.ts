...
(function(){
  ...
  function openTopPlayers(){
    ...
    document.body.classList.add('top-players-entering');
    setTimeout(function(){showTopPlayersDirect()},150);
    setTimeout(function(){document.body.classList.remove('top-players-entering');if(card)card.__topPlayersOpening=false},620);
  }
