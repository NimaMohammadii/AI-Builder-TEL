...
#predictzone .predict-crypto-card{position:relative;width:100%;min-height:132px;border:1px solid rgba(255,255,255,.11);border-radius:28px;background:rgba(255,255,255,.045)!important;box-shadow:0 18px 46px rgba(0,0,0,.24),inset 0 1px 0 rgba(255,255,255,.10)!important;-webkit-backdrop-filter:blur(4px);backdrop-filter:blur(4px);display:grid;grid-template-columns:78px minmax(0,1fr) auto;align-items:center;gap:12px;padding:10px;text-align:left;color:#fff;overflow:hidden}
#predictzone .predict-crypto-card:before{content:"";position:absolute;inset:10px;border-radius:22px;background:rgba(0,0,0,.16);box-shadow:inset 0 1px 0 rgba(255,255,255,.08);pointer-events:none;z-index:0}
