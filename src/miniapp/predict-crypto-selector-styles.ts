...
#predictzone .predict-crypto-card-upload{position:absolute!important;inset:3px;z-index:0!important;display:block;border-radius:25px;background-color:transparent!important;background-position:center;background-repeat:no-repeat;background-size:contain;pointer-events:none;overflow:hidden}
