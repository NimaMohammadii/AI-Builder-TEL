...
body:has(#predictzone.active) .content{width:calc(100% + 32px)!important;margin-left:-16px!important;margin-right:-16px!important;padding:0 0 calc(18px + env(safe-area-inset-bottom))!important;overflow:hidden!important}
