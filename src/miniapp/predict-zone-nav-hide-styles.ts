...
body:has(#predictzone.active) #predictzone .predict-zone-simple-shell{position:relative!important;min-height:calc(100vh - 56px - env(safe-area-inset-top) - env(safe-area-inset-bottom))!important;display:grid!important;align-content:start!important;padding:24px 0 120px!important;overflow:visible!important;background:transparent!important}
...
@media(max-width:380px){body:has(#predictzone.active) .app{padding-top:calc(12px + env(safe-area-inset-top))!important}body:has(#predictzone.active) #predictzone .predict-zone-simple-shell{padding-top:21px!important}body:has(#predictzone.active) #predictzone .predict-zone-category-menu{left:-16px!important;width:calc(100% + 32px)!important;margin:0 0 12px!important;padding:0 16px 10px!important}}
`;