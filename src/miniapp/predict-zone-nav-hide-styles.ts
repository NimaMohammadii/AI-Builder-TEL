...
body:has(#predictzone.active) #predictzone .predict-zone-simple-shell{position:relative!important;min-height:calc(100vh - 56px - env(safe-area-inset-top) - env(safe-area-inset-bottom))!important;display:grid!important;align-content:start!important;padding:30px 0 120px!important;overflow:visible!important;background:transparent!important}
