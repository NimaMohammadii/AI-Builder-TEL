...
(function(){
  ...
  function matchHtml(m){var a=team(m.a),b=team(m.b);return '<article class="football-match-card" data-football-match="'+esc(m.id)+'"><div class="football-match-head"><span class="football-match-left"><span class="football-match-tag">'+esc(m.stage)+'</span><span class="football-live-badge"><i class="football-live-dot"></i>LIVE</span></span><span class="football-match-time">'+esc(m.time)+'</span></div><div class="football-teams"><div class="football-team">'+logo(m.a)+'<b>'+esc(a.name)+'</b></div><div class="football-vs">VS</div><div class="football-team">'+logo(m.b)+'<b>'+esc(b.name)+'</b></div></div><div class="football-pick-row"><button type="button">'+esc(a.name)+'</button><button type="button">Draw</button><button type="button">'+esc(b.name)+'</button></div></article>'}
