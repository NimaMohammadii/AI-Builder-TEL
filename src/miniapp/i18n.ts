...
export const SHARE_INVITE_TEXT: VexaText = {
  en: '🎮 Come play Vexa with me!\n\nOn Vexa, you can play Mines, Plinko, Crash, Wheel, Dice, Dragon Tower, Slot, and Ghost Run — then compete with other players. 🏆\n\nYou can also predict the direction of Bitcoin, gold, and oil prices, along with the outcomes of major world events, and put your skills to the test. 📈\n\nI’m on Vexa too — come play with me 😄',
