...
export const LOTTERY_HOME_TEXT: Readonly<Record<VexaLocale, LotteryHomeText>> = {
  en: { previousWinners: 'Previous winners', lottery: 'Lottery', drawAt: 'Next draw', prizeSplit: 'Prize split', howItWorks: 'How it works', threeWinners: 'Three unique winners share the full prize pool.', ticketNote: 'Every ticket joins the next draw.', winChance: 'Your chance to win', waitingForDraw: 'Waiting for draw', noResults: 'No results this round', player: 'Player' },
  fa: { previousWinners: 'برنده‌های قبلی', lottery: 'لاتاری', drawAt: 'قرعه‌کشی بعدی', prizeSplit: 'تقسیم جایزه', howItWorks: 'نحوهٔ لاتاری', threeWinners: 'سه برندهٔ متفاوت، کل Prize Pool را تقسیم می‌کنند.', ticketNote: 'هر تیکت وارد قرعه‌کشی بعدی می‌شود.', winChance: 'شانس شما برای برنده شدن', waitingForDraw: 'در انتظار قرعه‌کشی', noResults: 'برای این دور نتیجه‌ای نیست', player: 'بازیکن' },
  ru: { previousWinners: 'Предыдущие победители', lottery: 'Лотерея', drawAt: 'Следующий розыгрыш', prizeSplit: 'Распределение призов', howItWorks: 'Как это работает', threeWinners: 'Три разных победителя делят весь призовой фонд.', ticketNote: 'Каждый билет участвует в следующем розыгрыше.', winChance: 'Ваш шанс на победу', waitingForDraw: 'Ожидание розыгрыша', noResults: 'В этом раунде нет результатов', player: 'Игрок' },
  tr: { previousWinners: 'Önceki kazananlar', lottery: 'Çekiliş', drawAt: 'Sonraki çekiliş', prizeSplit: 'Ödül dağılımı', howItWorks: 'Nasıl çalışır', threeWinners: 'Üç farklı kazanan tüm ödül havuzunu paylaşır.', ticketNote: 'Her bilet sonraki çekilişe katılır.', winChance: 'Kazanma şansınız', waitingForDraw: 'Çekiliş bekleniyor', noResults: 'Bu turda sonuç yok', player: 'Oyuncu' },
  ar: { previousWinners: 'الفائزون السابقون', lottery: 'السحب', drawAt: 'السحب التالي', prizeSplit: 'توزيع الجوائز', howItWorks: 'كيف يعمل', threeWinners: 'ثلاثة فائزين مختلفين يتقاسمون كامل الجائزة.', ticketNote: 'كل تذكرة تدخل السحب التالي.', winChance: 'فرصتك في الفوز', waitingForDraw: 'بانتظار السحب', noResults: 'لا نتائج لهذه الجولة', player: 'لاعب' },
  es: { previousWinners: 'Ganadores anteriores', lottery: 'Sorteo', drawAt: 'Próximo sorteo', prizeSplit: 'Reparto de premios', howItWorks: 'Cómo funciona', threeWinners: 'Tres ganadores distintos comparten todo el premio.', ticketNote: 'Cada boleto participa en el próximo sorteo.', winChance: 'Tu probabilidad de ganar', waitingForDraw: 'Esperando el sorteo', noResults: 'Sin resultados en esta ronda', player: 'Jugador' },
  'pt-BR': { previousWinners: 'Vencedores anteriores', lottery: 'Sorteio', drawAt: 'Próximo sorteio', prizeSplit: 'Divisão do prêmio', howItWorks: 'Como funciona', threeWinners: 'Três vencedores diferentes dividem todo o prêmio.', ticketNote: 'Cada bilhete participa do próximo sorteio.', winChance: 'Sua chance de ganhar', waitingForDraw: 'Aguardando sorteio', noResults: 'Sem resultados nesta rodada', player: 'Jogador' },
  id: { previousWinners: 'Pemenang sebelumnya', lottery: 'Undian', drawAt: 'Undian berikutnya', prizeSplit: 'Pembagian hadiah', howItWorks: 'Cara kerja', threeWinners: 'Tiga pemenang berbeda berbagi seluruh hadiah.', ticketNote: 'Setiap tiket masuk ke undian berikutnya.', winChance: 'Peluang Anda untuk menang', waitingForDraw: 'Menunggu undian', noResults: 'Belum ada hasil ronde ini', player: 'Pemain' },
  hi: { previousWinners: 'पिछले विजेता', lottery: 'लॉटरी', drawAt: 'अगला ड्रॉ', prizeSplit: 'इनाम का बंटवारा', howItWorks: 'यह कैसे काम करता है', threeWinners: 'तीन अलग विजेता पूरा प्राइज़ पूल बाँटते हैं।', ticketNote: 'हर टिकट अगले ड्रॉ में शामिल होता है।', winChance: 'आपके जीतने की संभावना', waitingForDraw: 'ड्रॉ की प्रतीक्षा है', noResults: 'इस राउंड का कोई परिणाम नहीं', player: 'खिलाड़ी' },
  de: { previousWinners: 'Letzte Gewinner', lottery: 'Lotterie', drawAt: 'Nächste Ziehung', prizeSplit: 'Preisaufteilung', howItWorks: 'So funktioniert es', threeWinners: 'Drei verschiedene Gewinner teilen den gesamten Preispool.', ticketNote: 'Jedes Ticket nimmt an der nächsten Ziehung teil.', winChance: 'Deine Gewinnchance', waitingForDraw: 'Warte auf Ziehung', noResults: 'Keine Ergebnisse in dieser Runde', player: 'Spieler' },
  fr: { previousWinners: 'Derniers gagnants', lottery: 'Loterie', drawAt: 'Prochain tirage', prizeSplit: 'Répartition des prix', howItWorks: 'Comment ça marche', threeWinners: 'Trois gagnants différents se partagent tout le lot.', ticketNote: 'Chaque ticket participe au prochain tirage.', winChance: 'Ta chance de gagner', waitingForDraw: 'En attente du tirage', noResults: 'Aucun résultat pour ce tour', player: 'Joueur' },
  it: { previousWinners: 'Ultimi vincitori', lottery: 'Lotteria', drawAt: 'Prossima estrazione', prizeSplit: 'Divisione premi', howItWorks: 'Come funziona', threeWinners: 'Tre vincitori diversi condividono l’intero montepremi.', ticketNote: 'Ogni biglietto partecipa alla prossima estrazione.', winChance: 'La tua possibilità di vincere', waitingForDraw: 'In attesa dell’estrazione', noResults: 'Nessun risultato in questo turno', player: 'Giocatore' },
  uk: { previousWinners: 'Попередні переможці', lottery: 'Лотерея', drawAt: 'Наступний розіграш', prizeSplit: 'Розподіл призів', howItWorks: 'Як це працює', threeWinners: 'Три різні переможці ділять весь призовий фонд.', ticketNote: 'Кожен квиток бере участь у наступному розіграші.', winChance: 'Ваш шанс на перемогу', waitingForDraw: 'Очікування розіграшу', noResults: 'У цьому раунді немає результатів', player: 'Гравець' },
  pl: { previousWinners: 'Poprzedni zwycięzcy', lottery: 'Loteria', drawAt: 'Następne losowanie', prizeSplit: 'Podział nagród', howItWorks: 'Jak to działa', threeWinners: 'Trzech różnych zwycięzców dzieli całą pulę nagród.', ticketNote: 'Każdy los bierze udział w następnym losowaniu.', winChance: 'Twoja szansa na wygraną', waitingForDraw: 'Oczekiwanie na losowanie', noResults: 'Brak wyników tej rundy', player: 'Gracz' },
  vi: { previousWinners: 'Người thắng trước đó', lottery: 'Xổ số', drawAt: 'Kỳ quay tiếp theo', prizeSplit: 'Chia giải thưởng', howItWorks: 'Cách hoạt động', threeWinners: 'Ba người thắng khác nhau chia toàn bộ giải thưởng.', ticketNote: 'Mỗi vé tham gia kỳ quay tiếp theo.', winChance: 'Cơ hội chiến thắng của bạn', waitingForDraw: 'Đang chờ quay', noResults: 'Chưa có kết quả vòng này', player: 'Người chơi' },
  th: { previousWinners: 'ผู้ชนะก่อนหน้า', lottery: 'ลอตเตอรี่', drawAt: 'รอบถัดไป', prizeSplit: 'การแบ่งรางวัล', howItWorks: 'วิธีการทำงาน', threeWinners: 'ผู้ชนะสามคนที่ไม่ซ้ำกันจะแบ่งรางวัลทั้งหมด', ticketNote: 'ตั๋วทุกใบเข้าร่วมรอบถัดไป', winChance: 'โอกาสชนะของคุณ', waitingForDraw: 'กำลังรอผลรางวัล', noResults: 'รอบนี้ยังไม่มีผล', player: 'ผู้เล่น' },
  ko: { previousWinners: '이전 당첨자', lottery: '복권', drawAt: '다음 추첨', prizeSplit: '상금 분배', howItWorks: '이용 방법', threeWinners: '서로 다른 세 명의 당첨자가 전체 상금을 나눕니다.', ticketNote: '모든 티켓은 다음 추첨에 참여합니다.', winChance: '당첨 확률', waitingForDraw: '추첨 대기 중', noResults: '이번 라운드 결과 없음', player: '플레이어' },
  ja: { previousWinners: '前回の当選者', lottery: '抽選', drawAt: '次回の抽選', prizeSplit: '賞金の配分', howItWorks: '仕組み', threeWinners: '異なる3人の当選者で賞金プール全額を分けます。', ticketNote: 'すべてのチケットが次回の抽選に参加します。', winChance: '当選確率', waitingForDraw: '抽選を待っています', noResults: 'このラウンドの結果はありません', player: 'プレイヤー' },
  ur: { previousWinners: 'پچھلے فاتحین', lottery: 'لاٹری', drawAt: 'اگلا ڈرا', prizeSplit: 'انعام کی تقسیم', howItWorks: 'یہ کیسے کام کرتی ہے', threeWinners: 'تین مختلف فاتحین پورا انعامی پول بانٹتے ہیں۔', ticketNote: 'ہر ٹکٹ اگلے ڈرا میں شامل ہوتا ہے۔', winChance: 'آپ کے جیتنے کا امکان', waitingForDraw: 'ڈرا کا انتظار ہے', noResults: 'اس راؤنڈ کا کوئی نتیجہ نہیں', player: 'کھلاڑی' },
  fil: { previousWinners: 'Nakaraang nanalo', lottery: 'Lottery', drawAt: 'Susunod na draw', prizeSplit: 'Hati ng premyo', howItWorks: 'Paano ito gumagana', threeWinners: 'Tatlong magkakaibang nanalo ang maghahati sa buong premyo.', ticketNote: 'Bawat ticket ay kasali sa susunod na draw.', winChance: 'Tsansa mong manalo', waitingForDraw: 'Naghihintay ng draw', noResults: 'Walang resulta sa round na ito', player: 'Manlalaro' },
  ms: { previousWinners: 'Pemenang terdahulu', lottery: 'Loteri', drawAt: 'Cabutan seterusnya', prizeSplit: 'Pembahagian hadiah', howItWorks: 'Cara ia berfungsi', threeWinners: 'Tiga pemenang berbeza berkongsi keseluruhan hadiah.', ticketNote: 'Setiap tiket menyertai cabutan seterusnya.', winChance: 'Peluang anda untuk menang', waitingForDraw: 'Menunggu cabutan', noResults: 'Tiada keputusan untuk pusingan ini', player: 'Pemain' },
  'zh-Hant': { previousWinners: '上期得獎者', lottery: '抽獎', drawAt: '下次抽獎', prizeSplit: '獎金分配', howItWorks: '玩法說明', threeWinners: '三位不同得獎者平分全部獎金池。', ticketNote: '每張票都會參加下次抽獎。', winChance: '你的中獎機率', waitingForDraw: '等待抽獎', noResults: '本輪尚無結果', player: '玩家' },
};
