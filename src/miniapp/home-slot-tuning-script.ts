...
(function(){
  ...
  function tune(){
    ...
    st.textContent=[
      ...
      '#home .home-slot-number-digit{height:34px!important;display:flex!important;align-items:center!important;justify-content:center!important;font-family:-apple-system,BlinkMacSystemFont,"SF Pro Display","Inter","Segoe UI",sans-serif!important;font-size:31px!important;font-weight:900!important;letter-spacing:-.045em!important;color:transparent!important;background:linear-gradient(180deg,#ffffff 0%,#fff4f7 18%,#ffd2dd 46%,#b76a7d 68%,#fff7fb 100%)!important;-webkit-background-clip:text!important;background-clip:text!important;-webkit-text-stroke:.35px rgba(255,255,255,.42)!important;text-shadow:0 1px 0 rgba(255,255,255,.28),0 2px 2px rgba(0,0,0,.72),0 0 10px rgba(255,210,224,.22),0 10px 20px rgba(0,0,0,.62)!important;filter:drop-shadow(0 0 6px rgba(255,235,240,.12))!important}',
