...
(function(){
  ...
  function tune(){
    ...
    st.textContent=[
      ...
      '#home .home-slot-number-reel:first-child{transform:translateX(2px)!important}',
      '#home .home-slot-number-reel:nth-child(2){transform:translateX(3px)!important}',
      '#home .home-slot-number-reel:last-child{transform:translateX(-5px)!important}',
      '#home .home-slot-number-strip{position:absolute!important;left:0!important;right:0!important;top:48%!important;display:grid!important;grid-auto-rows:34px!important;will-change:transform!important;transition:none!important}',
