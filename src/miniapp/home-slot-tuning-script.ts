...
(function(){
  ...
  function tune(){
    ...
    st.textContent=[
      ...
      '#home .home-draw-actions{display:flex!important;align-items:center!important;gap:7px!important;flex:0 0 auto!important}.home-draw-actions .home-ticket-image-button{height:38px!important;min-width:88px!important;padding:0 12px!important;border:0!important;border-radius:18px!important;background:rgba(0,0,0,.22)!important;color:#fff!important;font-size:12px!important;font-weight:950!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.06),inset 0 -1px 0 rgba(255,255,255,.04)!important;backdrop-filter:none!important;-webkit-backdrop-filter:none!important}.home-bonus-button{width:38px!important;height:38px!important;border:0!important;border-radius:18px!important;background:rgba(0,0,0,.22)!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.06),inset 0 -1px 0 rgba(255,255,255,.04)!important;display:grid!important;place-items:center!important;padding:0!important}.home-bonus-icon{width:20px!important;height:18px!important;display:block!important;position:relative!important;border-radius:5px!important;background:linear-gradient(135deg,#fff7f8 0%,#e8a4ae 18%,#98263c 46%,#3b0711 72%,#c85869 100%)!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.62),inset 0 -1px 0 rgba(0,0,0,.32)!important}.home-bonus-icon:before{content:""!important;position:absolute!important;left:8px!important;top:0!important;bottom:0!important;width:3px!important;background:rgba(255,255,255,.62)!important;border-radius:3px!important}.home-bonus-icon:after{content:""!important;position:absolute!important;left:-2px!important;right:-2px!important;top:6px!important;height:3px!important;background:rgba(255,255,255,.58)!important;border-radius:3px!important}',
  ...
  function drawInfoHtml(){return '<div class="home-draw-info-card" id="homeDrawInfoCard"><div class="home-draw-copy"><span class="home-draw-label">Next Draw in</span><strong class="home-draw-time" data-draw-time>24:00:00</strong></div><div class="home-draw-actions" id="homeDrawActions"><button class="home-bonus-button" id="homeBonusButton" type="button"><i class="home-bonus-icon" aria-hidden="true"></i></button></div></div>'}
  function ensureDrawInfoCard(){var slot=q('#home .home-lottery-slot-card');if(!slot)return;var card=q('#homeDrawInfoCard');if(!card){slot.insertAdjacentHTML('beforebegin',drawInfoHtml());card=q('#homeDrawInfoCard')}var tm=q('[data-draw-time]',card);if(tm)tm.textContent=drawTimeText();var actions=q('#homeDrawActions',card);var my=q('#homeTicketImageButton');if(actions&&my&&my.parentNode!==actions){actions.insertBefore(my,actions.firstChild)}}
