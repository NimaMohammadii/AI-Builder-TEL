...
(function(){
  ...
  function tune(){
    ...
    st.textContent=[
      ...
      '#home .home-draw-ticket-pill{height:38px!important;min-width:124px!important;border-radius:18px!important;padding:0 4px!important;background:transparent!important;box-shadow:none!important;display:flex!important;align-items:center!important;justify-content:center!important;gap:8px!important;color:#fff!important;font-size:13px!important;font-weight:950!important;white-space:nowrap!important}.home-draw-ticket-icon{width:34px!important;height:21px!important;border-radius:7px!important;background:radial-gradient(circle at -1px 50%,rgba(13,13,13,.72) 0 4px,transparent 4.5px),radial-gradient(circle at calc(100% + 1px) 50%,rgba(13,13,13,.72) 0 4px,transparent 4.5px),linear-gradient(135deg,#fff7f8 0%,#e8a4ae 18%,#98263c 46%,#3b0711 72%,#c85869 100%)!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.64),inset 0 -1px 0 rgba(0,0,0,.32)!important;position:relative!important;display:block!important;transform:rotate(-7deg)!important}.home-draw-ticket-icon:before{content:""!important;position:absolute!important;top:3px!important;bottom:3px!important;left:11px!important;width:1px!important;background:repeating-linear-gradient(180deg,rgba(255,255,255,.64) 0 2px,transparent 2px 4px)!important;opacity:.78!important}.home-draw-ticket-icon:after{content:""!important;position:absolute!important;left:4px!important;right:4px!important;top:2px!important;height:7px!important;border-radius:999px!important;background:linear-gradient(180deg,rgba(255,255,255,.52),rgba(255,255,255,0))!important}',
