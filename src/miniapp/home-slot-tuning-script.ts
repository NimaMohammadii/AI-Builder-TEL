...
(function(){
  ...
  function tune(){
    ...
    st.textContent=[
      ...
      '#home .home-draw-copy{min-width:0!important;display:flex!important;align-items:center!important;gap:6px!important;white-space:nowrap!important;overflow:hidden!important}.home-draw-label{color:rgba(255,255,255,.54)!important;font-size:12px!important;font-weight:900!important;letter-spacing:-.01em!important;text-transform:none!important}.home-draw-time{font-family:-apple-system,BlinkMacSystemFont,"SF Pro Display","Inter","Segoe UI",sans-serif!important;color:#fff!important;background:none!important;-webkit-background-clip:initial!important;background-clip:initial!important;-webkit-text-stroke:0!important;font-size:17px!important;font-weight:950!important;letter-spacing:-.025em!important;white-space:nowrap!important;text-shadow:none!important;filter:none!important}',
      '#home .home-draw-ticket-pill{height:38px!important;min-width:124px!important;border-radius:18px!important;padding:0 12px!important;background:rgba(0,0,0,.22)!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.06),inset 0 -1px 0 rgba(255,255,255,.04)!important;display:flex!important;align-items:center!important;justify-content:center!important;gap:8px!important;color:#fff!important;font-size:13px!important;font-weight:950!important;white-space:nowrap!important}.home-draw-ticket-icon{width:30px!important;height:20px!important;border-radius:7px!important;background:radial-gradient(circle at -1px 50%,rgba(13,13,13,.7) 0 4px,transparent 4.5px),radial-gradient(circle at calc(100% + 1px) 50%,rgba(13,13,13,.7) 0 4px,transparent 4.5px),linear-gradient(135deg,#fff1f4 0%,#d97888 20%,#7b1529 48%,#2c050d 74%,#b64a5c 100%)!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.55),inset 0 -1px 0 rgba(0,0,0,.28),0 8px 16px rgba(0,0,0,.32)!important;position:relative!important;display:block!important;transform:rotate(-7deg)!important}.home-draw-ticket-icon:before{content:""!important;position:absolute!important;top:3px!important;bottom:3px!important;left:10px!important;width:1px!important;background:repeating-linear-gradient(180deg,rgba(255,255,255,.52) 0 2px,transparent 2px 4px)!important;opacity:.72!important}.home-draw-ticket-icon:after{content:""!important;position:absolute!important;inset:2px 4px auto 4px!important;height:7px!important;border-radius:999px!important;background:linear-gradient(180deg,rgba(255,255,255,.42),rgba(255,255,255,0))!important}',
