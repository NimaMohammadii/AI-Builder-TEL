...
(function(){
  ...
  function tune(){
    ...
    st.textContent=[
      ...
      '#home .home-draw-copy{min-width:0!important;display:flex!important;align-items:center!important;gap:6px!important;white-space:nowrap!important;overflow:hidden!important}.home-draw-label{color:rgba(255,255,255,.54)!important;font-size:12px!important;font-weight:900!important;letter-spacing:-.01em!important;text-transform:none!important}.home-draw-time{font-family:-apple-system,BlinkMacSystemFont,"SF Pro Display","Inter","Segoe UI",sans-serif!important;color:transparent!important;background:linear-gradient(180deg,#fff2f4 0%,#d48994 18%,#7f182b 46%,#3b0711 72%,#b94a5d 100%)!important;-webkit-background-clip:text!important;background-clip:text!important;-webkit-text-stroke:.28px rgba(255,205,215,.32)!important;font-size:17px!important;font-weight:950!important;letter-spacing:-.025em!important;white-space:nowrap!important;text-shadow:0 1px 0 rgba(255,210,218,.2),0 2px 2px rgba(0,0,0,.72),0 0 11px rgba(115,10,30,.32),0 10px 20px rgba(0,0,0,.62)!important;filter:drop-shadow(0 0 6px rgba(110,7,25,.18))!important}',
      '#home .home-draw-ticket-pill{height:38px!important;min-width:124px!important;border-radius:18px!important;padding:0 12px!important;background:rgba(0,0,0,.22)!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.06),inset 0 -1px 0 rgba(255,255,255,.04)!important;display:flex!important;align-items:center!important;justify-content:center!important;gap:8px!important;color:#fff!important;font-size:13px!important;font-weight:950!important;white-space:nowrap!important}.home-draw-ticket-icon{width:30px!important;height:19px!important;border-radius:6px!important;background:radial-gradient(circle at -1px 50%,rgba(13,13,13,.7) 0 4px,transparent 4.4px),radial-gradient(circle at calc(100% + 1px) 50%,rgba(13,13,13,.7) 0 4px,transparent 4.4px),linear-gradient(135deg,#fff0f3 0%,#b94d60 28%,#5a0d1e 65%,#23050b 100%)!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.5),inset 0 -1px 0 rgba(0,0,0,.3),0 8px 16px rgba(0,0,0,.32)!important;position:relative!important;display:block!important;transform:rotate(-5deg)!important}.home-draw-ticket-icon:before{content:""!important;position:absolute!important;top:4px!important;bottom:4px!important;left:10px!important;width:1px!important;background:rgba(255,255,255,.34)!important;opacity:.7!important}.home-draw-ticket-icon:after{content:""!important;position:absolute!important;left:4px!important;right:4px!important;top:2px!important;height:6px!important;border-radius:999px!important;background:linear-gradient(180deg,rgba(255,255,255,.36),rgba(255,255,255,0))!important}',
