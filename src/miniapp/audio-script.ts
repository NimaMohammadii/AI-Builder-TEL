...
(function(){
  ...
  function installCss(){
    ...
    style.textContent='#miniAppAudioBox{display:none!important;visibility:hidden!important;pointer-events:none!important}#miniAppAudioButton{position:fixed!important;right:31px!important;top:calc(154px + env(safe-area-inset-top))!important;z-index:2147483647!important;width:46px!important;height:46px!important;border:1px solid rgba(255,255,255,.18)!important;border-radius:999px!important;background:rgba(255,255,255,.045)!important;color:#fff!important;display:grid!important;place-items:center!important;padding:0!important;margin:0!important;box-shadow:0 12px 28px rgba(0,0,0,.18),inset 0 1px 0 rgba(255,255,255,.18),inset 0 -1px 0 rgba(255,255,255,.045)!important;backdrop-filter:blur(2px) saturate(1.08)!important;-webkit-backdrop-filter:blur(2px) saturate(1.08)!important;touch-action:none!important;-webkit-tap-highlight-color:transparent!important;pointer-events:auto!important;user-select:none!important;appearance:none!important;-webkit-appearance:none!important;outline:0!important;overflow:hidden!important;font-size:0!important;line-height:0!important}#miniAppAudioButton:before{content:"";position:absolute;inset:0;border-radius:inherit;background:linear-gradient(145deg,rgba(255,255,255,.12),rgba(255,255,255,.018) 58%,rgba(255,255,255,.052));pointer-events:none}#miniAppAudioButton:after{content:"";position:absolute;inset:1px;border-radius:inherit;border:1px solid rgba(255,255,255,.055);pointer-events:none}#miniAppAudioButton svg{position:absolute!important;left:50%!important;top:50%!important;z-index:1;width:23px!important;height:23px!important;display:block!important;color:#fff!important;fill:currentColor!important;filter:drop-shadow(0 1px 5px rgba(0,0,0,.32));pointer-events:none!important;transform:translate(-50%,-50%)!important}#miniAppAudioButton.is-playing{background:rgba(255,255,255,.055)!important;border-color:rgba(255,255,255,.22)!important}';
