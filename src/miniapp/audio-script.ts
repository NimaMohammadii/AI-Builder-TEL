...
(function(){
  ...
  function installCss(){
    ...
    style.textContent='#miniAppAudioBox{display:none!important;visibility:hidden!important;pointer-events:none!important}#miniAppAudioButton{position:fixed!important;right:30px!important;top:calc(124px + env(safe-area-inset-top))!important;z-index:2147483647!important;width:58px!important;height:58px!important;border:1px solid rgba(255,255,255,.18)!important;border-radius:999px!important;background:linear-gradient(145deg,rgba(255,255,255,.115),rgba(255,255,255,.035) 52%,rgba(255,255,255,.075))!important;color:#fff!important;display:grid!important;place-items:center!important;padding:0!important;margin:0!important;box-shadow:0 20px 44px rgba(0,0,0,.22),inset 0 1px 0 rgba(255,255,255,.24),inset 0 -1px 0 rgba(255,255,255,.07)!important;backdrop-filter:blur(22px) saturate(1.45)!important;-webkit-backdrop-filter:blur(22px) saturate(1.45)!important;touch-action:none!important;-webkit-tap-highlight-color:transparent!important;pointer-events:auto!important;user-select:none!important;appearance:none!important;-webkit-appearance:none!important;outline:0!important;overflow:hidden!important;font-size:0!important;line-height:0!important}#miniAppAudioButton:before{content:"";position:absolute;inset:0;border-radius:inherit;background:radial-gradient(circle at 28% 18%,rgba(255,255,255,.28),transparent 34%),linear-gradient(145deg,rgba(255,255,255,.16),rgba(255,255,255,.025) 58%,rgba(255,255,255,.08));pointer-events:none}#miniAppAudioButton:after{content:"";position:absolute;inset:1px;border-radius:inherit;border:1px solid rgba(255,255,255,.07);pointer-events:none}#miniAppAudioButton svg{position:absolute!important;left:50%!important;top:50%!important;z-index:1;width:29px!important;height:29px!important;display:block!important;color:#fff!important;fill:currentColor!important;filter:drop-shadow(0 2px 8px rgba(0,0,0,.42));pointer-events:none!important;transform:translate(-50%,-50%)!important}#miniAppAudioButton.is-playing{background:linear-gradient(145deg,rgba(255,255,255,.16),rgba(255,255,255,.045) 52%,rgba(255,255,255,.09))!important;border-color:rgba(255,255,255,.26)!important}';
