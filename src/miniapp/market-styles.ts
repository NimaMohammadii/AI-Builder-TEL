...
#market .market-price-button{position:relative;width:100%;height:29px;padding:0 11px;border-radius:999px;border:0!important;background:rgba(255,255,255,.035)!important;color:#fff;display:flex;align-items:center;justify-content:center;gap:6px;font-size:10.2px;font-weight:900;letter-spacing:-.02em;box-shadow:0 18px 42px rgba(0,0,0,.16),inset 0 1px 0 rgba(255,255,255,.16)!important;-webkit-backdrop-filter:blur(10px) saturate(1.18)!important;backdrop-filter:blur(10px) saturate(1.18)!important;margin-top:2px;overflow:hidden;opacity:1;text-shadow:0 1px 10px rgba(0,0,0,.28);transition:transform .22s cubic-bezier(.2,.9,.16,1),box-shadow .22s ease,background .22s ease}
...
#market .market-price-button b{position:relative;z-index:1;font-size:10.2px;font-weight:900;letter-spacing:-.02em;line-height:1;color:#fff!important;text-shadow:0 1px 10px rgba(0,0,0,.28)!important}
