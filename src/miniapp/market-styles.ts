...
#market .market-price-button{position:relative;width:100%;height:29px;padding:0 11px;border-radius:999px;border:1px solid rgba(255,46,99,.30)!important;background:linear-gradient(180deg,rgba(255,46,99,.30),rgba(255,255,255,.06))!important;color:#fff;display:flex;align-items:center;justify-content:center;gap:6px;font-size:10.2px;font-weight:900;letter-spacing:-.02em;box-shadow:0 10px 24px rgba(0,0,0,.24),0 0 20px rgba(255,46,99,.10),inset 0 1px 0 rgba(255,255,255,.36)!important;-webkit-backdrop-filter:blur(18px) saturate(190%);backdrop-filter:blur(18px) saturate(190%);margin-top:2px;overflow:hidden;opacity:1;transition:transform .22s cubic-bezier(.2,.9,.16,1),box-shadow .22s ease,background .22s ease}
...
#market .market-nft-card:hover .market-price-button{transform:translateY(-1px);background:linear-gradient(180deg,rgba(255,255,255,.28),rgba(255,255,255,.10))!important;box-shadow:0 14px 30px rgba(0,0,0,.28),0 0 18px rgba(255,46,99,.10),inset 0 1px 0 rgba(255,255,255,.44)!important}
#market .market-nft-card:hover .market-price-button:before{transform:translateX(120%)}
#market .market-price-button img{position:relative;z-index:1;width:15px;height:15px;object-fit:contain;border:0!important;background:transparent!important;box-shadow:none!important;display:block!important;flex:0 0 auto;opacity:1!important;visibility:visible!important;filter:drop-shadow(0 1px 6px rgba(0,0,0,.55))}
#market .market-price-button b{position:relative;z-index:1;font-size:10.2px;font-weight:900;letter-spacing:-.02em;line-height:1;color:#fff!important;text-shadow:none!important}
@media(max-width:380px){#market .market-grid{grid-template-columns:repeat(2,minmax(0,1fr))!important;column-gap:8px!important;row-gap:14px!important}#market .market-nft-title-row strong{font-size:12.5px}#market .market-nft-title-row em{max-width:50px;height:18px;font-size:7.8px;padding:0 6px}#market .market-price-button{height:26px;padding:0 9px;font-size:9.2px}#market .market-price-button img{width:13px;height:13px}#market .market-price-button b{font-size:9.2px}}
`;
