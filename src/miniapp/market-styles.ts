...
#market .market-price-button{width:100%;height:40px;border:1px solid rgba(255,255,255,.075)!important;border-radius:16px;background:transparent!important;-webkit-backdrop-filter:blur(2px)!important;backdrop-filter:blur(2px)!important;display:flex!important;align-items:center!important;justify-content:center!important;gap:8px!important;color:#fff!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.12),inset 0 -1px 0 rgba(255,255,255,.035)!important;margin-top:2px;overflow:hidden;opacity:1!important}
