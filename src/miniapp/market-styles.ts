...
#market .market-nft-art,#market .market-nft-art-ruby,#market .market-nft-art-nova,#market .market-nft-art-shadow,#market .market-nft-art-orbit,#market .market-nft-art-pulse{width:100%;height:100%;display:grid;place-items:center;position:relative;overflow:hidden;background:#030303!important;color:transparent!important}
...
#market .market-nft-art:after{content:"";position:absolute;inset:0;background:radial-gradient(circle at 28% 18%,rgba(255,255,255,.08),transparent 24%),radial-gradient(circle at 50% 100%,rgba(255,46,99,.055),transparent 48%);filter:none}
...
#market .market-price-button{width:100%;height:40px;border:1px solid rgba(255,255,255,.10)!important;border-radius:16px;background:rgba(255,255,255,.045)!important;-webkit-backdrop-filter:blur(3px) saturate(150%)!important;backdrop-filter:blur(3px) saturate(150%)!important;display:flex!important;align-items:center!important;justify-content:center!important;gap:8px!important;color:#fff!important;box-shadow:0 18px 42px rgba(0,0,0,.20),inset 0 1px 0 rgba(255,255,255,.08)!important;margin-top:2px;overflow:hidden;opacity:1!important}
