...
#market .market-price-button{width:100%;height:40px;border:0!important;border-radius:16px;background:linear-gradient(180deg,rgba(255,255,255,.18),rgba(255,255,255,.075))!important;-webkit-backdrop-filter:blur(1px) saturate(150%)!important;backdrop-filter:blur(1px) saturate(150%)!important;display:flex!important;align-items:center!important;justify-content:center!important;gap:8px!important;color:#fff!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.16),0 10px 24px rgba(0,0,0,.10)!important;margin-top:2px;overflow:hidden;opacity:1!important}
#market .market-price-button img{width:20px;height:20px;object-fit:contain;border:0!important;background:transparent!important;box-shadow:none!important;display:block!important;flex:0 0 auto;opacity:1!important;visibility:visible!important}
#market .market-price-button b{font-size:13.4px;font-weight:950;letter-spacing:-.035em;line-height:1;color:#fff!important;text-shadow:0 1px 10px rgba(0,0,0,.25)}
