...
#market .market-price-button{position:relative;width:100%;height:29px;padding:0 11px;border-radius:999px;border:1px solid rgba(255,255,255,.20);background:linear-gradient(180deg,rgba(255,255,255,.18),rgba(255,255,255,.055));color:#fff;display:flex;align-items:center;justify-content:center;gap:6px;font-size:10.2px;font-weight:900;letter-spacing:-.02em;box-shadow:0 10px 22px rgba(0,0,0,.24),inset 0 1px 0 rgba(255,255,255,.32),inset 0 -1px 0 rgba(255,255,255,.06);-webkit-backdrop-filter:blur(18px) saturate(190%);backdrop-filter:blur(18px) saturate(190%);margin-top:2px;overflow:hidden;opacity:1;transition:transform .22s cubic-bezier(.2,.9,.16,1),box-shadow .22s ease,background .22s ease}
...
#market .market-nft-card:hover .market-price-button{transform:translateY(-1px);background:linear-gradient(180deg,rgba(255,255,255,.28),rgba(255,255,255,.10));box-shadow:0 14px 30px rgba(0,0,0,.28),0 0 18px rgba(255,46,99,.10),inset 0 1px 0 rgba(255,255,255,.44)}
