...
#predictzone .predict-card-actions button[data-predict-card-side="up"],#predictzone .predict-zone-choice-up{background:rgba(34,197,94,.18)!important;color:#fff!important}
#predictzone .predict-card-actions button[data-predict-card-side="down"],#predictzone .predict-zone-choice-down{background:rgba(92,10,31,.18)!important;color:#fff!important}
