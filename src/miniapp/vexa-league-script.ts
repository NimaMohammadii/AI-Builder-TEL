...
(function(){
  ...
  function fallbackLeague(){
    ...
    return {currentWeek:{title:'Weekly Prize',status:'preview',winnerCount:50,startsAt:now.toISOString(),endsAt:end.toISOString(),announcement:'Top 50 players of this week.'},userState:{vex:0,claimedMissionIds:[]},seedUsers:[
  ...
  function updateHomeCard(){
    ...
    if(main)main.innerHTML='<span>Weekly Prize</span><strong>Top 50 Players</strong><small>Weekly users, ranks, Vex and TON balance</small>';
  }
