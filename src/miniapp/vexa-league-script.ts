...
(function(){
  ...
  function renderLoading(){ensureHeroStyle();var page=q('leaderboardPage');if(!page)return;page.innerHTML='<section class="top-players-hero-card"><p class="top-players-hero-kicker">Top Players</p><h2 class="top-players-hero-title">Top 50 Players</h2><p class="top-players-hero-sub">Loading players...</p><div class="top-players-hero-art"><img src="'+heroImage()+'" alt="" onerror="this.style.display=\'none\'"/></div></section><div class="missions-title" style="margin-top:18px"><strong>Top Players</strong><span>Loading</span></div><div class="leaderboard-list"><div class="mission-row"><span class="mission-icon">#</span><span class="mission-main"><strong>Loading players</strong><span>Preparing Top 50 list</span></span><span class="mission-reward">...</span></div></div>';syncNativeBack();}
