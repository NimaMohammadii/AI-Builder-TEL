...
(function(){
  ...
  function paidButtonHtml(cost){var src=balanceIconSrc(),icon=src?'<img src="'+src+'" alt="" aria-hidden="true" style="width:28px;height:28px;display:block;object-fit:contain">':'';return '<span style="display:flex;width:100%;align-items:center;justify-content:center;gap:1px">'+icon+'<span style="font-size:calc(1em + 2px);line-height:1">'+gramPrice(cost)+'</span></span>'}
