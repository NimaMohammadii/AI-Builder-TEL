...
<section id="rps" class="view rps-view">
  <style>
    ...
    .rps-multiplier{flex:0 0 auto;height:34px;min-width:58px;padding:0 12px;border:0;border-radius:999px;display:grid;place-items:center;color:rgba(255,255,255,.58);font-size:12px;font-weight:950;letter-spacing:-.025em;background:rgba(255,255,255,.035);box-shadow:inset 0 1px 0 rgba(255,255,255,.10),0 10px 24px rgba(0,0,0,.22);-webkit-backdrop-filter:blur(8px) saturate(130%);backdrop-filter:blur(8px) saturate(130%);scroll-snap-align:center;transition:transform .32s cubic-bezier(.2,.9,.18,1),background .22s ease,color .22s ease,box-shadow .22s ease,filter .32s ease}
    ...
    .rps-multiplier.rps-win{color:rgba(220,255,232,.96);background:linear-gradient(180deg,rgba(8,86,42,.58),rgba(2,32,17,.72));box-shadow:inset 0 1px 0 rgba(149,255,187,.16),0 0 18px rgba(8,92,43,.26),0 12px 28px rgba(0,0,0,.36);transition:transform .2s cubic-bezier(.18,.86,.2,1),background .08s ease,color .08s ease,box-shadow .08s ease,filter .2s ease;animation:rpsMultiplierWin .72s cubic-bezier(.18,.86,.2,1) both}
    .rps-multiplier.rps-loss{color:rgba(255,218,226,.94);background:linear-gradient(180deg,rgba(85,5,28,.64),rgba(31,1,12,.82));box-shadow:inset 0 1px 0 rgba(255,124,151,.14),0 0 18px rgba(92,5,30,.28),0 12px 28px rgba(0,0,0,.38);transition:transform .2s cubic-bezier(.18,.86,.2,1),background .08s ease,color .08s ease,box-shadow .08s ease,filter .2s ease;animation:rpsMultiplierLoss .72s cubic-bezier(.18,.86,.2,1) both}
    ...
    .rps-hand-card{height:168px;border:0!important;border-radius:0!important;background:transparent!important;box-shadow:none!important;display:grid;grid-template-rows:128px 18px;place-items:center;gap:6px;overflow:visible!important;-webkit-backdrop-filter:none!important;backdrop-filter:none!important}
    .rps-hand-img{display:block;width:116px;height:116px;object-fit:contain;border:0!important;outline:0!important;background:transparent!important;box-shadow:none!important;filter:drop-shadow(0 18px 28px rgba(0,0,0,.46));pointer-events:none;opacity:0;--rps-hand-angle:90deg;--rps-hand-drop-start:-90deg;--rps-hand-drop-overshoot:5deg;transform:rotate(var(--rps-hand-angle));transform-origin:center;transition:opacity .24s ease,transform 1.15s cubic-bezier(.18,.82,.22,1);will-change:transform,opacity}
    [data-rps-bot-img]{--rps-hand-angle:-90deg;--rps-hand-drop-start:90deg;--rps-hand-drop-overshoot:-5deg}
    .rps-choice .rps-hand-img{width:58px;height:58px;filter:drop-shadow(0 10px 14px rgba(0,0,0,.32));opacity:0}
    .rps-hand-card.has-rps-image .rps-hand-img,.rps-choice.has-rps-image .rps-hand-img{opacity:1}
    ...
    @keyframes rpsMultiplierWin{0%{filter:saturate(1);transform:translateY(0) scale(1)}46%{filter:saturate(1.26);transform:translateY(-1px) scale(1.04)}100%{filter:saturate(1);transform:translateY(0) scale(1)}}
    @keyframes rpsMultiplierLoss{0%{filter:saturate(1);transform:translateY(0) scale(1)}46%{filter:saturate(1.22);transform:translateY(1px) scale(.99)}100%{filter:saturate(1);transform:translateY(0) scale(1)}}
    @media(max-width:380px){.rps-arena{min-height:436px}.rps-duel{margin:18px 0 12px}.rps-hand-card{height:148px;grid-template-rows:108px 18px}.rps-hand-img{width:86px;height:86px}.rps-hand-card.has-rps-image .rps-hand-img{width:104px;height:104px}.rps-choice{height:78px;grid-template-rows:54px 16px}.rps-choice .rps-hand-img{width:50px;height:50px}.rps-panel{margin-top:0}}
  </style>
  <div class="rps-wrap">
    <div class="rps-arena">
