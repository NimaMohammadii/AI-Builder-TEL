...
@media(max-width:380px){#playzone .limbo-forest-controls span{height:22px;font-size:10px}#playzone .limbo-forest-status{font-size:7.8px}#playzone .limbo-forest-hud{font-size:8px}}
</style>`;
