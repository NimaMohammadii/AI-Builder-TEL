...
(function(){
  ...
  Object.assign(sectionLabels,{home:'Home',connect:'Connect',flow:'TTS',playzone:'Play Zone',plinko:'Plinko',mines:'Mines',crash:'Crash',wheel:'Wheel',dice:'Dice',limbo:'Limbo',slot:'Slot',tower:'Tower',coinflip:'Coin Flip',hilo:'Hi-Lo',ghostrun:'Ghost Run'});
