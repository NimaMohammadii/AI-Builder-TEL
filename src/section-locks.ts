...
const DEFAULT_SECTIONS: Array<Omit<SectionLock, 'locked' | 'mode' | 'expiresAt' | 'remainingMs' | 'hasCode' | 'hasImage' | 'imageUrl' | 'hasLockedImage' | 'lockedImageUrl' | 'hasCodeImage' | 'codeImageUrl'>> = [
  ...
  { id: 'playzone-row-ad-2', label: 'Play Zone Row Ad 2', description: 'Legacy image slot after the second Play Zone row' },
  { id: 'playzone-row-ad-3', label: 'Play Zone Row Ad 3', description: 'Legacy image slot after the third Play Zone row' },
  { id: 'playzone-card-ad-mines', label: 'Play Zone Mines Row Image', description: 'Image slot displayed with the Mines card row' },
  { id: 'playzone-card-ad-plinko', label: 'Play Zone Plinko Row Image', description: 'Image slot displayed with the Plinko card row' },
  { id: 'playzone-card-ad-crash', label: 'Play Zone Crash Row Image', description: 'Image slot displayed with the Crash card row' },
  { id: 'playzone-card-ad-wheel', label: 'Play Zone Wheel Row Image', description: 'Image slot displayed with the Wheel card row' },
  { id: 'playzone-card-ad-dice', label: 'Play Zone Dice Row Image', description: 'Image slot displayed with the Dice card row' },
  { id: 'playzone-card-ad-limbo', label: 'Play Zone Limbo Row Image', description: 'Image slot displayed with the Limbo card row' },
  { id: 'playzone-card-ad-tower', label: 'Play Zone Tower Row Image', description: 'Image slot displayed with the Tower card row' },
  { id: 'playzone-card-ad-coinflip', label: 'Play Zone Coin Flip Row Image', description: 'Image slot displayed with the Coin Flip card row' },
  { id: 'playzone-card-ad-hilo', label: 'Play Zone Hi-Lo Row Image', description: 'Image slot displayed with the Hi-Lo card row' },
