...
(function(){
  ...
  function addMenu(){
    ...
    btn.innerHTML='<strong>Plinko Control</strong><span>Upload button images and tune chances</span>';
  ...
  async function uploadPlinkoImage(kind){
    ...
    const input=document.getElementById(kind==='input'?'plinkoInputImage':'plinkoDropImage');
